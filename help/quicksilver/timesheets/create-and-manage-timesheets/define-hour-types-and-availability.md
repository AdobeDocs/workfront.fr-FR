...
1. Cliquez sur l’icône **Plus** ![Plus](assets/more-icon.png) en regard du nom d’utilisateur, puis cliquez sur **Modifier**. La boîte de dialogue Modifier l’utilisateur s’ouvre.

   >[!IMPORTANT]
   >
   >Seul un administrateur ou une administratrice système peut modifier les autres utilisateurs et utilisatrices.
   >Si vous disposez d’une licence Standard ou Plan, vous pouvez modifier les types d’heures sur votre propre profil. Cliquez sur l’image de votre profil dans la zone de navigation supérieure d’Adobe Workfront, puis cliquez sur **Profil Workfront**. Cliquez sur le menu **Plus** en regard de votre nom, puis cliquez sur **Modifier**.

1. Dans la section **Planification des ressources** de la zone Modifier l&#39;utilisateur, dans le menu déroulant **Types d&#39;heures disponibles**, effectuez l&#39;une des opérations suivantes, selon les types d&#39;heures que vous souhaitez rendre disponibles lors de la journalisation du temps sur un projet, une tâche ou un événement :

   * **Pour rendre tous les types d’heures disponibles pour l’utilisateur :** sélectionnez tous les types d’heures.\
     Si vous ne sélectionnez aucun type d’heure, cela revient techniquement à sélectionner tous les types d’heures. Cependant, dans ce cas, tous les types d&#39;heures ne sont disponibles pour l&#39;utilisateur que sur les projets, tâches et événements pour lesquels **Non** est sélectionné dans l&#39;option **Filtrer les types d&#39;heures** lors de la modification du projet, comme décrit dans [Définir la disponibilité au niveau du projet](#define-availability-at-the-project-level).
...
1. Cliquez sur Enregistrer les modifications. ****
   ...
   Désormais, lorsque l’utilisateur ou l’utilisatrice enregistre des heures pour un projet, une tâche ou un événement, les types d’heures que vous sélectionnez sont disponibles si ces mêmes types d’heures ont été rendus disponibles au niveau du projet.

## Fonctionnement des types d’heures au niveau de l’utilisateur ou de l’utilisatrice et au niveau du projet

La liste suivante décrit les types d’heures qui s’affichent sur un objet après avoir personnalisé et filtré les types d’heures au niveau de l’utilisateur et au niveau du projet lorsque vous saisissez du temps sur l’objet :
...
* Après avoir personnalisé les types d’heures et défini les types d’heures disponibles pour l’utilisateur ou filtré les types d’heures d’un projet, les scénarios suivants existent :

  * Si vous avez sélectionné tous les types d’heures pour le champ Type d’heure disponible dans le profil de l’utilisateur et que les types d’heures du projet ne sont pas filtrés, l’utilisateur voit tous les types d’heures disponibles lors de la journalisation de l’heure.
  * Si vous avez sélectionné uniquement un sous-ensemble de types d’heures pour le champ Type d’heures disponible dans le profil de l’utilisateur et que les types d’heures du projet ne sont pas filtrés, l’utilisateur ne voit que leurs types d’heures lors de la journalisation de l’heure.
  * Si vous avez sélectionné tous les types d’heures pour le champ Type d’heure disponible dans le profil de l’utilisateur et que les types d’heures du projet sont filtrés, seuls les types d’heures du projet et les types d’heures par défaut tels que Heure du projet, Heure de la tâche ou Heure de l’événement sont affichés, selon l’objet.
  * Si vous avez sélectionné uniquement un sous-ensemble de types d’heures pour le champ Type d’heures disponible dans le profil de l’utilisateur et que les types d’heures du projet sont filtrés, l’utilisateur ne voit que les types d’heures communs à l’utilisateur et au projet. Si aucun type d’heure n’est commun à l’utilisateur ou à l’utilisatrice et au projet, seuls les types d’heures par défaut s’affichent (durée du projet, durée de la tâche, heure du problème).

>[!TIP]
>
>Si vous sélectionnez un autre type d&#39;heures que le type d&#39;heures par défaut pour un objet, le type d&#39;heures devient contigu. La prochaine fois que vous consignez du temps sur le même objet, le type d&#39;heures correspond automatiquement par défaut à celui que vous avez sélectionné en dernier.
