...
title: Présentation de la disposition de la feuille de calcul
description: Cet article décrit la mise en page des feuilles de temps dans Adobe Workfront, ce qui vous permet de mieux comprendre comment personnaliser et utiliser les feuilles de temps pour enregistrer le temps.
author: Alina
feature: Timesheets
...
# Présentation de la disposition de la feuille de calcul
...
Les préférences de feuille de temps et d’heure contrôlent ce qui s’affiche sur une feuille de temps. Cet article présente un aperçu de toutes les options disponibles. Pour plus d’informations, voir [Configuration des préférences de feuille de temps et d’heure](../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/timesheet-and-hour-preferences.md).
...
* Bouton Ajouter un élément à partir duquel vous pouvez ajouter des projets, des tâches ou des problèmes.
* Icône de filtre rapide permettant de rechercher des tâches ou des problèmes dans la feuille de temps.
* Le **Afficher les commentaires** qui vous permet d’afficher ou de masquer les commentaires d’heure consignés pour le projet, la tâche ou les entrées d’heure de publication.
* Icône Plein écran à partir de laquelle vous pouvez afficher la feuille de temps en mode Plein écran.
* **Résumé ouvert** (ou **Fermer le résumé**) à partir duquel vous pouvez ouvrir ou fermer le panneau Résumé pour afficher des informations supplémentaires sur les tâches ou les problèmes. Cette option n’est pas disponible pour les projets.
...
Vous pouvez cliquer sur les boutons Envoyer pour approbation, Fermer, Approuver et Rejeter dans cette zone pour fermer ou refuser une validation de feuille de temps.

Cette zone contient également des informations sur la date de la dernière sauvegarde de la feuille de temps. Toutes les modifications que vous apportez aux informations de la feuille de temps sont automatiquement enregistrées.

## Fonction

![](assets/timesheet-job-role-area-unshimmed-redesign.png)

Vous pouvez sélectionner un autre rôle de tâche à associer aux entrées d’heure. Votre administrateur Workfront doit activer le paramètre Attribuer manuellement les rôles de tâche aux entrées d’heure . Le rôle de tâche spécifié lorsque vous êtes affecté à la tâche ou au problème s’affiche par défaut. Si aucun rôle de tâche n’est attribué à la tâche ou au problème, votre rôle Principal s’affiche comme valeur par défaut. Pour plus d’informations, voir l’article [Configuration des préférences de feuille de temps et d’heure](../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/timesheet-and-hour-preferences.md).
...
Pour plus d’informations, voir [Créer une feuille de temps à usage unique](../create-and-manage-timesheets/create-tmshts.md) ou [Création, modification et affectation de profils de feuille de temps](../create-and-manage-timesheets/create-timesheet-profiles.md).
