   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td>Ce graphique vous permet d’afficher la quantité de transfert de données et d’opérations utilisées tout au long des exécutions du scénario dans un graphique de [!UICONTROL line].</td> 
     </tr> 
     <tr> 
