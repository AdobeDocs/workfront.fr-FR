...
1. Cliquez sur l’icône [!UICONTROL Plus] ![](assets/more-icon.png), puis cliquez sur **[!UICONTROL Versions précédentes]**.

1. Cliquez sur le bouton **[!UICONTROL Sélectionner la version]**, puis sur la version à restaurer.
