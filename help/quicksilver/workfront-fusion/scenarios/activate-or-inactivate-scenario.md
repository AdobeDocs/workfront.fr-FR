...
* Un scénario actif s’exécute périodiquement, selon son planning défini, comme expliqué dans la section [Planifier un scénario dans  [!DNL Adobe Workfront Fusion]](../../workfront-fusion/scenarios/schedule-a-scenario.md).
