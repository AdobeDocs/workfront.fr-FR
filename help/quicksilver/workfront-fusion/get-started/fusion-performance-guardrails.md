...
* Le délai d’exécution par défaut du scénario est le suivant : **40 minutes**. Une fois ce délai dépassé, [!DNL Workfront Fusion] interrompt l’exécution du scénario après le cycle ou l’opération suivant, selon le scénario. Cette action entraîne l’arrêt du scénario peu après l’atteinte de la limite de 40 minutes.
