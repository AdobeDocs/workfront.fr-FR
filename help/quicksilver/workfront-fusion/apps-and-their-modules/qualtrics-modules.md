...
>
>* [Modules Qualtrics](https://experienceleague.adobe.com/docs/workfront-fusion/using/references/apps-and-their-modules/third-party-app-connectors/qualtrics-modules.html)
>
>Mettez à jour les signets.
>
>Cet article n’est plus mis à jour et sera supprimé prochainement.

Dans un scénario [!DNL Adobe Workfront Fusion], vous pouvez automatiser les workflows qui utilisent [!DNL Qualtrics] et le connecter à plusieurs applications et services tiers.
...
## Connecter [!DNL Qualtrics] à [!DNL Workfront Fusion]
