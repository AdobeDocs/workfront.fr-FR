...
* Recherche des fichiers pouvant être écrits par l’utilisateur ou utilisatrice « test@example.org »
...
* Recherche des fichiers pouvant être écrits par les utilisateurs et utilisatrices « test@example.org » et « test2@example.org »
