...
description: Dans un scénario  [!DNL Adobe Workfront Fusion] , vous pouvez automatiser les workflows qui utilisent  [!DNL Azure]  Active Directory et le connecter à de multiples applications et services tiers.
author: Becky
...
Pour utiliser les modules [!DNL Azure Active Directory], vous devez avoir un compte [!DNL Azure Active Directory].
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Pour savoir comment connecter votre compte [!DNL Azure Active Directory] à [!DNL Workfront Fusion], voir <a href="../../workfront-fusion/connections/connect-to-fusion-general.md" class="MCXref xref" data-mc-variable-override="">Créer une connexion à [!DNL Adobe Workfront Fusion] - Instructions de base</a>.</p> </td> 
  </tr> 
  <tr> 
