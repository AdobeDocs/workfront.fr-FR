...
title: Module HTTP > Effectuer une requête d’autorisation de certificat client
...
# Module HTTP > [!UICONTROL Effectuer une requête d’autorisation de certificat client]
...
>
>* [HTTP > Créer un module de demande d’autorisation de certificat client](https://experienceleague.adobe.com/docs/workfront-fusion/using/references/apps-and-their-modules/universal-connectors/http-module-make-a-client-cert-auth-request.html)
>
...
## Configuration du module [!UICONTROL HTTP] > [!UICONTROL Effectuer une requête d’autorisation de certificat client]

Lorsque vous configurez le module [!UICONTROL HTTP] > [!UICONTROL Effectuer une requête d’autorisation de certificat client], [!DNL Adobe Workfront Fusion] affiche les champs répertoriés ci-dessous. Un titre en gras dans un module indique un champ obligatoire.
