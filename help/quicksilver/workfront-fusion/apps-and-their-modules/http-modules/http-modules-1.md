...
* [HTTP >[!UICONTROL Effectuer une requête] module](../../../workfront-fusion/apps-and-their-modules/http-modules/http-module-make-a-request.md)
...
* [Utilisation de TLS mutuel dans les modules HTTP dans [!DNL Adobe Workfront Fusion]](../../../workfront-fusion/apps-and-their-modules/http-modules/use-mtls-in-http-modules.md)
