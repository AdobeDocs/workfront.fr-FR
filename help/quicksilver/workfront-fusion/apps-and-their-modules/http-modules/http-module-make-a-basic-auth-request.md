...
title: HTTP &gt; Créer un module de demande d’autorisation de base
...
Ceci [!DNL Adobe Workfront Fusion] permet de configurer une requête HTTP avec une autorisation de base HTTP et de l’envoyer à un serveur. La réponse HTTP reçue est alors contenue dans le lot de sortie.
...
## [!UICONTROL HTTP] >[!UICONTROL Effectuer une requête d’autorisation de base] configuration du module

Lorsque vous configurez la variable [!UICONTROL HTTP] >[!UICONTROL Effectuer une requête d’autorisation de base] module, [!DNL Adobe Workfront Fusion] affiche les champs répertoriés ci-dessous. Un titre en gras dans un module indique un champ obligatoire.
