  ...
  <tr> 
   ...
   <td> <p>Renseignez les champs suivants :</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL État du document de bibliothèque]</b> </p> <p>Indiquez si le document est en état de création ou principal.</p> </li> 
     ...
     <li> <p><b>[!UICONTROL Date du dernier événement]</b> </p> <p>Entrez la dernière date à laquelle un événement s’est produit dans le document de bibliothèque.</p> <p>Pour obtenir la liste des formats de date et d’heure pris en charge, voir <a href="../../workfront-fusion/mapping/type-coercion.md" class="MCXref xref">Type de contrainte dans [!DNL Adobe Workfront Fusion]</a>.</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Renseignez les champs suivants :</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Est l’administrateur du compte]</b> </p> <p>Cochez cette option si l’utilisateur créé est un administrateur de compte.</p> </li> 
     <li> <p><b>[!UICONTROL User ID]</b> </p> <p>Saisissez l’identifiant unique de l’utilisateur.</p> </li> 
     <li> <p><b>[!UICONTROL ID de compte]</b> </p> <p>Saisissez l’identifiant unique de la variable [!DNL Adobe Acrobat Sign] compte associé à cet utilisateur.</p> </li> 
     ...
     <li> <p><b>Identifiant de groupe Principal</b> </p> <p>Entrez le groupe auquel le nouvel utilisateur est ajouté. Si rien n’est saisi, l’utilisateur est ajouté au groupe par défaut du compte.</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Renseignez les champs suivants :</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Informations sur la mise en valeur]</b> </p> <p>Si votre compte est configuré pour le coffre-fort de documents et que vous avez la possibilité d’activer par accord, vous pouvez activer cette option pour valider ce contrat.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td> <p>Renseignez les champs suivants :</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Type de note]</b> </p> <p>Sélectionner le type de notaire</p> 
      <ul> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Sélectionnez le type de champ associé que vous souhaitez créer.</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Reminders]</b> </p> <p>Renseignez les champs suivants :</p> 
      <ul> 
       ...
       <li> <p><b>[!UICONTROL Status]</b> </p> <p>Pour les nouveaux enregistrements, l’état doit être [!UICONTROL Principal].</p> </li> 
       ...
       <li> <p><b>[!UICONTROL Fréquence de rappel]</b> </p> <p>Définissez la fréquence d'envoi du rappel. Si aucune fréquence n’est fournie, le rappel sera envoyé une seule fois.</p> </li> 
     ...
     <li> <p><b>[!UICONTROL Rapport d’identité du signataire]</b> </p> <p>Saisissez le mot de passe utilisé pour protéger le document du PDF.</p> </li> 
     <li> <p><b>[!UICONTROL Views]</b> </p> <p>Renseignez les champs suivants</p> 
      <ul> 
       ...
       <li> <p><b>[!UICONTROL Utilisateur de connexion automatique]</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> pour connecter automatiquement l’utilisateur à l’URL renvoyée.</p> </li> 
       ...
       <li> <p><b>[!UICONTROL Possibilité de modifier des fichiers]</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> si vous souhaitez que la section de chargement de fichier soit modifiée en ajoutant ou en supprimant des fichiers. Ce n'est pas un mécanisme de contrôle d'accès. La valeur par défaut est [!UICONTROL Oui].</p> </li> 
       <li> <p><b>[!UICONTROL Document de bibliothèque]</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> si vous souhaitez que les liens de documents de bibliothèque soient visibles. La valeur par défaut est [!UICONTROL Oui].</p> </li> 
       <li> <p><b>[!UICONTROL Fichier local]</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> si vous souhaitez que le bouton de téléchargement de fichier local s’affiche. La valeur par défaut est [!UICONTROL Oui].</p> </li> 
       <li> <p><b>[!UICONTROL Connecteurs Web]</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> si vous souhaitez que les liens joignent des documents provenant de sources web apparaissent. La valeur par défaut est Oui.</p> </li> 
       <li> <p><b>[!UICONTROL L Aperçu sélectionné]</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> pour définir la page Composer sur le mode Création.</p> </li> 
      </ul> </li> 
     ...
     <li> <p>[!UICONTROL Déléguer un jeu de participants]</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Identifiant de jeu de participants]</b> </p> <p>Saisissez l'identifiant de l'ensemble de participants.</p> </li> 
       <li> <p><b>[!UICONTROL Informations sur les membres]</b> </p> <p>Pour chaque membre à ajouter, cliquez sur [!UICONTROL Ajouter un élément] et saisissez l’adresse électronique et les informations de téléphone du membre.</p> </li> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Informations sur la vue Bibliothèque]</td> 
   <td> <p>Renseignez les champs suivants :</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Locale]</b> </p> <p>Saisissez la langue dans laquelle vous souhaitez créer la vue. </p> </li> 
     <li> <p><b>[!UICONTROL Aucun indicateur Chrome]</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> pour afficher la page incorporée sans en-tête ou pied de page de navigation.</p> </li> 
     <li> <p><b>[!UICONTROL Envoi de la configuration de vue]</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> si vous souhaitez configurer la vue [!UICONTROL Envoyer], renseignez les champs suivants.</p> 
      <ul> 
       ...
       <li> <p><b>[!UICONTROL Possibilité de modifier des fichiers]</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> si vous souhaitez que la section de chargement de fichier soit modifiée en ajoutant ou en supprimant des fichiers. Ce n'est pas un mécanisme de contrôle d'accès. La valeur par défaut est [!UICONTROL Oui].</p> </li> 
       <li> <p><b>[!UICONTROL Fichier local]</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> si vous souhaitez que les liens de documents de bibliothèque soient visibles. La valeur par défaut est [!UICONTROL Oui].</p> </li> 
       <li> <p><b>[!UICONTROL Connecteurs Web]</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> si vous souhaitez que les liens joignent des documents provenant de sources web apparaissent. La valeur par défaut est [!UICONTROL Oui].</p> </li> 
       <li> <p><b>Est l’aperçu sélectionné</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> pour définir la page Composer sur le mode Création.</p> </li> 
      </ul> <p> </p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>Renseignez les champs suivants :</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Frame parent]</b> </p> <p>Saisissez ou mappez une liste séparée par des virgules d’URL de domaine parent dans laquelle les URL renvoyées peuvent être encadrées. Si rien n’est indiqué, la variable [!DNL Adobe Acrobat Sign] les pages ne sont pas visibles dans iframe.</p> </li> 
     <li> <p><b>Aucun indicateur de chrome</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> pour afficher la page incorporée sans en-tête ou pied de page de navigation.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Saisissez un chemin relatif à <code>https://api.[region].adobesign.com/api/rest/v6/</code></p> <p>Remarque : Pour obtenir la liste des points de fin disponibles, reportez-vous à la section [!DNL Adobe Sign] Référence de l’API.</p> </td> 
  </tr> 
  <tr> 
      ...
      <ul> 
       <li> <p><b>[!UICONTROL Liste d’informations du groupe]</b> </p> <p>Renseignez les champs suivants :</p> 
        <ul> 
         ...
         <li> <p><b>[!UICONTROL Est l’administrateur de groupe]</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> pour faire de cet utilisateur un administrateur de groupe.</p> </li> 
         <li> <p><b>Est un groupe Principal</b> </p> <p>Sélectionner <b>[!UICONTROL Oui]</b> pour mettre à jour ce groupe vers le groupe Principal de l’utilisateur.</p> </li> 
         ...
         <li> <p><b>[!UICONTROL Création de documents de bibliothèque visible]</b> </p> <p>Ces paramètres déterminent si l’utilisateur peut créer des documents de bibliothèque.</p> 
          <ul> 
         ...
         <li> <p><b>[!UICONTROL Envoi limité aux workflows]</b> </p> <p>Ces paramètres déterminent si l’utilisateur peut créer des contrats uniquement à l’aide de workflows.</p> 
          <ul> 
           <li> <p>[!UICONTROL Value]</p> <p>Autoriser</p> </li> 
           <li> <p>[!UICONTROL Hérité]</p> <p>Hériter du paramètre de groupe du groupe ou du compte</p> </li> 
          </ul> </li> 
