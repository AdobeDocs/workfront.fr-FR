...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Accès Modifier aux documents avec l’autorisation Supprimer activée</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Autorisations d’objet</td> 
   <td> <p>Accès Afficher ou supérieur sur l’objet qui contient le document</p> <p>Accès en gestion avec l’autorisation Supprimer activée sur le document</p> </td> 
  </tr> 
 </tbody> 
</table>
