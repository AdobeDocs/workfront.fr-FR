...
1. (Conditionnel) Dans la zone **Choisir le type d’enregistrement**, cliquez sur la carte correspondant au type d’enregistrement à ajouter à partir d’un espace de travail existant, puis cliquez sur **Ajouter**.

   <span class="preview">Si vous utilisez l’environnement de Prévisualisation, vous pouvez cliquer sur pour sélectionner plusieurs types d’enregistrements, puis cliquer sur **Ajouter**. Tous les types d’enregistrements globaux de tous les espaces de travail où ils sont disponibles s’affichent dans la liste.</span>
...
&lt;!—vérifiez auprès de Lilit si nous pouvons ajouter des automatisations ou des formulaires de demande aux RT globaux secondaires??—ajoutez une étape avec des liens vers ces articles si / lorsque oui—>
