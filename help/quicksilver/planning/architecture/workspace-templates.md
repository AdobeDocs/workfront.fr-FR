...
* Chaque modèle est fourni avec un ensemble de types d’enregistrement. Pour plus d’informations, voir [Types d’enregistrement - Aperçu](/help/quicksilver/planning/architecture/overview-of-record-types.md).
