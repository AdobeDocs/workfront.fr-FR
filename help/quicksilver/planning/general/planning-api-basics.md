...
>[!NOTE]
>
>Les utilisateurs doivent être ajoutés au Adobe Admin Console pour être accessibles dans les appels API. Les utilisateurs Workfront uniquement ne sont pas accessibles à l’aide de l’API Adobe Planning.
>
