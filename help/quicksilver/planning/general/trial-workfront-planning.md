...
La version d’essai de Workfront Planning n’est pas disponible pour les clients Workfront Planning actuels. Cette version d’essai est l’occasion pour les clients Adobe Workfront qui ne sont pas des clients de Planning de découvrir Workfront Planning et de voir comment il peut associer la stratégie globale au travail quotidien qui la met en œuvre.
...
* Le contrat d’évaluation juridique signé est disponible dans l’instance Workfront de votre entreprise
...
* **1er mai 2026** : la période d’évaluation de Workfront Planning se termine et votre accès à Planning est supprimé. Workfront sécurise vos données une fois l’essai terminé.
...
* Après le lancement de l’essai le 2 mars 2026, procédez comme suit :
   ...
   1. Cliquez sur **Accepter** après avoir consulté le contrat.
      ...
      * La zone Planning est ajoutée au menu principal pour vous et tous les utilisateurs de votre système avec un badge **Évaluation**.
      * Vous recevez un accès de niveau Gérer à l’onglet **Espaces de travail des bonnes pratiques** dans la zone Planification .
      * Tous les utilisateurs de votre système bénéficient d’un accès en lecture seule à l’onglet **Espaces de travail des bonnes pratiques** dans la zone Planning.
...
* Entre Le 2 Mars Et Le 1Er Mai 2026 :
...
* Après Le 1Er Mai 2026 :
  ...
  Votre accès à Workfront Planning est supprimé et Workfront sécurise vos données.
