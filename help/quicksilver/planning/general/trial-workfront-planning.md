...
>
>* Si vous avez accepté le contrat d’évaluation et êtes inscrit à l’évaluation, il sera disponible entre les dates suivantes : du 2 mars au 1er mai 2026.
>
...
* Avoir accès au Adobe Admin Console
* fait partie du système Identity Management (IMS) ;
...
* **1er mai 2026** : la période d’évaluation de Workfront Planning se termine et votre accès à Planning est supprimé.
...
>[!WARNING]
>
>La période de souscription se termine le 1er avril 2026. Cependant, les fonctionnalités d’évaluation de Planning sont disponibles jusqu’au 1er mai 2026.
...
1. (Conditionnel) Une fois l’accord d’évaluation signé par un administrateur Workfront, cliquez sur le **de l’icône** Menu principal![](assets/main-menu-shell.png), puis sur l’une des options suivantes pour accéder à la zone **Planification** :
   ...
   * **Portefeuilles**, **Programmes** ou à partir d’un portefeuille ou d’un programme    cliquez ensuite sur **Explorer les hiérarchies personnalisées**.
