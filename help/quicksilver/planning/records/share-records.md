...
description: Vous pouvez partager des enregistrements avec d’autres utilisateurs afin d’accroître la collaboration.
hidefromtoc: true
hide: true
...
Vous pouvez partager un enregistrement de planification Adobe Workfront de différentes manières :
...
* Vous pouvez partager tous les enregistrements d’un espace de travail avec d’autres utilisateurs en partageant l’espace de travail. Pour plus d’informations, voir [Partager un espace de travail](/help/quicksilver/planning/access/share-workspaces.md).

Cet article décrit comment copier un lien vers une page d’enregistrement à partir de la vue table d’un type d’enregistrement.
...
<tr>
   ...
   <td> <p>Affichage d’autorisations ou d’autorisations supérieures pour un espace de travail afin de partager un enregistrement à l’aide d’un lien </p>
...
1. Collez le lien dans un email, ou une fenêtre de conversation, à partager avec d’autres utilisateurs. Lorsque les utilisateurs reçoivent le lien, il ouvre la page d’enregistrement.

   >[!TIP]
   >
   >Les champs de la page d’enregistrement sont les mêmes champs disponibles dans la vue Tableau de l’enregistrement.
...
Vous pouvez partager tous les enregistrements dans un espace de travail lorsque vous partagez l’espace de travail avec d’autres personnes. Pour plus d’informations, voir [Partager un espace de travail](/help/quicksilver/planning/access/share-workspaces.md).
