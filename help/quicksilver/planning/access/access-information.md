...
ht-degree: 51%
---
# Informations sur l’accès à la planification Adobe Workfront : index des articles
...
En tant qu’administrateur ou administratrice Workfront, vous devez autoriser vos utilisateurs et utilisatrices à utiliser la planification Adobe Workfront.

Les articles suivants contiennent des informations sur l’accès dont vos utilisateurs et utilisatrices ont besoin pour utiliser les fonctionnalités de la planification Workfront :

* [Présentation de l’accès à Adobe Planning](/help/quicksilver/planning/access/access-overview.md)
* [Vue d’ensemble du partage d’autorisations dans la planification Adobe Workfront](/help/quicksilver/planning/access/sharing-permissions-overview.md)
...
* [Définition des autorisations par défaut pour les enregistrements](/help/quicksilver/planning/access/set-default-record-permissions.md)

<div class="preview">

* [Partager les champs de planification Workfront](/help/quicksilver/planning/access/share-fields.md)
