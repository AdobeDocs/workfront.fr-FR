...
Vous pouvez partager des vues que vous avez créées ou pour lesquelles vous disposez d’autorisations de niveau Gérer avec des utilisateurs, des groupes, des <span class="preview">équipes, des sociétés et des fonctions</span> dans Workfront.
