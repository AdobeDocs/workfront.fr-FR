...
## Aperçu : démarrage rapide, mise à l’échelle intelligente

L’obstacle le plus courant à un déploiement réussi n’est pas la technologie : c’est la « faute de la technologie ». Lorsque les équipes font face à de nouvelles personnes, à de nouveaux processus et à de nouveaux outils à la fois, l’outil devient une cible de frustration.
...
## La transition par phases : l’autonomie guidée

Les déploiements réussis utilisent l’**autonomie guidée**. Cela signifie que l’administrateur définit les « voies sur la route » (paramètres par défaut et modèles régis) tout en permettant aux équipes de choisir leur propre aventure en leur sein.



Plus important encore, l’autonomie guidée est **évolutionnaire**. Au lieu d’appliquer une taxonomie d’entreprise complète au Jour 1, l’administrateur commence par des définitions globales minimales basées sur les besoins de la première équipe pilote. À mesure que d’autres équipes sont intégrées, l’administrateur observe les schémas courants et effectue une itération sur les normes globales. Vous n&#39;abandonnez pas le contrôle; vous le mettez à l&#39;échelle intelligemment en fonction de ce qui fonctionne réellement.



Pour activer ce changement évolutionnaire, choisissez une équipe pilote prête et disposée à innover. Utilisez les 15 premiers jours pour prouver le modèle par l’un des deux chemins à grande vitesse :
...
Dans les deux cas, l’objectif est de passer le plus rapidement possible de la théorie à l’application dans le monde réel, en veillant à ce que l’outil soit utilisé pour un véritable travail stratégique plutôt que de rester un exercice « sandbox ».
