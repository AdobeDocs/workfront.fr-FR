...
1. Pointez sur l’en-tête de la colonne, cliquez sur la flèche pointant vers le bas, puis sur **Masquer le champ**
   ...
   >
   ><span class="preview">Par défaut, les champs masqués ne s&#39;affichent pas dans la zone d&#39;aperçu **Détails** de l&#39;enregistrement. Pour plus d’informations, voir [Gérer la mise en page des enregistrements](/help/quicksilver/planning/records/manage-the-record-page.md)</span>
