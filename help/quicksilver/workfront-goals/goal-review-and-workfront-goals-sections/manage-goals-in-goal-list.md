...
title: Gérer les objectifs dans la liste d’objectifs d’Adobe Workfront
description: Une fois que vous ou d’autres personnes avez créé des objectifs, vous pouvez consulter leur progression et leurs informations dans la liste des objectifs. Pour plus d’informations sur la création d’objectifs, voir Créer des objectifs dans Objectifs Adobe Workfront.
author: Alina
...
Pour plus d’informations, voir [Vue d’ensemble des sections d’Objectifs Adobe Workfront](../../workfront-goals/goal-review-and-workfront-goals-sections/overview-of-wf-goals-sections.md).
...
1. Cliquez sur l’icône **Menu principal** ![icône du menu principal](assets/lines-main-menu.png) dans le coin supérieur droit, puis cliquez sur **Objectifs**.
   ...
   * **Statut** : le statut de l’objectif peut être l’un des suivants :
     ...
     Pour plus d’informations sur le statut des objectifs, voir [Vue d’ensemble du statut des objectifs dans Objectifs Adobe Workfront](../goal-management/goal-status-overview.md).
   ...
   * **Condition** : représentation visuelle de la progression de la réalisation de l’objectif pendant la période allouée à l’objectif.
     ...
     Pour plus d’informations sur les conditions des objectifs, voir [Vue d’ensemble de la progression et de l’état des objectifs dans Objectifs Adobe Workfront](../goal-management/calculate-goal-progress.md).
   ...
   * **Progression** : indicateur de progression de l’objectif sous forme de valeur en pourcentage. La couleur de l’indicateur de progression correspond à la couleur de la condition de l’objectif.
     ...
     Pour plus d’informations, voir [Calculer la progression des objectifs dans Objectifs Adobe Workfront](../goal-management/calculate-goal-progress.md).

1. Cliquez sur l’icône de filtre ![icône de filtre](assets/filter-icon.png) dans le coin supérieur droit de la liste des objectifs et appliquez des filtres pour afficher uniquement les objectifs qui sont importants pour vous.
...
1. Sélectionnez un objectif dans la liste, puis cliquez sur l’une des options suivantes en haut de la liste :
   * Icône **Modifier** ![Modifier](assets/edit-icon.png) pour modifier les informations sur l’objectif. Pour plus d’informations, voir [Modifier des objectifs dans Objectifs Adobe Workfront](../goal-management/edit-goals.md).
   * **Icône Partager** ![Icône Partager](assets/share-icon.png) pour partager l’objectif avec d’autres personnes. Pour plus d’informations, voir [Partager un objectif dans Objectifs Adobe Workfront](../workfront-goals-settings/share-a-goal.md).
   * **Ouvrir l’alignement** icône ![Ouvrir l’icône d’alignement](assets/align-icon-unshimmed.png) pour ouvrir la zone Alignement des objectifs. Cette option ne s’affiche que lorsque l’objectif que vous sélectionnez est aligné sur un autre objectif.
   * Icône **Supprimer** ![Icône Supprimer](assets/delete-icon.png) pour supprimer l’objectif, puis cliquez sur **Supprimer** pour confirmer.  Pour plus d’informations, voir [Supprimer et désactiver des objectifs dans Objectifs Adobe Workfront](../goal-management/delete-and-deactivate-goals.md).
