...
Pour plus d’informations sur la personnalisation de la terminologie dans Workfront, voir [Personnaliser la terminologie de l’interface utilisateur à l’aide d’un modèle de mise en page](../../administration-and-setup/customize-workfront/use-layout-templates/customize-terminology.md).
