...
En cours de configuration [!DNL Workfront] pour [!DNL Jira], as a [!DNL Jira] administrateur système, vous pouvez configurer certains champs d’une application afin de les synchroniser avec les champs des éléments liés de l’autre application.
...
<table style="table-layout:auto"> 
 ...
 <thead> 
  <tr> 
   <th><strong>Mis à jour [!DNL Workfront] field</strong> </th> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[!UICONTROL Nom du problème]</p> <p>Un commentaire sur le changement de nom est ajouté au <strong>[!DNL Workfront]</strong> de la [!DNL Jira] problème. </p> </td> 
  </tr> 
  <tr> 
   <td>[!UICONTROL Problème ou description de la tâche]</td> 
   <td> <p> [!UICONTROL Description du problème]</p> <p>Un commentaire sur la Description mise à jour est ajouté à la variable <strong>[!DNL Workfront]</strong> de la [!DNL Jira] problème.<br></p> </td> 
  </tr> 
  <tr> 
   <td> <p> [!UICONTROL Documents téléchargés]</p> <p>Remarque : documents liés à [!DNL Workfront] les éléments d’un serveur externe ne sont pas transférés vers [!DNL Jira] problèmes. Seuls les documents téléchargés directement vers [!DNL Workfront] Les éléments sont également mis à jour vers le lien [!DNL Jira] problèmes. </p> </td> 
   <td> <p>[!UICONTROL Pièces jointes]</p> <p>Un commentaire sur les pièces jointes chargées est ajouté à la variable <strong>[!DNL Workfront]</strong> de la [!DNL Jira] problème.<br></p> </td> 
  </tr> 
  <tr> 
   <td>[!UICONTROL Date d’achèvement prévue]</td> 
   <td> <p>[!UICONTROL Échéance]</p> <p>Un commentaire sur la modification de la [!UICONTROL Échéance] est ajouté à la variable [!DNL Workfront] de la [!DNL Jira] problème. </p> <p>Remarque : Vous devez activer <strong>[!UICONTROL Échéance]</strong> pour votre [!DNL Jira] problèmes pour pouvoir voir ce champ mis à jour dans [!UICONTROL Jira]. </p> </td> 
  </tr> 
  <tr> 
   <td>Forms et champs personnalisés</td> 
   <td> <p> Afficher dans le [!DNL Workfront] panneau droit de [!DNL Jira] problème. <br>Seuls les champs personnalisés ayant une valeur réelle s’affichent dans le panneau.<br></p> <p>Remarque : les sections Formulaire personnalisé s’affichent avec le niveau d’accès de la variable [!DNL Workfront] administrateur. </p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <thead> 
  <tr> 
   <th><strong>Mis à jour [!DNL Jira] Champ</strong> </th> 
...
L’heure à laquelle vous enregistrez pour un [!DNL Jira] élément dans [!DNL Jira] sera également transféré au lien [!DNL Workfront] élément, quel que soit l’emplacement dans [!DNL Jira] vous enregistrez l&#39;heure.\
...
>[!NOTE]
>
>Si l’heure est ajoutée à une [!DNL Jira] élément lié à un [!DNL Workfront] la tâche, [!UICONTROL Type d’heure] pour l’heure en [!DNL Workfront] is [!UICONTROL Heure de tâche]. Si l’heure est ajoutée à une [!DNL Jira] élément lié à un [!DNL Workfront] le problème, [!UICONTROL Type d’heure] pour l’heure en [!DNL Workfront] is [!UICONTROL Heure de publication].

Un commentaire est ajouté au **[!DNL Workfront]** dans [!DNL Jira] et au **[!UICONTROL Mises à jour]** de l’élément dans [!DNL Workfront] pour enregistrer l’heure.\
L’heure est également affichée dans la variable **[!UICONTROL Heures]** de la [!DNL Workfront] élément .
...
1. Développez l’objet **[!UICONTROL Plus]** et cliquez sur **[!UICONTROL Travail de journal]**.
...
1. Continuez à ajouter des informations à votre saisie horaire, y compris une **[!UICONTROL Description du travail]**, puis cliquez sur **[!UICONTROL Journal]**.\
   L’heure est ajoutée à la variable **[!UICONTROL Journal de travail]** de la [!DNL Jira] , ainsi qu’au [!DNL Workfront] élément qui lui est lié.\
   La description de travail de la saisie temporelle est enregistrée en tant que note sur la saisie horaire dans [!DNL Workfront].
...
1. Accédez à un [!DNL Jira] problème lié à un [!DNL Workfront] élément .
   ...
   Les détails de la variable [!DNL Workfront] doit s’afficher dans la variable [!DNL Workfront] panneau droit du problème.
...
1. Cliquez sur **[!UICONTROL Temps journal]**.
   ...
   Cette fois-ci, la fonction [!UICONTROL Journal de travail] de la [!DNL Jira] problème.
...
1. Commencez à saisir un commentaire, puis cliquez sur **[!UICONTROL Envoyer]**.
   ...
   * La variable **[!DNL Workfront]** de la [!DNL Jira] problème.
   * La variable **[!UICONTROL Commentaires]** de la [!DNL Jira] problème.
   * La variable **[!UICONTROL Mises à jour]** de l’élément lié dans Workfront.
