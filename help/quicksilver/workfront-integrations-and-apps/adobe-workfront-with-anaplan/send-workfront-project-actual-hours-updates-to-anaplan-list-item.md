...
description: Ce scénario d’intégration partage les détails sur les heures réelles capturées dans un projet  [!DNL Adobe Workfront] avec un élément de liste de budget  [!DNL Anaplan] . Le partage de ces informations vous permet de mieux tirer parti de l’optimisation des dépenses et de l’analyse financière fournie par [!DNL Anaplan] .
author: Becky
...
# Envoyer [!DNL Adobe Workfront] mises à jour d’heures réelles à un élément de liste [!DNL Anaplan]

Ce scénario d’intégration partage les détails des heures réelles capturés dans un projet [!DNL Adobe Workfront] avec un élément de liste de budgets [!DNL Anaplan]. Le partage de ces informations vous permet de mieux tirer parti de l’optimisation des dépenses et de l’analyse financière fournie par [!DNL Anaplan].

Ce modèle de scénario fournit une liste des heures résumées par projet, jour et rôle enregistré sur les projets actifs au cours des 3 derniers mois.
...
* Un profil utilisateur de [!DNL Workfront] nommé **[!UICONTROL Intégration Anaplan]**, disposant des droits d’administrateur système.
...
* Un fichier de [!DNL Anaplan] nommé **[!UICONTROL Anaplan Real Hours Import]** contenant les colonnes suivantes, dans cet ordre :

   1. [!UICONTROL GUID de projet Workfront]

   2. [!UICONTROL Heures]

   3. [!UICONTROL Hours Coût estimé]
  ...
  Pour préparer le fichier [!DNL Anaplan] Rapport de dépenses réelles :
...
* Un processus **[!UICONTROL d’&#39;importation des heures réelles du projet]** préparé pour exécuter l’&#39;importation des données fournies dans un téléchargement de fichier.
...
1. Accédez au menu [!UICONTROL Modèles] dans [!DNL Workfront Fusion] et cliquez sur le modèle de scénario **[!UICONTROL Envoyer les mises à jour des heures réelles Workfront à [!DNL Anaplan] élément de liste]** .
1. Remplacez les valeurs de variable pour les variables [!DNL Anaplan] suivantes :
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td role="rowheader">[!UICONTROL Nom de fichier : importation des heures réelles]</td> 
     ...
     <tr> 
      <td role="rowheader">[!UICONTROL Nom du processus : importation des heures réelles]</td> 
