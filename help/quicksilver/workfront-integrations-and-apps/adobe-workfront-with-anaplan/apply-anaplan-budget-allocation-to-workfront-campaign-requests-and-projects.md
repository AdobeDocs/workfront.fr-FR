...
title: Appliquer une allocation de budget  [!DNL Anaplan]  à une demande de campagne ou à un projet de campagne  [!DNL Adobe Workfront]
...
# Application d’une allocation de budget [!DNL Anaplan] à une requête de campagne ou à un projet de campagne [!DNL Adobe Workfront]

Ce scénario d’intégration synchronise toutes les allocations budgétaires qui ont été effectuées dans [!DNL Anaplan] avec [!DNL Workfront]. Le scénario récupère tous les éléments de budget de campagne liés, puis transmet la valeur du budget au projet [!DNL Workfront] lié si la valeur du budget a été modifiée.
...
* Profil utilisateur dans [!DNL Workfront] nommé **[!DNL Anaplan Integration]**, disposant des droits d’administrateur système.
...
* Une vue dans [!DNL Anaplan] appelée **[!UICONTROL Campaigns.Update Campaigns dans Adobe Workfront]**.
  ...
  Cette vue doit contenir les colonnes suivantes, dans cet ordre :
   ...
   3. [!UICONTROL [!DNL Workfront] GUID de projet ]

   4. [!UICONTROL Nom de la campagne]

   5. [!UICONTROL Budget]

   6. [!UICONTROL Recettes estimées]

   7. [!UICONTROL Brand]

  La vue doit être filtrée pour afficher les éléments qui ont un [!UICONTROL [!DNL Workfront] GUID de projet ] et certains indicateurs que les allocations budgétaires doivent être transmises à Workfront.

Pour obtenir des instructions sur l’une de ces actions, consultez la documentation [!DNL Anaplan].

## Déploiement sur Workfront Fusion
...
1. Accédez au menu [!UICONTROL Modèles] dans [!DNL Workfront Fusion] et cliquez sur le modèle de scénario **[!UICONTROL Appliquez [!DNL Anaplan] les allocations budgétaires aux demandes de campagne et aux projets Workfront]** .
...
1. Sur le module **[!UICONTROL Convertir un fichier CSV en objet JSON]** , ajoutez une nouvelle structure de données pour mapper les colonnes CSV à un objet JSON utilisable.
