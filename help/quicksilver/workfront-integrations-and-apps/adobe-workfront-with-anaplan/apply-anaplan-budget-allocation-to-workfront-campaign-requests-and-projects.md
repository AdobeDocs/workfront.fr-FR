...
title: Appliquez une [!DNL Anaplan] allocation d’un budget à un [!DNL Adobe Workfront] requête de campagne ou projet de campagne
...
# Appliquez une [!DNL Anaplan] allocation d’un budget à un [!DNL Adobe Workfront] requête de campagne ou projet de campagne

Ce scénario d’intégration synchronise toutes les allocations budgétaires qui ont été effectuées dans [!DNL Anaplan] Retour à [!DNL Workfront]. Le scénario récupère tous les éléments de budget de l’opération liés, puis transmet la valeur du budget à l’élément lié [!DNL Workfront] project si la valeur du budget a été modifiée.
...
* Un profil utilisateur dans [!DNL Workfront] named **[!DNL Anaplan Integration]**, qui dispose des droits d’administrateur système.
...
* Une vue dans [!DNL Anaplan] appelé **[!UICONTROL Campagnes.Mettre à jour les campagnes dans Adobe Workfront]**.

   Cette vue doit contenir les colonnes suivantes, dans cet ordre :

   1. [!UICONTROL Nom de l’élément]

   2. [!UICONTROL [!DNL Workfront] GUID de requête]

   3. [!UICONTROL [!DNL Workfront] GUID du projet]
   ...
   7. [!UICONTROL Marque]
   La vue doit être filtrée pour afficher les éléments qui ont une [!UICONTROL [!DNL Workfront] GUID du projet] et quelques indicateurs indiquant que les allocations budgétaires doivent être transmises à Workfront.
...
1. Accédez au [!UICONTROL Modèles] dans [!DNL Workfront Fusion] et cliquez sur le bouton **[!UICONTROL Appliquer [!DNL Anaplan] allocations budgétaires pour les demandes et projets de campagne Workfront]** modèle de scénario.
...
1. Sur le **[!UICONTROL Convertir un fichier CSV en objet JSON]** , ajoutez une nouvelle structure de données pour mapper les colonnes CSV à un objet JSON utilisable.
