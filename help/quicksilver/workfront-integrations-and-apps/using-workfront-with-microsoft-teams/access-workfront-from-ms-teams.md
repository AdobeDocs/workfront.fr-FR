...
title: Accès aux [!DNL Adobe Workfront] de [!DNL Microsoft] Teams
description: Vous pouvez accéder aux [!DNL Adobe Workfront] à partir de [!DNL Microsoft Teams] et effectuer plusieurs actions dans [!DNL Workfront] en saisissant des commandes dans le canal de robot Workfront ou tout autre canal d’équipe.
author: Becky
