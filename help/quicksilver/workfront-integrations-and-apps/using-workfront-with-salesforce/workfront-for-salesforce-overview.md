...
description: Vous pouvez installer [!DNL Adobe Workfront] for Salesforce pour permettre à vos utilisateurs Salesforce d’envoyer des demandes de [!DNL Workfront] et de créer automatiquement des projets sans jamais quitter Salesforce.
author: Becky
