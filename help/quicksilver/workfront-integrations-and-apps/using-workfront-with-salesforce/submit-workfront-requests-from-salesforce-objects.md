...
description: Après l’installation de [!DNL Adobe Workfront] pour [!DNL Salesforce], vous pouvez envoyer des demandes de [!DNL Workfront] à partir d’Opportunités et comptes [!DNL Salesforce]. Cette fonctionnalité est disponible dans les frameworks d’expérience Classic et Lightning.
author: Becky
