...
title: Charger des documents à partir d’InDesign
...
# Charger des documents depuis [!DNL InDesign]
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Accès en affichage ou supérieur à l’objet dans lequel vous souhaitez charger un document.</p></td> 
  </tr> 
 </tbody> 
</table>
...
* Vous devez installer le plug-in [!DNL Adobe Workfront for design and video] avant de pouvoir charger des documents à partir d’[!DNL InDesign].
...
## Charger des documents vers [!DNL InDesign]
