...
title: Réponse à un commentaire d’Outlook
description: Lorsque vous recevez une [!DNL Adobe Workfront] une notification par e-mail dans votre boîte de réception Outlook, vous pouvez rapidement publier un commentaire sur [!DNL Workfront] simplement en répondant à la notification dans Outlook.
author: Becky
...
# Réponse à un commentaire de [!DNL Outlook]

Lorsque vous recevez une [!DNL Adobe Workfront] notification électronique dans votre [!DNL Outlook] boîte de réception, vous pouvez rapidement publier un commentaire sur [!DNL Workfront] simplement en répondant à la notification dans Outlook.
...
1. Sélectionnez la [!DNL Workfront] notification électronique contenant le commentaire auquel vous souhaitez répondre.
...
1. Cliquez sur **[!UICONTROL Réponse au commentaire]**.
