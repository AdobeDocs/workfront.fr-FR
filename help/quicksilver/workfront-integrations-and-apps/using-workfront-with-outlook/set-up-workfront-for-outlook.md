...
Le [!DNL Adobe Workfront] [!DNL Outlook] module complémentaire vous permet d’effectuer les opérations suivantes : [!DNL Workfront] tâches directement depuis Outlook :
...
* Ajoutez un email comme tâche dans votre [!UICONTROL Mon travail] zone. Pour plus d’informations, voir [Ajoutez un [!DNL Outlook] email en tant que tâche à votre liste de travail](../../workfront-integrations-and-apps/using-workfront-with-outlook/add-outlook-email-as-task-to-your-work-list.md).
...
* **[!DNL Outlook]sur le Web :** Le [!DNL Workfront] est disponible lors de l’utilisation de [!DNL Outlook] à partir d’un navigateur web, que ce soit sur un ordinateur de bureau ou un périphérique mobile. Cette fonctionnalité est également disponible lors de l’utilisation de la fonction [!DNL Outlook] application web.
* **[!DNL Outlook]Application de bureau :** Le [!DNL Workfront] est disponible lors de l’utilisation de la fonction [!DNL Windows] et [!DNL Mac] Versions de bureau de [!DNL Outlook] inclus dans [!DNL Office] module.

Le [!DNL Workfront] module complémentaire pour [!DNL Outlook] est pris en charge dans les environnements qui répondent aux exigences suivantes :
...
* Nous soutenons [!DNL Exchange 2016 On-Premise]
...
* Le serveur doit disposer d’un certificat d’authentification valide pour que le serveur puisse émettre des jetons d’identité valides. Nouvelles installations de [!DNL Exchange Server] incluez un certificat d’authentification par défaut.
   ...
   Pour plus d’informations, voir [Certificats numériques et chiffrement dans [!DNL Exchange 2016]](https://technet.microsoft.com/en-us/library/dd351044(v=exchg.160).aspx) et [Set-AuthConfig](https://technet.microsoft.com/en-us/library/jj215766(v=exchg.160).aspx).
...
1. Dans [!DNL Outlook 365], cliquez sur le bouton **[!UICONTROL Parcourir les modules complémentaires]** icon ![](assets/outlook-add-in-26x26.png)dans la partie supérieure de l’interface d’Office 365, puis cliquez sur **[!UICONTROL Gestion des modules complémentaires]**.
...
1. Rechercher **[!DNL Workfront]** dans le **[!UICONTROL Rechercher des modules complémentaires]** champ, puis appuyez sur **[!UICONTROL Entrée]**.
...
1. Rechercher **[!DNL Workfront]** dans le **[!UICONTROL Rechercher]** champ, puis appuyez sur **[!UICONTROL Entrée]**.

1. Cliquez sur le bouton bascule pour activer la fonction **[!UICONTROL [!DNL Workfront]add-in]**.

## Connectez-vous à [!DNL Workfront] de [!DNL Outlook]
