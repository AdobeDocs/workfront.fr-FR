...
title: Présentation des intégrations Adobe Workfront
description: Adobe Workfront propose des intégrations à d’autres applications courantes, telles que la [!DNL Adobe Creative Cloud], [!DNL Salesforce], Jira et Slack. Cet article renvoie à la documentation de toutes les intégrations actuellement proposées.
...
* [[!DNL Adobe Workfront] présentation des intégrations intégrées](../workfront-integrations-and-apps/built-in-integrations-non-admin.md)
* [[!DNL Adobe Workfront] méthodes d’intégration](../workfront-integrations-and-apps/built-in-vs-api-vs-fusion.md)
...
* [[!DNL Adobe Workfront for Microsoft Teams]: index de l’article](../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/use-workfront-with-ms-teams.md)
