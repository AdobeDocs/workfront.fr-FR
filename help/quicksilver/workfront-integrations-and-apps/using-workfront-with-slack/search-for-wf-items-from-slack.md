...
title: Rechercher des éléments sur [!DNL Adobe Workfront] à partir de [!DNL Slack]
description: Vous pouvez rechercher des éléments [!DNL Adobe Workfront] à partir de [!DNL Slack], si l’application [!DNL Workfront] a été installée sur votre instance de Slack.
author: Becky
