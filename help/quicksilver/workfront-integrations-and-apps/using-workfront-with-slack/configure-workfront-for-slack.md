...
description: L’intégration de [!DNL Adobe Workfront] à Slack vous permet d’accéder aux éléments de travail, aux approbations, aux favoris et aux éléments récents de Slack, ainsi que de les créer [!DNL Workfront].
author: Becky
