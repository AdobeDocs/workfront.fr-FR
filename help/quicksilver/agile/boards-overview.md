...
Pour plus d’informations sur l’utilisation des fonctions de base des panoramas, voir [Prise en main des panoramas : index des articles](../agile/get-started-with-boards/get-started-with-boards.md). Pour plus d’informations sur les outils de planification AEM dans les panoramas, voir [Présentation des outils de planification Agile](/help/quicksilver/agile/use-boards-agile-planning-tools/agile-planning-tools-overview.md).
...
Pour consulter les vidéos pas à pas des fonctionnalités des panoramas, voir [[!DNL Adobe Workfront] [!UICONTROL Panoramas] démonstrations vidéo](/help/quicksilver/agile/get-started-with-boards/boards-video-demonstrations.md).
