...
1. Cliquez sur le menu **[!UICONTROL Plus]** ![](assets/more-menu.png), puis sélectionnez **[!UICONTROL Modifier]**.
   ...
   ![Modifier une équipe](assets/edit-team-settings-kanban.png)
...
Par défaut, les types de données suivants s’affichent sur la carte de l’article pour les tâches et les événements :
...
Pour utiliser cette fonctionnalité, vous devez activer le paramètre **Afficher la liste d’attente** sur le panorama [!UICONTROL Kanban].

Chaque fois qu’une histoire est déplacée de la colonne [!UICONTROL En cours] vers une colonne du storyboard qui représente un statut [!UICONTROL Terminé] (ou un statut équivalent à [!UICONTROL Terminé]), l’histoire suivante de la colonne Portefeuille est automatiquement déplacée vers la colonne [!UICONTROL Nouveau] du tableau [!UICONTROL Kanban].

L’histoire suivante est l’histoire incomplète avec le plus petit numéro de commande de liste d’attente qui répond à tous les critères suivants :

* Il est attribué à l’équipe.
* Il n’a pas de date d’achèvement effective (c’est-à-dire qu’il n’est pas encore terminé).
* Il n’est pas déjà sur un tableau Kanban.
* Il appartient à un projet avec un statut actuel.

L’ordre de la liste d’attente est différent de la priorité. Vous pouvez organiser l’ordre de la liste d’attente en faisant glisser et en déposant des histoires dans la colonne Liste d’attente. L&#39;histoire qui se trouve en haut de l&#39;arriéré est celle qui est ensuite inscrite au tableau.

Pour ajouter automatiquement des histoires de la liste d’attente au panorama [!UICONTROL Kanban] :
...
1. Sélectionnez l’équipe Kanban que vous souhaitez gérer.
1. Cliquez sur le menu **[!UICONTROL Plus]** ![](assets/more-menu.png), puis sélectionnez **[!UICONTROL Modifier]**.
1. Sélectionnez **[!UICONTROL Ajouter automatiquement l’histoire suivante à partir de la liste d’attente]** pour configurer l’élément suivant de la liste d’attente afin qu’il soit automatiquement ajouté à la colonne **[!UICONTROL Nouveau]** lorsqu’un élément est déplacé hors de la colonne **[!UICONTROL En cours]**.
