...
description: Vous pouvez créer un article Agile sur une itération de différentes manières. Après avoir créé un article Agile, vous pouvez ajouter des tâches subordonnées à l’article.
author: Courtney
feature: Agile
...
Vous pouvez créer un article Agile sur une itération de différentes manières. Après avoir créé un article Agile, vous pouvez ajouter des tâches subordonnées à l’article.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Gérer l’accès au projet sur lequel se trouve l’article </td> 
  </tr> 
 </tbody> 
</table>
...
1. Accédez à l’itération Agile dans laquelle vous souhaitez créer l’article :
...
## Création d’un article Agile dans le journal des travaux en souffrance

Vous pouvez créer un article Agile à partir du portefeuille de travaux Agile, comme décrit dans la section [Créer de nouveaux articles sur le portefeuille de travaux](../../agile/work-in-an-agile-environment/manage-the-agile-backlog.md#creating-new-stories) de l&#39;article [[!UICONTROL Gérer] le portefeuille de travaux Agile](../../agile/work-in-an-agile-environment/manage-the-agile-backlog.md).

## Ajout d’une tâche ou d’un problème sous la forme d’un article Agile
...
## Création de tâches subordonnées dans un article Agile

Vous pouvez créer une tâche secondaire pour un article Agile en utilisant l’une des méthodes suivantes :
