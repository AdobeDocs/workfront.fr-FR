...
L’objet connecté, les personnes désignées, les balises, la date d’échéance, le compteur de liste de contrôle, le nombre d’heures estimé et le statut s’affichent sur la carte.
