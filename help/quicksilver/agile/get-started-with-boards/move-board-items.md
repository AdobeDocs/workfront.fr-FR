...
1. Faites glisser la carte et déposez-la dans une autre colonne, à l’emplacement où elle doit apparaître.
   ...
   Cliquez sur le menu **[!UICONTROL Plus]** ![Plus de menu](assets/more-icon-spectrum.png) sur la carte, puis sélectionnez **[!UICONTROL Déplacer]**. Ensuite, dans la zone **[!UICONTROL Déplacer l’élément]**, choisissez une autre colonne et sélectionnez **[!UICONTROL Déplacer]**.
