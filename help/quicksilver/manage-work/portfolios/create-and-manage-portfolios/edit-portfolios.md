...
Vous pouvez modifier un [!UICONTROL portfolio] dans la page des portfolios ou modifier des portfolios dans une liste.
...
1. Pour modifier toutes les informations relatives à un ou plusieurs portfolios, effectuez l’une des opérations suivantes :
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td> <p>Mettez à jour le nom du portfolio. </p> <p>Conseil : cette option n’est pas disponible lorsque vous avez sélectionné plusieurs portfolios. </p> </td> 
     </tr> 
     <tr> 
