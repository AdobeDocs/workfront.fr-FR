...
title: Comprendre la méthodologie Portfolio
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <p>Gérer les autorisations de modification d’un portfolio ou d’ajout de projets</p>
   <p>Afficher les autorisations d’un portfolio pour l’afficher dans Workfront</p>
    </td> 
  </tr> 
 </tbody> 
</table>
...
1. Créez un business case pour un projet et associez-le à un portfolio.
   ...
   * Évaluation des risques
   ...
   Vous pouvez associer le projet à un portefeuille tout en établissant son business case. Vous devez créer un portefeuille avant de pouvoir l’associer à un projet. Pour plus d’informations, voir [Création d’un portfolio](/help/quicksilver/manage-work/portfolios/create-and-manage-portfolios/create-portfolios.md)

   Les détails que vous collectez lors de la création d’un business case sont utilisés dans l’[!UICONTROL optimiseur de portefeuille] et le [!UICONTROL planificateur de ressources] pour aider la direction à sélectionner les projets.
...
1. Faites approuver le [!UICONTROL business case] par la personne chargée de la gestion de vos portfolios.
   ...
   Pour plus d’informations, voir [Approuver un business case](/help/quicksilver/manage-work/projects/define-a-business-case/approve-business-case.md).
