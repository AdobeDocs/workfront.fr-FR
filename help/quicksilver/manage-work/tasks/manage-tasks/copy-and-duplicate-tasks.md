...
* Si votre entreprise utilise à la fois l’espace de stockage cloud Workfront hérité et Adobe, vous ne pouvez pas copier de tâches entre des projets qui utilisent différents types de stockage.
