...
* Lorsque votre entreprise utilise à la fois l’espace de stockage cloud Workfront et Adobe hérité, vous ne pouvez pas copier de tâches entre des projets qui utilisent différents types de stockage.
...
Les tâches copiées se trouvent maintenant dans le projet spécifié et sont soit des sous-tâches de la tâche parent sélectionnée, soit les dernières tâches du projet.
