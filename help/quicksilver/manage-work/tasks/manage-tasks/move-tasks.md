...
* Si votre entreprise utilise à la fois l’espace de stockage cloud Workfront hérité et Adobe, vous ne pouvez pas déplacer les tâches entre les projets qui utilisent différents types de stockage.
