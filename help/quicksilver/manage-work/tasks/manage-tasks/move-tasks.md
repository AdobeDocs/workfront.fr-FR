...
* Lorsque votre entreprise utilise à la fois l’espace de stockage cloud Workfront et Adobe hérité, vous ne pouvez pas déplacer les tâches entre les projets qui utilisent différents types de stockage.
