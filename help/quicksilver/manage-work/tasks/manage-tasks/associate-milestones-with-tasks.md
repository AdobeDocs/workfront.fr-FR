...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Accès en modification aux tâches</p> <p><b>NOTE</b>
...
* L’administrateur Workfront doit créer un chemin de jalon, comme décrit dans la section [Créer un chemin de jalon](../../../administration-and-setup/customize-workfront/configure-approval-milestone-processes/create-milestone-path.md).
...
1. Cliquez sur **Paramètres**, puis sélectionnez un jalon dans le champ **Milestone** pour la tâche.
1. Cliquer sur **Enregistrer**.
1. (Facultatif) Dans une liste de tâches, ajoutez la colonne **Icônes d’état** pour identifier les tâches qui comportent des jalons. L’indicateur de losange Milestone s’affiche dans la colonne Icônes d’état.
...
1. (Facultatif) Accédez à une liste de projets, sélectionnez la vue **Milestone** pour identifier la progression de vos tâches de jalon.
