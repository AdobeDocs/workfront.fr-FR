...
La contrainte Doit commencer à planifie le démarrage d’une tâche exactement à l’heure et à la date spécifiées dans le champ **Date de début planifiée**.
...
* La tâche affiche **En danger** si les prédécesseurs commencent à courir en retard ou en retard.

* Lorsque vous déplacez ou copiez une tâche avec une contrainte MSO vers un autre projet, la contrainte de la tâche ou des dates du projet peut changer en fonction des dates de contrainte et des dates de début et de fin du projet. Les scénarios suivants sont possibles :
