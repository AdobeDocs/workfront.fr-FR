...
title: Mise à jour du type de durée d’une tâche
description: Le Type de durée d’une tâche identifie la relation entre le nombre de ressources affectées à une tâche, l’effort total et la Durée totale de la tâche. Pour plus d’informations, voir Présentation de la durée de la tâche et du type de durée.
author: Alina
...
Le Type de durée d’une tâche identifie la relation entre le nombre de ressources affectées à une tâche, l’effort total et la Durée totale de la tâche. Pour plus d’informations, voir [Présentation de la durée et du type de durée de la tâche](../../../manage-work/tasks/taskdurtn/task-duration-and-duration-type.md).

## Exigences d’accès

Pour modifier le type de durée d’une tâche, vous devez disposer des éléments suivants :
