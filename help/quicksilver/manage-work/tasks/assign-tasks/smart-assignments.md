...
Les affectations identifiées sont répertoriées dans les sections **Utilisateurs et équipes** et **Fonctions**<!--, and <span class="preview">**Rate card roles**</span>--> du champ Affectations.
