...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">Adobe Workfront ou package de workflow</td> 
   <td> <p>Tous </p> </td> 
  </tr> 
  <tr> 
...
-->
* Votre organisation doit disposer d’un package de workflow ou Workfront Select, Prime ou Ultimate
