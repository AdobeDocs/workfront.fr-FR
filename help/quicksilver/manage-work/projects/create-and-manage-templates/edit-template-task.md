...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Modifier l’accès aux modèles</p> <p>Remarque : Si vous disposez d’un accès correct, mais que vous ne pouvez toujours pas modifier une tâche de modèle, demandez à votre administrateur Workfront s’il définit des restrictions supplémentaires à votre niveau d’accès. Pour plus d’informations sur la façon dont un administrateur Workfront peut modifier votre niveau d’accès, voir <a href="../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">Création ou modification de niveaux d’accès personnalisés</a>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"><strong>Autorisations d’objet</strong> </td> 
   <td> <p>Gérez les autorisations d’un modèle. </p> <p>Contribuez à la tâche de modèle ou à des autorisations supérieures.</p> <p>Pour plus d’informations sur la demande d’accès aux objets, voir <a href="../../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Demande d’accès aux objets </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>

&#42;Pour connaître votre plan, votre type de licence ou votre niveau d’accès, contactez votre administrateur Workfront.
...
1. (Conditionnel) Pour modifier des informations limitées sur la tâche de modèle, cliquez sur **Détails de la tâche de modèle** dans le panneau de gauche, accédez aux sections de la section Détails pour modifier les informations de chaque zone.
...
1. (Conditionnel) Pour modifier toutes les informations relatives à la tâche de modèle, cliquez sur le bouton **Plus** menu ![](assets/qs-more-icon-on-an-object.png) en regard du nom de la tâche de modèle, puis cliquez sur **Modifier**.
   ...
   Le **Modifier la tâche du modèle** s’affiche.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td>Spécifiez un nom pour la tâche de modèle.</td> 
     </tr> 
     <tr> 
     ...
     <tr> 
      ...
      <td> <p>Il s’agit d’un indicateur visuel qui vous permet de prioriser vos tâches de modèle. </p> <p>Sélectionnez l’une des options suivantes :</p> 
       <ul> 
        ...
        <li> <p style="font-weight: bold;"><span style="font-weight: normal;">Élevé</span> </p> </li> 
     ...
     <tr data-mc-conditions=""> 
      ...
      <td> <p><span>La quantité d’effort requise pour terminer une tâche. Votre chef de projet peut décider d’utiliser ce champ au lieu des Heures planifiées pour estimer l’effort nécessaire pour terminer une tâche. Ce champ n’est visible que lorsque les conditions suivantes sont remplies :</span> </p> 
       <ul> 
        <li> <p><span>La tâche de modèle a un type de durée simple.</span> </p> <p>Conseil : <span>Si vous mettez à jour le type de durée de la tâche, ce champ devient masqué.</span> </p> </li> 
        <li><span>Votre chef de projet a activé le champ Utiliser l’effort de travail pour calculer les heures planifiées sur le modèle.</span> </li> 
       </ul> 
       <div> 
       ...
       </div> <p>Pour plus d’informations sur l’utilisation de l’effort de travail au lieu des heures planifiées pour estimer l’effort de tâche, voir <span href="work-effort.md"><a href="../../../manage-work/tasks/task-information/work-effort.md" class="MCXref xref">Présentation de l’effort de travail</a></span>.</p> </td> 
     </tr> 
     <tr> 
      ...
      <td> <p>La tâche sur le projet créé à partir de ce modèle aura cette contrainte. Les contraintes de tâche déterminent à quel moment une tâche doit être terminée. </p> <p>Sélectionnez l’une des options suivantes :</p> 
       <ul> 
        ...
        <li><strong>Il Faut Commencer Le</strong>. Spécifiez un <strong>Date de début planifiée.</strong></li> 
        <li><strong>Il Faut Finir Le</strong>. Spécifiez un <strong>Date d’achèvement prévue</strong>.</li> 
        ...
        <li>Commencer Au Plus Tard. Spécifiez un <strong>Date de début planifiée</strong>.</li> 
        <li><strong>Commencer Au Plus Tôt</strong>. Spécifiez un <strong>Date de début planifiée</strong>.</li> 
        <li><strong>Finir Au Plus Tard</strong>. Spécifiez un <strong>Date d’achèvement prévue</strong>.</li> 
        <li><strong>Finir Au Plus Tôt</strong>. Spécifiez un <strong>Date d’achèvement prévue</strong>.</li> 
...
1. Mettez à jour l’un des éléments suivants :
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td> <p>Indiquez le Type de coût de la tâche à venir. Cela va déterminer comment le coût de la tâche est calculé, en fonction du nombre d'heures sur les tâches. </p> <p>Sélectionnez l’une des options suivantes :</p> 
       <ul> 
        ...
        <li> <p style="font-weight: normal;"><span>Utilisateur, par heure</span> </p> </li> 
     ...
     <tr> 
      <td role="rowheader"><strong>Type de revenus</strong> </td> 
      <td> <p>Indiquez le Type de revenu pour la tâche à venir. Cela va déterminer comment est calculé le chiffre d’affaires de la tâche, en fonction du nombre d’heures sur les tâches.</p> <p style="font-weight: normal;">Sélectionnez l’une des options suivantes : </p> 
       <ul> 
        ...
        <li> <p style="font-weight: normal;">Utilisateur par heure avec plafond</p> </li> 
        <li> <p style="font-weight: normal;">Rôle par heure avec plafond</p> </li> 
   ...
   <p>Vous devez associer un chemin de jalon à un modèle pour que ce champ s’affiche. Pour plus d’informations, voir <a href="../create-and-manage-templates/edit-templates.md">Modifier des modèles de projet</a>.</p> 
     ...
     <tr> 
      ...
      <td> <p>Indiquez le mode de suivi de l’état d’avancement de la tâche à venir. </p> <p>Sélectionnez l’une des options suivantes :</p> 
       <ul> 
        <li> <p><strong>Utilisateur doit mettre à jour</strong> </p> </li> 
...
1. (Facultatif) Si vous avez plusieurs personnes désignées, sélectionnez la variable **Propriétaire** Bouton radio pour indiquer l’utilisateur ou le rôle qui est considéré comme le propriétaire de la tâche ou le cessionnaire Principal. Workfront marque le premier utilisateur ou rôle de tâche que vous affectez à une tâche de modèle en tant que propriétaire ou cessionnaire Principal.
...
1. (Conditionnel et facultatif) Si vous avez joint un formulaire personnalisé à la tâche de modèle, modifiez les champs du formulaire. Vous devez spécifier tous les champs requis avant de pouvoir enregistrer la tâche de modèle.
   ...
   >Pour plus d’informations sur la définition des autorisations de modèle, voir [Partage d’un modèle](../../../workfront-basics/grant-and-request-access-to-objects/share-a-template.md).
