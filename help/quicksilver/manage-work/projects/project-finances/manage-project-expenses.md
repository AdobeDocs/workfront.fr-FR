...
1. Mettez à jour les informations suivantes :
   ...
   * **Date prévue :** saisissez la date prévue pour que la dépense soit effectuée. Vous pouvez saisir la date dans le champ au format *mm/jj/aa* ou cliquer sur l’icône **Calendrier**  ![Icône de calendrier](assets/calendar-icon.png) et sélectionnez la date de manière dynamique.
