...
description: Vous pouvez modifier un projet dans Adobe Workfront aussi souvent que nécessaire. Idéalement, vous devez modifier un projet lorsque son statut est Planification. Cet article décrit comment rechercher, rechercher et modifier un projet, si vous êtes autorisé à le faire.
author: Alina
