...
Dans le cadre de la planification des ressources, vous pouvez budgéter les fonctions nécessaires pour effectuer le travail dans un projet lorsque vous créez l’analyse de rentabilité. Pour plus d’informations sur la création d’un business case, voir [Créer un business case pour un projet](../../../manage-work/projects/define-a-business-case/create-business-case.md).

>[!NOTE]
>
>La budgétisation des ressources n’est pas la même chose que la planification des ressources pour un projet. Lorsque vous budgérisez des ressources, vous estimez les rôles qui peuvent être nécessaires pour effectuer le travail sur un projet. Pour réellement planifier ou affecter des personnes à un travail sur un projet, voir [Gérer des affectations d’utilisateur ou d’utilisatrice dans l’équilibreur de charge de travail](../../../resource-mgmt/workload-balancer/manage-user-allocations-workload-balancer.md).

Vous devez associer des fonctions au projet avant de pouvoir budgéter les ressources pour celui-ci. Vous trouverez ci-dessous plusieurs façons d’affecter des fonctions à un projet :

* Utilisez le planificateur de ressources pour appliquer des groupes de ressources au projet et budgéter des fonctions.
