---
title: Application mobile pour tablettes de l’épreuve Workfront
description: L’application de tablette  [!DNL Workfront Proof] vous permet de vérifier et d’approuver facilement vos bons à tirer lorsque vous êtes en déplacement. L’application peut être téléchargée pour tout le monde. Vous n’avez pas besoin d’être un utilisateur  [!DNL Workfront Proof] pour pouvoir passer en revue les bons à tirer sur votre tablette ou votre téléphone.
hide: true
hidefromtoc: true
...
L’application de tablette [!DNL Workfront Proof] vous permet de vérifier et d’approuver facilement vos bons à tirer lorsque vous êtes en déplacement. L’application peut être téléchargée pour tout le monde. Vous n’avez pas besoin d’être un utilisateur [!DNL Workfront Proof] pour pouvoir passer en revue les bons à tirer sur votre tablette ou votre téléphone.

Les invités peuvent simplement cliquer sur le bouton [!UICONTROL Aller à la BAT] dans l’email de notification qu’ils reçoivent pour ouvrir le BAT dans l’application.

Les utilisateurs de [!DNL Workfront Proof] peuvent se connecter à l’application et utiliser le tableau de bord pour gérer facilement leur travail.
...
L’application de tablette [!DNL Workfront Proof] est disponible dans Apple App Store et dans la boutique Google Play.
...
L’application de tablette [!DNL Workfront Proof] vous permet d’accéder au tableau de bord avec les bons à tirer qui nécessitent votre attention. Pour accéder au tableau de bord :

1. Utilisez l’une des méthodes suivantes :

   * Connectez-vous à l’aide de vos informations d’identification [!DNL Workfront Proof].

     Si vous recevez un courrier électronique d’invitation à un BAT et ouvrez-le sur votre appareil mobile, le lien vous redirigera vers le BAT dans l’application. Vous n’avez pas besoin d’être un utilisateur pour pouvoir passer en revue les bons à tirer ; toutefois, l’application doit être installée sur votre appareil pour pouvoir les afficher.
...
Si vous souhaitez rester connecté à votre compte [!DNL Workfront Proof] :

1. Activez **[!UICONTROL Gardez-moi connecté]** dans le menu de la barre latérale sous **[!UICONTROL Paramètres]** :
...
Comme pour les graphiques de tableau de bord de notre application web, dans l’application mobile, nous affichons une liste de BAT qui ont été partagés avec vous. Le message de bienvenue en haut de la page vous donnera le nombre total de BAT et au-dessous duquel nous les répartirons en *A l&#39;heure*, *À risque* et *BAT en retard*.

* **Les bons à tirer à temps** correspondent aux bons à tirer qui n’ont pas d’échéance définie ou dont l’échéance est dépassée de 24 heures.
* **Les bons à tirer à risque** sont ceux où la date limite est fixée dans les 24 heures suivantes : la barre de progression est orange pour ces bons à tirer.
* **Les bons à tirer tardifs** sont les bons à tirer qui ont déjà dépassé la date limite ; la barre de progression est rouge pour ces bons à tirer. Une fois l’échéance atteinte, [!DNL Workfront Proof] envoie aux décideurs et au propriétaire du BAT un courriel de rappel automatisé.
...
1. Cliquez sur le nom du BAT à ouvrir dans la visionneuse [!DNL Workfront Proof].

   Ou

   Pour ouvrir un BAT à partir d&#39;une notification par email, les réviseurs peuvent cliquer sur le lien **[!UICONTROL Aller au BAT]** dans la notification.
Si vous disposez d’un compte [!DNL Workfront Proof], vous pouvez vous connecter et accéder à votre BAT à partir du tableau de bord.
   ...
   >[!NOTE]
   >
   >L’application doit être installée sur votre appareil pour pouvoir passer en revue les bons à tirer dans [!DNL Workfront Proof], même si vous n’avez pas de compte [!DNL Workfront Proof].
...
1. Naviguez dans votre BAT :
   ...
   * Pour accéder à une page spécifique du BAT, faites glisser sur les côtés ou utilisez la liste [!UICONTROL miniatures].
...
Vous ne pouvez modifier et supprimer des commentaires que si aucune réponse n’a été publiée. Si vous ne voyez pas l’icône [!UICONTROL corbeille], il est possible que cette option ait été désactivée par votre administrateur [!DNL Workfront Proof].
...
* **[!UICONTROL Une seule vue de commentaire]** affiche un commentaire à la fois. Pour accéder au commentaire suivant, appuyez sur la flèche en haut de la page.
* **[!UICONTROL Masquer la vue de commentaires]** masque tous les commentaires.

Chaque annotation laissée sur le BAT place une épingle sur l’image. Pour afficher le commentaire et le balisage associés à l’épingle, appuyez simplement sur l’épingle. Vous ne pouvez le faire que si la zone d’édition des commentaires est fermée. Pour fermer la zone de commentaire, appuyez sur [!UICONTROL x] dans le commentaire supérieur gauche de la zone.

## Outil Annotation de texte

Le texte de vérification en déplacement se trouve réellement dans l&#39;application de tablette [!DNL Workfront Proof]. L’outil d’annotation de texte est disponible dans la barre d’outils des annotations après avoir cliqué sur le bouton orange **[!UICONTROL Ajouter un commentaire]** .
...
1. Tenez le doigt sur le mot jusqu’à ce que le surlignage soit disponible et utilisez les curseur pour mettre en surbrillance l’ensemble du mot ou de l’expression que vous souhaitez marquer.
   ...
   | **[!UICONTROL Surbrillance]** | Met le texte en surbrillance et le copie dans la zone de commentaire. |
   |---|---|
   | **[!UICONTROL Remplacer]** | Ajoute [[!UICONTROL REPLACE]] et [[!UICONTROL WITH]] dans la zone de commentaire avec le texte, ce qui facilite la recommandation de texte de remplacement. |
   | **[!UICONTROL Supprimer]** | Fait défiler le texte et ajoute [DELETE] à la zone de commentaire. |
...
Les actions sur les commentaires doivent être configurées dans votre compte par l’administrateur [!DNL Workfront Proof] et ne peuvent être utilisées que sur un BAT par les personnes disposant de droits d’édition.
...
La lecture de vidéos en déplacement est facile avec l&#39;application de tablette [!DNL Workfront Proof]. La vidéo ci-dessous montre comment faire des commentaires, des annotations et des décisions dans l’application.
...
1. Appuyez sur le bouton de décision vert en haut de la page.
   ...
   Si vous ne voyez pas le bouton vert **[!UICONTROL Terminer la révision]** et que vous pensez que vous devriez prendre une décision sur le BAT, votre administrateur [!DNL Workfront Proof] peut mettre à jour votre rôle de BAT, comme expliqué dans la section [Gérer les rôles de BAT dans [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/share-proofs-and-files/manage-proof-roles.md).
...
|---|---|
| **[!UICONTROL Workflow]** | Affiche les détails des étapes de révision, ainsi qu’une liste des opérateurs validants, leurs échéances, barres de progression, décisions et le nombre de commentaires et de réponses. |
...
| **[!UICONTROL Verrouillage]** | Permet de verrouiller le bon à tirer. Vous devez disposer de droits d’édition sur le BAT pour pouvoir voir cette option. |
...
| **[!UICONTROL Paramètres]** | Vous pouvez choisir d&#39;afficher les pin&#39;s et/ou les annotations sur le BAT. Vous pouvez également activer l&#39;option [!UICONTROL Gardez-moi connecté] pour vous empêcher d&#39;être déconnecté de l&#39;application. |
