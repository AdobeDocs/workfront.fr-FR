...
description: Les administrateurs et administrateurs de facturation peuvent créer et gérer des profils personnalisés pour spécifier ce que les utilisateurs peuvent faire dans le compte de votre entreprise et dans les paramètres du compte.
author: Courtney
...
La section [!UICONTROL Administration des données] détermine les droits dont disposent les utilisateurs sur les éléments appartenant à d’autres utilisateurs dans le compte.
...
* Fichiers
Pour plus d’informations, voir [Téléchargement de fichiers et de contenu web vers [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/create-proofs-and-files/upload-files-web-content.md).

* Dossiers publics
Pour plus d’informations, voir [Comprendre les autorisations de dossier dans [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/organize-your-work/folder-permissions.md).
...
* Balises
Pour plus d’informations, voir [Création et gestion des balises dans [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/organize-your-work/create-and-manage-tags.md).
...
![Capture d’écran_2018-04-06_12-20-27.png](assets/screenshot-2018-04-06-12-20-27-350x223.png)
...
Pour plus d’informations, voir [La zone de dépôt](../../../workfront-proof/wp-work-proofsfiles/create-proofs-and-files/dropzone.md).

* Gérer le workflow avancé
Pour plus d’informations, reportez-vous à la section [Présentation du processus automatisé](../../../review-and-approve-work/proofing/proofing-overview/automated-workflow.md).

* Gestion de l’authentification unique
Pour plus d’informations, voir [Connexion unique dans [!DNL Workfront Proof]](../../../workfront-proof/wp-acct-admin/managing-security/single-sign-on-overview.md).

* Afficher l’historique du compte
Pour plus d’informations, voir [Compréhension du  [!DNL Workfront Proof] journal d’audit d’activité](../../../workfront-proof/wp-work-proofsfiles/basic-features/activity-audit-trail.md).

* Affichage des sauvegardes de compte
Pour plus d’informations, voir [Sauvegarde de vos [!DNL Workfront Proof] données](../../../workfront-proof/wp-work-proofsfiles/organize-your-work/back-up-data.md).

* Gestion des billing
Pour plus d’informations, voir [Gestion de la facturation](https://support.workfront.com/hc/en-us/sections/115000912187-Managing-your-billing).
...
![Capture d’écran_2018-04-06_12-20-43.png](assets/screenshot-2018-04-06-12-20-43-350x134.png)
...
1. Dans la section **[!UICONTROL Profile Details]** :

   1. Dans le champ **[!UICONTROL Name]** , spécifiez un nom pour le profil personnalisé.
   1. Sélectionnez **[!UICONTROL Activer le profil]**. ![Capture d’écran_2018-04-06_12-25-09.png](assets/screenshot-2018-04-06-12-25-09.png)
...
1. Dans la section **[!UICONTROL Autorisations administratives]** , sélectionnez les autorisations pour les fonctions administratives.
...
1. (Facultatif) Attribuez le nouveau profil aux nouveaux comptes d’utilisateurs et aux comptes existants.
Pour plus d’informations, voir [Profils d’autorisations de BAT dans [!DNL Workfront Proof]](../../../workfront-proof/wp-acct-admin/account-settings/proof-perm-profiles-in-wp.md).
...
Pour activer ou désactiver plusieurs profils simultanément, sélectionnez les profils manuellement ou sélectionnez **[!UICONTROL Nom]** pour sélectionner tous les profils personnalisés.
   ![Capture d’écran_2018-04-06_12-31-53.png](assets/screenshot-2018-04-06-12-31-53.png)
...
1. Cliquez sur le menu déroulant **[!UICONTROL Plus]** , puis sur l’une des options suivantes, selon que vous souhaitez activer ou désactiver le profil :
   ...
   * **Désactiver les profils :** Une boîte de confirmation s’affiche. Sélectionnez **[!UICONTROL Oui]** pour confirmer. Le profil devient inactif et est supprimé des menus [!DNL Workfront Proof].

     >[!NOTE]
     >
     >Un profil désactivé ne peut plus être attribué aux utilisateurs dans le compte. Si des utilisateurs disposant de ce profil existent dans le compte, sélectionnez-leur un profil différent avant que le profil ne soit désactivé.

     ![Capture d’écran_2018-04-06_12-30-07.png](assets/screenshot-2018-04-06-12-30-07.png)
...
1. Cliquez sur le nom du profil et cliquez sur le bouton **[!UICONTROL Copier le profil]** .

   ![Capture d’écran_2018-04-06_12-33-40.png](assets/screenshot-2018-04-06-12-33-40.png)
   ...
   ![Capture d’écran_2018-04-06_12-34-41.png](assets/screenshot-2018-04-06-12-34-41.png)

1. (Facultatif) Pour activer le profil copié, voir [Activation et désactivation d’un profil](#enabling-and-disabling-a-profile).
1. (Facultatif) Pour apporter des modifications au profil copié, voir [Modification d’un profil](#editing-a-profile).
...
1. Cliquez sur le nom du profil à modifier.
...
Pour plus d’informations sur les autorisations, voir [Autorisations de module](#module-permissions) et [Autorisations d’administration](#administrative-permissions).

>[!NOTE]
>
>Les profils par défaut [!DNL Workfront Proof] sont visibles dans la liste des profils, mais ne peuvent pas être modifiés.
...
1. Cliquez sur l’icône **[!UICONTROL Corbeille]** en haut de la page.
   ...
   ![Capture d’écran_2018-04-06_12-36-21.png](assets/screenshot-2018-04-06-12-36-21-163x288.png)

1. Cliquez sur **[!UICONTROL Oui]** dans la boîte de dialogue **[!UICONTROL Confirmer]** qui s’affiche.

1. Si le profil est attribué à un utilisateur, utilisez le menu déroulant de la boîte de dialogue pour sélectionner un autre profil à affecter à cet utilisateur. Cliquez sur **[!UICONTROL Oui]** pour confirmer.

   ![Capture d’écran_2018-04-02_12-02-47.png](assets/screenshot-2018-04-02-12-02-47.png)
...
Pour plus d’informations sur la désactivation des profils, voir [Activation et désactivation d’un profil](#enabling-and-disabling-a-profile).
