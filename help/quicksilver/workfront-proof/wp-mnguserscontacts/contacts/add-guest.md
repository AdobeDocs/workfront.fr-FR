...
1. Saisissez les informations de l’invité, puis cliquez sur **[!UICONTROL Créer]**. Vous pouvez choisir le rôle et les autorisations de BAT par défaut pour le nouvel invité. Lorsque cette personne est ensuite ajoutée à une épreuve, ce rôle et cette alerte lui sont attribués par défaut. Toutefois, ils peuvent être modifiés sur la page Nouvelle épreuve lors de leur ajout à l’épreuve.
