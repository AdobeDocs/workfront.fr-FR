...
title: Comparaison des bons à tirer dans la visionneuse de BAT
...
# Comparaison des bons à tirer dans la visionneuse de BAT
...
1. Dans le coin supérieur gauche de la visionneuse de vérification qui s’affiche, cliquez sur le nom du BAT. Ensuite, dans la liste des versions qui s’affiche, cliquez sur le bouton **Comparer** en regard de la version que vous souhaitez ouvrir et comparer.
...
1. Passez à la [Utilisation des outils de comparaison](#use-the-compare-tools).
...
Pour plus d’informations sur la comparaison de BAT distincts de la liste de documents dans [!DNL Workfront], reportez-vous à la section [Comparaison de deux bons à tirer différents](../../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/compare-proofs.md#comparing-two-proofs-from-a-document-list) dans la section [Comparaison de BAT](../../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/compare-proofs.md) article.

### Comparaison de BAT distincts dans [!DNL Workfront Proof] {#compare-separate-proofs-in-workfront-proof}

>[!NOTE]
>
>Les bons à tirer comparés doivent se trouver dans le même dossier et au même niveau de hiérarchie au sein de la structure de dossiers. Pour plus d’informations sur l’utilisation de dossiers pour regrouper les bons à tirer que vous souhaitez comparer, voir [Utilisation de plusieurs bons à tirer dans la visionneuse de BAT](../../../workfront-proof/wp-work-proofsfiles/review-proofs-wpv/work-with-multiple-proofs.md)

1. Ouvrez l’un des BAT que vous souhaitez comparer dans la visionneuse de BAT.
1. Cliquez sur le bouton **[!UICONTROL Mode de comparaison]** icône .
...
1. Cliquez sur le bouton [!UICONTROL folder] au-dessus du BAT, soit à gauche, soit à droite, pour répertorier les autres BAT dans le même dossier.
...
1. Dans la liste, cliquez sur le nom du BAT que vous souhaitez comparer au BAT actuellement ouvert dans la visionneuse de BAT.
   ...
   ![Comparaison_proofs-list_of_proofs_in_folder.png](assets/comparing-proofs-list-of-proofs-in-folder-350x89.png)
...
La comparaison automatique effectue une comparaison pixel par pixel entre deux bons à tirer statiques ou vidéo. Toutes les différences détectées sont surlignées en rouge dans le BAT à gauche.
...
1. Commencez par comparer les bons à tirer de l’une des façons suivantes :
   ...
   * Comparaison de deux versions du même BAT (voir [Comparaison des versions de BAT](#compare-proof-versions) dans cet article).
   * Comparaison de deux bons à tirer distincts (voir [Comparaison de BAT distincts](#compare-separate-proofs) dans cet article).

1. Cliquez sur le bouton **[!UICONTROL Comparaison automatique]** icône .
...
1. (Facultatif) Cliquez sur le **[!UICONTROL Basculer]** pour modifier le côté principal afin que les différences s’affichent sur le BAT sur le côté droit. Par défaut, les différences s’affichent sur le BAT sur le côté gauche.

   ![proof_autocompare_changeactive.png](assets/proof-autocompare-changeactive.png)

1. (Facultatif) Cliquez sur le **[!UICONTROL Couleur]** pour modifier la couleur et l’opacité utilisées lors de la mise en surbrillance des différences.
...
1. Cliquez sur le bouton **[!UICONTROL Incrustation]** icône .
...
**BAT statique :** Lorsque cette option est activée sur les bons à tirer statiques, la navigation simultanée verrouille le niveau et la position du zoom des deux bons à tirer lors du défilement ou de la rotation. Lorsqu’un BAT contient plusieurs pages et que la navigation simultanée est activée, la modification de pages dans un BAT entraîne la modification de la page dans l’autre BAT.

**BAT vidéo :** Lorsqu’elle est activée sur les bons à tirer vidéo, la navigation simultanée mémorise la différence de temps dans les chronologies des deux bons à tirer.
...
1. Cliquez sur le bouton **[!UICONTROL Navigation simultanée]** icône .

   ![proof_compare_simultan_icon.png](assets/proof-compare-simultaneous-icon.png)

1. (Facultatif) Cliquez sur le **[!UICONTROL Réinitialiser]** à tout moment pour réinitialiser le niveau et la position du zoom (pour le BAT statique) ou la chronologie (pour les BAT vidéo).
