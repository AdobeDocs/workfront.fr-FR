...
title: Incorporer une mini-épreuve
description: Le widget de mini-épreuve permet d’incorporer une épreuve dans une page web, un blog ou un wiki. La mini-épreuve affiche l’épreuve, ainsi que tous les commentaires et annotations existants. Vous pouvez l’utiliser pour travailler sur l’épreuve comme si vous étiez dans  [!DNL Workfront Proof].
author: Courtney
...
# Incorporer une mini-épreuve

>[!IMPORTANT]
>
>Cet article fait référence aux fonctionnalités du produit autonome [!DNL Workfront Proof]. Pour plus d’informations sur la relecture dans [!DNL Adobe Workfront], voir [Relecture](../../../review-and-approve-work/proofing/proofing.md).

Le widget de mini-épreuve permet d’incorporer une épreuve dans une page web, un blog ou un wiki. La mini-épreuve affiche l’épreuve, ainsi que tous les commentaires et annotations existants. Vous pouvez l’utiliser pour travailler sur l’épreuve comme si vous étiez dans [!DNL Workfront Proof].
...
Pour incorporer une mini-épreuve dans une page web, un blog ou un wiki, procédez comme suit :
...
1. Collez le code dans le site web, le blog ou le wiki où vous souhaitez incorporer la mini-épreuve.
