...
Le widget de mini-épreuve permet d’incorporer une épreuve dans une page web, un blog ou un wiki.
...
Pour incorporer une mini-épreuve dans un site web, un blog ou un wiki :
...
1. Collez le code dans le site web, le blog ou le wiki sur lequel vous travaillez pour incorporer la mini-épreuve.
