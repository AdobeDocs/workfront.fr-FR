...
description: Basecamp est un outil de gestion de projets en ligne développé par 37signals. Si vous utilisez Basecamp pour la gestion de projet, vous pouvez offrir à votre équipe de projet des outils de révision et d'approbation plus riches en utilisant [!DNL Workfront Proof].
author: Courtney
