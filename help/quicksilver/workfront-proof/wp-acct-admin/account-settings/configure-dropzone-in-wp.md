...
description: En tant qu’administrateur ou administratrice [!DNL Workfront Proof], vous pouvez définir, afficher et modifier les paramètres de la zone de dépôt pour les utilisateurs et utilisatrices. Pour plus d’informations sur la zone de dépôt, voir la section Zone de dépôt.
author: Courtney
