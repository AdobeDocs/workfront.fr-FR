...
description: Après avoir demandé une sauvegarde des données de relecture, vous pouvez demander qu’une nouvelle sauvegarde des données soit créée. Pour plus d’informations sur les sauvegardes de données, voir Sauvegarder vos données [!DNL Workfront Proof].
author: Courtney
