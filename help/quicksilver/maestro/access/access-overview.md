...
Actuellement, tous les utilisateurs de votre entreprise peuvent avoir accès à Maestro si un administrateur Workfront leur permet d’y accéder.
...
Pour utiliser Adobe Maestro, vous devez disposer des accès suivants :
