...
* [Informations d’accès à la planification Adobe Workfront : index des articles](/help/quicksilver/maestro/access/access-information.md): informations sur l’accès et les autorisations nécessaires à l’utilisation de la planification Workfront.
...
* [Notifications Adobe Workfront Planning : index des articles](/help/quicksilver/maestro/notifications/notifications-information.md): informations sur les notifications par e-mail et les notifications in-app générées par des événements dans la planification Workfront.
