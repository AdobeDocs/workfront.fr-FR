...
Le webinaire de la version 23.1 s’est tenu le mardi 10 janvier 2023. Vous pouvez [vous inscrire au webinaire pour afficher un enregistrement à la demande ici](https://event.on24.com/wcc/r/3995983/A5FC731C36313CE081AEBB3B1AA39C77).

Les <span class="preview">fonctionnalités hors cycle (celles qui sont publiées en production avant la date de publication de la version 23.1) sont surlignées en jaune.</span>
...
<table>
            ...
            <tbody>
                <tr>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-project-enhancements.md" class="MCXref xref" xrefformat="{para}">Ajout de rôles de tâche Secondaire à la liste Autres affectations lors de l’affectation en masse d’éléments dans l’équilibreur de charge de travail</a></p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-project-enhancements.md" class="MCXref xref" xrefformat="{para}">Délocalisation de l’option "Ajouter des utilisateurs" sur un projet</a></p>
                        <p>En vue de l’obsolescence et de la suppression des outils de planification des ressources, nous avons déplacé l’option "Ajouter des utilisateurs" de la section Planification d’un projet vers la section Personnes. Lors de l’ajout d’utilisateurs à un projet, les utilisateurs qui ne sont pas associés aux éléments du projet font partie de l’équipe de projet.</p>
                    ...
                    <td><p><b>Disponible à ces dates :</b></p>
                     <p>
                        ...
                        <ul>
                            <li>
                                <p>Version d’aperçu : vendredi 20 octobre 2022<br /></p>
                            </li>
                            <li>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-project-enhancements.md" class="MCXref xref" xrefformat="{para}">Copier un lien direct vers un dossier de document</a></p>
                        <p>Vous pouvez désormais copier et partager des liens vers des dossiers de document afin d’accéder rapidement au dossier. Les utilisateurs doivent disposer au moins de l’accès Affichage à l’objet pour afficher le dossier.</p>
                    </td>
                    <td><p><b>Disponible à ces dates :</b></p>
                     <p>
                        </p>
                        <ul>
                            <li>
                                <p>Version d’aperçu : vendredi 13 octobre 2022<br /></p>
                            </li>
                            <li>
...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">La planification des fréquences pour les panoramas Workfront</a><span style="color: #ff0000;"> Bientôt disponible !</span></p>
                        <p>Les nouvelles fonctions de planification Scrum des panoramas Adobe Workfront offrent des options flexibles pour gérer vos processus agiles. Grâce à ces outils, vous pouvez :
                        <ul>
                        <li>Suivi du travail dans les itérations ou les empreintes</li>
                        <li>Utiliser la vitesse pour guider les engagements de l'équipe</li>
                        <li>Suivi de la charge et du taux d’achèvement</li>
                        </ul>
                        </p>
                    </td>
                    <td><p><b>Disponible à ces dates :</b></p>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">Les dates d’échéance sur les cartes sont associées à la date d’achèvement prévue sur l’objet Workfront{1</a></p>
                    ...
                    <td><p><b>Disponible à ces dates :</b></p>
                     <p>
                        ...
                        <ul>
                            <li>
                                <p>Version d’aperçu : vendredi 1 décembre 2022<br /></p>
                            </li>
                            <li>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible à ces dates :</b></p>
                     <p>
                        ...
                        <ul>
                            <li>
                                <p>Version d’aperçu : 1 décembre 2022<br /><span style="color: #ff0000;"> Cette fonctionnalité a été supprimée de la version d’aperçu et ne sera pas publiée avec la version 23.1.</span></p>
                            </li>
                            <li>
                                <p>Version de production pour inscription anticipée : indisponible</p>
                                <p>Version de production pour tous les clients : avec la version 23.1</p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-agile-enhancements.md" class="MCXref xref" xrefformat="{para}"> Compteur de carte sur les colonnes du panorama</a></p>
                        <p>Un nouveau paramètre de configuration est disponible pour activer un compteur de cartes pour toutes les colonnes d’un panorama. Si vous utilisez la limite de travaux en cours sur une colonne, aucun compteur de cartes distinct n’est ajouté.</p>
                    </td>
                    <td><p><b>Disponible à ces dates :</b></p>
                     <p>
                        </p>
                        <ul>
                            <li>
                                <p>Version d’aperçu : vendredi 17 novembre 2022<br /></p>
                            </li>
                            <li>
                                <p>Mise à jour de la production pour l’inclusion anticipée : 1er décembre 2022 <span style="color: #ff0000;"> Cette fonctionnalité est disponible en production à cette date uniquement via l’inclusion anticipée des fonctionnalités pour les panoramas Workfront.</span></p>
                                <p>Version de production pour tous les clients : avec la version 23.1</p>
                            </li>
                        </ul>
                    </td>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">Recherche et tri sur le tableau de bord des panoramas</a></p>
                    ...
                    <td><p><b>Disponible à ces dates :</b></p>
                     <p>
                        ...
                        <ul>
                            <li>
                                <p>Version d’aperçu : vendredi 10 novembre 2022<br /></p>
                            </li>
                            <li>
                                <p>Version de production pour la pré-inscription : 17 novembre 2022 <span style="color: #ff0000;"> Cette fonctionnalité est disponible en production à cette date uniquement via la pré-inscription de la fonctionnalité pour les panoramas Workfront.</span></p>
                                <p>Version de production pour tous les clients : avec la version 23.1</p>
                            </li>
                        </ul>
                    </td>
                     ...
                     <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">État s’affiche sur la carte</a></p>
                        <p>Si un état est attribué à une carte d’un panorama, l’état s’affiche désormais sur la carte, de sorte que vous n’ayez pas à l’ouvrir pour afficher l’état. Cette amélioration s’applique aux cartes ad hoc et connectées.</p>
                    </td>
                    <td><p><b>Disponible à ces dates :</b></p>
                     <p>
                        </p>
                    ...
                    <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">Carte Linkable désormais disponible sur les panoramas</a></p>
                        <p>Vous pouvez désormais envoyer un lien vers une carte spécifique à un autre utilisateur du panorama. La personne doit avoir accès au panorama avant de pouvoir ouvrir le lien.</p>
                        <!-- <p>When you open a card on a board, the browser URL looks like this: https://<Workfront-URL>/boards/<board-id>/card/<card-id>.</p> -->
                        <p>Vous pouvez copier l’URL complète et l’envoyer à quelqu’un d’autre. Ils accèdent directement à la carte ouverte lorsqu’ils accèdent au lien.</p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-agile-enhancements.md" class="MCXref xref" xrefformat="{para}">Filtrer par connexion sur les panoramas</a></p>
                    ...
                    <td><p><b>Disponible à ces dates :</b></p>
                     <p>
                        ...
                        <ul>
                            <li>
                                <p>Version d’aperçu : vendredi 27 octobre 2022<br /></p>
                            </li>
                            <li>
                                <p>Version de production pour la pré-inscription : 3 novembre 2022 <span style="color: #ff0000;"> Cette fonctionnalité est disponible en production à cette date uniquement via la pré-inscription de la fonctionnalité pour les panoramas Workfront.</span></p>
                                <p>Version de production pour tous les clients : avec la version 23.1</p>
                            </li>
                        </ul>
                    </td>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-agile-enhancements.md" class="MCXref xref" xrefformat="{para}"> Archivage de cartes à partir d’un panorama sur une planification</a></p>
...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-other-enhancements.md" class="MCXref xref" xrefformat="{para}">Présentation de l’ajout d’Illustrator à Adobe Workfront pour le module externe de conception et de vidéo</a><span style="color: #ff0000;"> Nouveau dans la production !</span></p>
                        <p>Nous sommes ravis d’annoncer l’extension de notre module externe Adobe Workfront for InDesign pour inclure Adobe Illustrator.</p>
                        <p>Le module externe mis à jour, Adobe Workfront pour la conception et la vidéo, prend désormais en charge Illustrator, InDesign, Premiere Pro et After Effects.  </p>
                        ...
                        <p>Les administrateurs peuvent également créer un package avec les modules externes de l’Admin Console et le déployer vers les utilisateurs de manière gérée ou autonome.</p>
                    </td>
                    <td><p><b>Disponible à ces dates :</b></p>
                     <p>
                        </p>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-other-enhancements.md" class="MCXref xref" xrefformat="{para}"> Expérience de filtrage améliorée généralement disponible dans Adobe Workfront</a></p>
                        <p>Une mise à niveau de l’expérience de filtrage a été publiée en version bêta publique sur les listes de projets, de tâches et de problèmes en août 2022. La plupart des listes proposent désormais des filtres améliorés.</p>
                        <p>Dans le cadre d’une "suite rapide" à la version 23.1, l’expérience de filtrage améliorée sera généralement disponible et deviendra le créateur de filtres standard dans la période février/mars 2023.</p>
                    </td>
                    <td><p><b>Disponible à ces dates :</b></p>
                     <p>
                        </p>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-other-enhancements.md" class="MCXref xref" xrefformat="{para}">Nouvelle fonctionnalité de contrôle de liste dans les pages Filtres, Vues et Groupements de la zone Configuration.</a></p>
                        <p>Nous avons ajouté la fonctionnalité de contrôle de liste aux pages Filtres, Vues et Groupements de la zone Configuration. Vous pouvez y activer ou désactiver des filtres, des vues et des regroupements pour le modèle de mise en page.
</p>
                    </td>
                    <td><p><b>Disponible à ces dates :</b></p>
                     <p>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible à ces dates :</b></p>
                        <ul>
                            ...
                            <li>
                                <p><span class="preview">Version de production : vendredi 17 novembre 2022</span></p>
                            </li>
                        </ul>
                    </td>
                </tr>
                 <tr>
                    ...
                    <td><p><b>Disponible à ces dates :</b></p>
                        <ul>
                            <li>
                                <p>Aperçu de la version : pendant toute la période de la version 23.1<br /></p>
                            </li>
                            <li>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-other-enhancements.md" class="MCXref xref" xrefformat="{para}"> Accès à l’aide de Workfront pour les clients sur l’Adobe d’expérience unifiée </a></p>
                        <p>Si votre organisation a été intégrée à Adobe Admin Console et à l’expérience unifiée Adobe pour Workfront, la barre de navigation de Workfront n’inclut plus de lien vers "Aide".</p>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/23.1-release-activity/23-1-other-enhancements.md" class="MCXref xref" xrefformat="{para}">Renommer les pin's et une nouvelle expérience lors de la suppression des pin's</a></p>
                        <p>Les mises à jour suivantes sont désormais disponibles pour les pin's :</p>
                        <ul>
                        <li>Renommer les pin's existants</li>
                        <li>Expérience améliorée lors de la suppression d’une épingle</li>
                        </ul>
                        <p>Les options permettant de renommer une épingle et de la supprimer s’affichent dans le menu déroulant lorsque vous pointez dessus.</p>
                    </td>
                    <td><p><b>Disponible à ces dates :</b></p>
                        <ul>
                            <li>
...
Les nouvelles fonctionnalités de Workfront Fusion sont disponibles en production à un rythme différent du calendrier de version 23.1. Pour plus d’informations sur les dernières fonctionnalités, voir [Activité Version d’Adobe Workfront Fusion](/help/quicksilver/product-announcements/product-releases/fusion-release-activity/fusion-release-activity.md).
...
Pour l’API version 15, nous avons modifié certaines ressources et points d’entrée. Certaines des modifications participent à la prise en charge des nouvelles fonctionnalités, tandis que d’autres facilitent l’utilisation des informations disponibles via l’API.

Pour plus d’informations sur les nouveautés et les mises à jour, consultez les [Nouveautés de l’API version 15](/help/quicksilver/wf-api/api/new-api-version-15.md).
...
#### **Abandon et suppression de la zone Campagnes (Beta) de l’environnement de prévisualisation**

Nous supprimons la zone Campagnes (Beta) de l’environnement Aperçu le 9 janvier 2023. Notre équipe produit va passer en revue cette fonctionnalité et l’inclure dans une prochaine version du produit.

À l’heure actuelle, nous apportons les modifications suivantes :

* Supprimez la zone Campagnes (Beta) du menu principal et des modèles de mise en page de l’environnement Aperçu.
* Supprimez la zone Campagnes (Beta) du menu principal et des modèles de mise en page dans l’environnement de production pour les clients qui l’ont activée sur demande.

En outre, tous les articles décrivant cette fonctionnalité seront également supprimés.

#### **Contrôles de liste (à partir de la zone Interface dans Configuration)**
...
Nous remplaçons l’extension [Workfront pour Illustrator et InDesign](/help/quicksilver/documents/workfront-for-adobe-creative-cloud/use-wf-adobe-cc.md) par des modules externes de Creative Cloud mis à jour. À compter de la fin de 2022, cette extension ne sera plus disponible pour l’installation dans l’Adobe Exchange.

Les fonctionnalités de cette extension, ainsi que plusieurs améliorations, sont disponibles dans la mise à jour des modules externes Adobe Workfront for Creative Cloud :
...
* [Adobe Workfront pour la conception et la vidéo](/help/quicksilver/workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-install-cc.md)
...
* La section Planification de la zone Ressource du menu principal

* La section Planning de la page d’une équipe
