---
title: Améliorations apportées aux opérations d’entreprise du deuxième trimestre 2026
description: Améliorations apportées aux opérations d’entreprise du deuxième trimestre 2026
author: Becky
...
>[!NOTE]
>
>Ces fonctionnalités ne sont disponibles que pour les organisations qui utilisent le package Workflow Ultimate.
...
>[!NOTE]
>
>Les profils métier ne sont disponibles que pour les organisations sur le package Workflow Ultimate.

En outre, les autorisations d’affichage des données de coût et de facturation ont été séparées des autorisations financières générales, tant dans les niveaux d’accès utilisateur que dans les autorisations d’objet. Pour plus d’informations, voir [Accorder l’accès aux données financières](/help/quicksilver/administration-and-setup/add-users/configure-and-grant-access/grant-access-financial.md) et [Partager des autorisations financières sur un objet](/help/quicksilver/workfront-basics/grant-and-request-access-to-objects/share-financial-permissions-object.md).

>[!NOTE]
>
>Des autorisations de coût et de facturation distinctes sont disponibles pour les organisations sur tous les packages Workfront et Workflow.
...
* Nouveaux **types logiques avancés** : affichage avancé, valeur par défaut, mise en forme conditionnelle et modifiabilité
