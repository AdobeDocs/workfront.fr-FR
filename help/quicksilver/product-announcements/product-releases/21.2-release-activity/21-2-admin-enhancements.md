...
title: 21.2 Améliorations apportées aux administrateurs
...
# 21.2 Améliorations apportées aux administrateurs
...
* Crée, modifie ou supprime un taux de change
...
Pour plus d’informations sur les listes modernisées dans Workfront, voir [Modifier l’affichage d’une liste](../../../workfront-basics/navigate-workfront/use-lists/modify-list-display.md).
...
Pour plus d’informations, voir [Création, modification et affectation de profils de feuille de temps](../../../timesheets/create-and-manage-timesheets/create-timesheet-profiles.md).
