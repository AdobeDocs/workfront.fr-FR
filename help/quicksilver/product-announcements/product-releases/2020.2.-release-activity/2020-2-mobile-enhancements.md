...
## Aidez-nous à tester le nouvel assistant virtuel mobile en version Beta

Nous lançons un nouvel assistant virtuel dans l’application mobile Workfront pour l’équipe de test Beta Android et iOS.
...
Pour participer au programme Beta, voir

* [Devenir Beta-testeur sur iOS](../../../workfront-basics/mobile-apps/using-the-workfront-mobile-app/ios-beta-tester.md)
