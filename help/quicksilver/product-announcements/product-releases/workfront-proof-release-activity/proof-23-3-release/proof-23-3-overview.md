...
title: Épreuve Adobe Workfront avec la version 23.3
...
# Épreuve Adobe Workfront avec la version 23.3

Cette page fournit des informations sur les fonctionnalités d’Adobe Workfront BAT publiées dans l’environnement de production au cours de la période de publication de la version 23.3.

Pour obtenir la liste de toutes les modifications disponibles pour toutes les zones de Workfront à ce stade du cycle de publication 23.3, consultez la [23.3 Release Overview](/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-release-overview.md).
...
<table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/workfront-proof-release-activity/proof-23-3-release/proof-23-3-jul-17.md" class="MCXref xref" xrefformat="{para}">Différer les mises à jour pour la visionneuse de vérification de l’appli de bureau</a> </p>
                    ...
                    <td><p><b>Disponible à ces dates :</b></p>
                        <ul>
                            <li>
                                <p><i>Pour les utilisateurs qui utilisent une installation manuelle, avec la version 2.1.26</i></p>
                                <p>Aperçu et version de production : 27 juillet 2023</p>
                            </li>
                            <li>
                                <p><i>Pour les utilisateurs qui utilisent l’installation automatique, avec la version 2.1.28</i></p>
                ...
                <tr>
                    ...
                    <td><p><b>Disponible à ces dates :</b></p>
                        <ul>
                            ...
                            <li>
                                <p><span class="preview">Version de production : vendredi 8 juin 2023</span></p>
                            </li>
                        </ul>
                    </td>
                </tr>                
