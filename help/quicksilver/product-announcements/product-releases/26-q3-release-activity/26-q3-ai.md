...
Connectez Workfront Workflow et Workfront Planning à toute plateforme d’IA compatible avec MCP, y compris Claude, ChatGPT, Copilot, Gemini, etc., et utilisez un langage naturel pour rechercher, créer, mettre à jour et gérer les éléments Workfront sans quitter l’outil d’IA de votre choix. Demandez vos tâches en retard, repoussez la date de fin d’un projet, envoyez un rappel aux approbateurs, mettez à jour le budget d’une campagne, et votre plateforme d’IA effectue le travail à votre place dans Workfront.
