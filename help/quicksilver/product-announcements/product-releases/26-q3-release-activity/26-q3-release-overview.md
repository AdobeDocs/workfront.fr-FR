...
>* Pour la version 26.7 (juillet 2026), la dernière date à laquelle les fonctionnalités peuvent apparaître dans l’environnement de Prévisualisation est le 7 juillet.
    ...
    <tbody>
        ...
        <tr>
            <td>
                ...
                <p>Pour étendre les fonctionnalités du connecteur MCP Workfront, de nouveaux outils ont été ajoutés, ainsi que les outils Rechercher des objets et Résoudre les noms de champ obsolètes.</p>
            </td>
...
<table>
    <tbody>
        ...
        <tr>
            <td>
                <a href="/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">Suivi des modifications pour la révision et l’approbation unifiées</a><p>[!BADGE Hors planning]{type=Neutral}</p>
            ...
            <td><p>10 Juillet 2026</p></td>
            <td><p>15 juillet 2026</p></td>
            <td><p>16 juillet 2026</p></td>
        </tr>
        <tr>
            <td>
                <a href="/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">Nouveaux champs de type de licence pour les niveaux d'accès<p>[!BADGE Hors planning]{type=Neutral}</p></a>
                <p>Les modifications de champ suivantes ont été apportées dans la zone Niveau d'accès : <ul><li>Le champ Type de licence de la zone Niveau d'accès a été renommé Type de licence de workflow. Ce réétiquetage ne modifie pas les fonctionnalités.  </li><li>Pour les clients qui ont également acheté un package Workfront Planning, nous avons ajouté un nouveau champ Type de licence Planning afin d'illustrer la licence d'un utilisateur pour Workfront Planning. </li><ul></p>
            </td>
            <td><p>16 juillet 2026</p></td>
            <td><p>16 juillet 2026</p></td>
            <td><p>16 juillet 2026</p></td>
        ...
        <tr>
            <td>
                <a href="/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">Champ de recherche interne remplaçant le type de champ de saisie semi-automatique</a>
                <p>Le nouveau type de champ de recherche interne dans les formulaires personnalisés offre un filtrage dynamique, une prise en charge de la sélection multiple et des performances améliorées pour les jeux de données volumineux. Il remplace le type de champ de saisie semi-automatique.</p>
            </td>
            <td><p>7 juillet 2026</p></td>
            <td><p>15 juillet 2026</p></td>
            <td><p>16 juillet 2026</p></td>
        ...
        <tr>
            <td>
                <a href="/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">Logique de valeur par défaut prise en charge sur les champs de référence natifs</a><p>[!BADGE Workflow Prime ou version ultérieure]{type=Informative}</p>
                <p>Dans les formulaires personnalisés, les champs de référence natifs vous permettent désormais d’ajouter une logique de valeur par défaut. Ce type de logique est disponible uniquement dans l’interface utilisateur et non dans l’API Workfront.</p>
            </td>
            <td><p>7 juillet 2026</p></td>
            <td><p>15 juillet 2026</p></td>
            <td><p>16 juillet 2026</p></td>
        ...
        <tr>
            <td>
                <a href="/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">Mises à jour du filtrage des champs natifs dans les formulaires personnalisés</a>
                <p>Les filtres système sur les champs natifs sont désormais visibles pour les administrateurs dans les formulaires personnalisés, et le filtrage dynamique est désormais disponible sur les champs de référence natifs.</p>
            </td>
            <td><p>7 juillet 2026</p></td>
            <td><p>15 juillet 2026</p></td>
            <td><p>16 juillet 2026</p></td>
        ...
        <tr>
            <td>
                <a href="/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">Protéger les noms de champ contre les changements de nom accidentels</a>
                <p>Les noms de champ dans le panneau des paramètres de champ de formulaire personnalisé sont désormais en lecture seule par défaut, ce qui nécessite une étape de confirmation explicite pour les renommer. Le champ Nom a été mis à jour au nom de l’API.</p>
            </td>
            <td><p>7 juillet 2026</p></td>
            <td><p>15 juillet 2026</p></td>
            <td><p>16 juillet 2026</p></td>
...
<table>
    <tbody>
        ...
        <tr>
            <td>
                <a href="/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-documents.md" class="MCXref xref" xrefformat="{para}">Adobe Cloud Drive</a><p>[!BADGE Hors planning]{type=Neutral}</p><p>[!BADGE Workflow Ultimate]{type=Informative}</p>
                <p>Adobe Cloud Drive est une application de bureau qui monte vos projets d’espace de stockage Adobe en tant que lecteur sur votre ordinateur Mac ou Windows. Vous pouvez ainsi ouvrir, modifier et enregistrer des fichiers dans n’importe quelle application directement depuis le Finder ou l’Explorateur de fichiers.</p>
            </td>
            <td><p>S/O</p></td>
            <td><p>8 juillet 2026</p></td>
            <td><p>8 juillet 2026</p></td>
        </tr>
            <td>
        ...
        <tr>
            <td>
                <a href="/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-documents.md" class="MCXref xref" xrefformat="{para}">Affichage des badges de Experience Manager Assets et de statut d’approbation dans la zone Documents</a>
                <p>Les ressources liées dans la zone Documents affichent désormais des badges d’état indiquant si un fichier a été envoyé à Adobe Experience Manager Assets avec son statut d’approbation actuel.</p>
            </td>
...
<table>
    <tbody>
        ...
        <tr>
            <td>
                <a href="/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-financial-management-enhancements.md" class="MCXref xref" xrefformat="{para}">Ajouter une carte tarifaire à un modèle</a><p>[!BADGE Workflow Ultimate]{type=Informative}</p>
                <p>Vous pouvez désormais sélectionner une carte tarifaire à ajouter à un modèle, qui est ensuite automatiquement associée à tous les projets créés à partir du modèle. La carte tarifaire devient la carte par défaut du projet, mais elle peut être remplacée si nécessaire.</p>
            </td>
            <td><p>25 Juin 2026</p></td>
            <td><p>15 juillet 2026</p></td>
            <td><p>16 juillet 2026</p></td>
        </tr>
        <tr>
            <td>
                <a href="/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-financial-management-enhancements.md" class="MCXref xref" xrefformat="{para}">Ajouter des taux de facturation entre les taux existants sur une carte tarifaire</a><p>[!BADGE Workflow Ultimate]{type=Informative}</p>
                <p>Vous pouvez désormais ajuster plus rapidement la liste des taux de facturation datés effectifs sur une carte tarifaire en ajoutant un nouveau taux à un emplacement spécifique de la liste. Sélectionnez le menu <b>Plus</b> en regard d’un taux existant pour insérer une ligne au-dessus ou en dessous de ce taux.</p>
            </td>
            <td><p>25 Juin 2026</p></td>
            <td><p>15 juillet 2026</p></td>
            <td><p>16 juillet 2026</p></td>
...
<table>
    <tbody>
        ...
        <tr>
            <td>
                <a href="/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-reports.md" class="MCXref xref" xrefformat="{para}">Amélioration de la précision des données dans les rapports de tableau de bord Zone de travail</a>
...
Pour plus d’informations sur les dernières fonctionnalités, voir :

* [Activité de la version du quatrième trimestre 2026 pour Adobe Workfront Planning](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-26-q4.md).
* [Activité de la version du troisième trimestre 2026 pour Adobe Workfront Planning](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-26-q3.md).


### Autres améliorations apportées à Workfront
...
>[!NOTE]
>
>Aperçu et production pour tous les clients : à compter du 16 juillet 2026
>
>[!BADGE Nouveaux clients uniquement]{type=Neutral}

Vous pouvez désormais acheter Adobe Workfront Planning indépendamment, sans avoir besoin d’une licence Workfront Workflow.

Adobe Workfront Planning en tant que produit autonome est conçu pour les nouveaux clients et les équipes qui ont besoin de fonctionnalités de planification de campagne et de gestion des métadonnées sans la suite complète de fonctionnalités de workflow.

>[!IMPORTANT]
>
>Cette option est disponible uniquement pour les nouveaux clients. Contactez votre représentant de compte pour plus de détails.

Voici quelques-unes des fonctionnalités incluses dans la planification d’Adobe Workfront en tant que produit autonome :

* Fonctionnalité complète de Workfront Planning, avec la possibilité de créer et de gérer des espaces de travail, des types d’enregistrements, des enregistrements, des champs et des vues.
* Possibilité de connecter des enregistrements, y compris des connexions entre espaces de travail pour les packages Prime et Ultimate.
* Automatisation de la création d&#39;enregistrements Planning.
* Processus de réception à l’aide des formulaires de demande Planning.

Pour plus d’informations, voir [Prise en main d’Adobe Workfront Planning en tant que produit autonome](/help/quicksilver/planning/planning-sta/planning-sta-overview.md).
...
La version 2 de l’API Workfront Planning est désormais disponible et étend considérablement les fonctionnalités de la version 1. Vous pouvez désormais créer, mettre à jour et supprimer des espaces de travail, des types d’enregistrements et des champs par programmation, en plus de gérer entièrement les enregistrements.

La version 2 apporte également des améliorations à la structure de l’URL, à la gestion des erreurs, à la pagination, au filtrage et aux autorisations, en plus d’inclure des mises à jour partielles via PATCH, des opérations d’enregistrement en masse, etc.

La version 1 reste disponible, mais nous vous recommandons de passer à la version 2.

REMARQUE : le connecteur Workfront Planning pour Fusion n’a pas été mis à jour vers la version 2 de l’API et il continuera à utiliser la version 1 jusqu’à nouvel ordre.

Pour plus d’informations, voir Principes de base des API de planification d’Adobe Workfront (/help/quicksilver/planning/general/planning-api-basics.md).
...
### Clôture de la version d’essai de Workfront Planning

Le procès de Workfront Planning se termine le 15 mai 2026.
