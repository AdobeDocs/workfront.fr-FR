...
Désormais, lorsque vous ajoutez un utilisateur à l’un de ces champs dans les zones Modifier ou Détails, en plus de son nom et de son avatar, son Rôle Principal et son email s’affichent également. Cela permet de distinguer plusieurs utilisateurs portant des noms similaires ou identiques.
...
## Les champs de date calculée sont toujours enregistrés en fonction de l’heure universelle coordonnée (UTC).
...
## Améliorations des formulaires personnalisés : Adobe XD et le filtre rapide

En fonction de vos commentaires, nous avons introduit les améliorations suivantes pour améliorer votre expérience de gestion des formulaires personnalisés :
...
* Interface intuitive de &quot;créateur bêta&quot; pour la création d’un nouveau filtre
...
Pour plus d’informations, voir [Présentation des filtres dans Adobe Workfront](/help/quicksilver/reports-and-dashboards/reports/reporting-elements/filters-overview.md) et [Création ou modification de filtres dans Adobe Workfront](/help/quicksilver/reports-and-dashboards/reports/reporting-elements/create-filters.md).
