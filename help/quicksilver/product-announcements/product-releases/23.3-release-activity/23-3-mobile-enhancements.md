---
title: Améliorations apportées à l’application mobile (version 23.3)
description: Améliorations apportées à l’application mobile (version 23.3)
author: Lisa
...
# Améliorations apportées à l’application mobile (version 23.3)
...
Avec l’abandon de l’application Workfront Proof autonome dans la version 23.4, des fonctionnalités de vérification de l’application mobile Workfront principale ont été ajoutées pour permettre la poursuite de la vérification sur mobile. Les nouvelles fonctionnalités incluent :
...
Pour plus d’informations sur la vérification dans l’application mobile Workfront, voir [Vérification et prise de décisions sur les bons à tirer dans l’application mobile Adobe Workfront](/help/quicksilver/workfront-basics/mobile-apps/using-the-workfront-mobile-app/work-with-proofs-in-mobile-app.md).
