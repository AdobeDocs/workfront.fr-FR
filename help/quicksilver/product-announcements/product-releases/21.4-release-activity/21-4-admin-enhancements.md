...
## Pour les administrateurs : Déterminer les groupes associés à un processus d’approbation
...
## Nouveautés pour les administrateurs : Les groupes peuvent configurer leurs propres préférences de feuille de temps et d’heure.
...
## Nouveautés pour les administrateurs Workfront : Configuration de modèles de mise en page pour les utilisateurs configurés automatiquement dans la nouvelle expérience Workfront
...
## La page Détails des plans directeurs affiche désormais une image.
...
De nouvelles préférences de problème sont désormais disponibles pour certains plans directeurs. Ils sont installés par défaut, mais vous pouvez vous désinscrire de l’installation des préférences lorsque vous configurez les détails de l’installation.
...
## Nouveautés pour les administrateurs de groupe : Afficher et gérer les éléments récemment supprimés et restaurés d’un groupe
...
* Méthode d&#39;indice de performance
* Type de statut
...
Pour plus d’informations, voir la section Comment les préférences s’appliquent aux modèles et aux tâches de modèle dans l’article . [Création et modification de modèles de projet d’un groupe](../../../administration-and-setup/manage-groups/work-with-group-objects/create-and-modify-a-groups-templates.md).

## Nouveautés pour les administrateurs : Déterminer quels formulaires personnalisés utilisent un champ personnalisé
...
## Nouveautés pour les administrateurs de groupe : Verrouillage et déverrouillage des préférences de projet, de tâche et d’émission pour un groupe
...
Il est désormais plus facile de fournir des informations dans la section Détails pour un objet : Saisissez et enregistrez les informations dans un champ personnalisé unique ou une zone extensible (comme Aperçu et Finance), même si les champs requis dans d’autres formulaires personnalisés sur l’objet ne sont pas encore remplis.
...
## Nouveautés pour les administrateurs Workfront : Migrez vous-même des modèles de mise en page de Workfront Classic vers la nouvelle expérience Workfront
...
## Lors de l’association d’un modèle à un groupe, sélectionnez un processus d’approbation de groupe dans Détails de la file d’attente et Rubriques de la file d’attente.
