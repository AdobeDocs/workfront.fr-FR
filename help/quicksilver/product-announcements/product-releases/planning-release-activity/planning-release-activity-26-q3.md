...
Lorsque vous sélectionnez Restreint, seul le créateur de l’enregistrement et les utilisateurs, groupes, équipes, rôles ou sociétés spécifiquement sélectionnés peuvent modifier l’enregistrement, tandis que tous les autres conservent un accès en lecture seule.

Cette règle s’applique automatiquement aux nouveaux enregistrements, quelle que soit la manière dont l’enregistrement est créé (bouton Nouvel enregistrement, formulaires de demande, API, à l’aide d’une automatisation Fusion ou d’un assistant AI). Les modifications apportées à la règle n’affectent que les enregistrements créés à l’avenir, jamais les enregistrements existants.

Une fois un enregistrement créé, ses autorisations peuvent toujours être mises à jour indépendamment sans affecter la règle par défaut pour les enregistrements futurs.

Pour plus d’informations, voir [Définition des autorisations par défaut pour les enregistrements](/help/quicksilver/planning/access/set-default-record-permissions.md).

## Disposition de regroupement en couloir pour la vue Chronologie
...
Les niveaux de regroupement imbriqués s’affichent sous forme de sous-colonnes mises en avant et les enregistrements de chaque piste restent sous-empilés et triés.

Vous pouvez faire glisser et déposer des enregistrements dans la vue groupée pour mettre à jour facilement leurs informations et leurs dates.

Tous les utilisateurs qui consultent la vue peuvent voir les regroupements appliqués.
...
Vous pouvez modifier les paramètres par défaut du champ après l’enregistrement. Vous pouvez remplacer les valeurs par défaut des champs lors de l’utilisation d’enregistrements.
...
Lorsqu&#39;un type d&#39;enregistrement Planning est associé au type d&#39;enregistrement Marques GenStudio, vous pouvez ajouter le champ Marques connectées à un formulaire de demande Planning associé au type d&#39;enregistrement Planning.
