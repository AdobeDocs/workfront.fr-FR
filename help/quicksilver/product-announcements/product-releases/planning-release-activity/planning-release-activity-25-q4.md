...
* Configurer une automatisation qui est déclenchée lorsqu’une demande est envoyée à partir du formulaire. Actuellement, vous pouvez créer automatiquement des enregistrements lors de l’envoi de la demande.
...
## Modification en ligne de projets Workfront dans la page Enregistrements connectés de l’enregistrement
...
Vous pouvez désormais modifier sur la ligne les projets connectés Workfront dans la page Enregistrements connectés . Vous pouvez également créer des projets sans modèle à partir de la page des enregistrements connectés.
