...
Désormais, des zones telles que l’en-tête, les listes et les cartes de détails sont familières et cohérentes avec votre expérience dans Workfront.
...
* **Mises à jour** : nous avons ajouté un nouveau commentaire dans la section Mises à jour d’un objectif afin d’afficher les commentaires des utilisateurs et les notes d’activité du système dans deux onglets distincts. Pour plus d’informations, voir [Gérer les commentaires d’objectif dans les objectifs Adobe Workfront](/help/quicksilver/workfront-goals/goal-management/manage-goal-comments.md).
