...
Pour plus d’informations sur la période de publication et toutes les fonctionnalités disponibles avec la version 2019.4, voir [Présentation de la version 2019.4](../../../../product-announcements/product-releases/quarterly-release-archive/2019.4-release-activity/2019.4-release-activity-overview.md).
