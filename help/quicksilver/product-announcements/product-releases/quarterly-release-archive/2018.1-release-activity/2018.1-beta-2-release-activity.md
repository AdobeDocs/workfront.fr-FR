...
Nous introduisons le nouveau concept de **Groupe avec accès à l’administration** que vous pouvez associer à un modèle de mise en page.
...
* [Améliorations du menu de gauche](#left-menu-improvements)
