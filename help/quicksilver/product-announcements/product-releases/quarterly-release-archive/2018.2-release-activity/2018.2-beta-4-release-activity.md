...
* Le nombre d’éléments de chaque groupement s’affiche désormais entre parenthèses en regard de son titre.
...
La visionneuse de vérification de l’appli de bureau comprend les améliorations suivantes par rapport à la visionneuse de vérification héritée pour la vérification du contenu interactif :
...
* Page Nouveau compte
   ...
   Avant cette amélioration, vous ne pouviez pas afficher les informations de votre compte sur l’application mobile et vous pouviez accéder à vos paramètres, envoyer des commentaires et vous déconnecter à partir du menu principal de Workfront.
