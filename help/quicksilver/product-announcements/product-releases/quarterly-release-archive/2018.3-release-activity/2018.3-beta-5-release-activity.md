...
Pour plus d’informations sur toutes les zones affectées par la suppression de ces fonctionnalités et pour comprendre quels outils les remplaceront, voir [Remplacement des outils basés sur des Flashs dans Adobe Workfront](../../../../product-announcements/announcements/announcement-archive/replace-flash-tools.md).
...
Les approbations basées sur les rôles fonctionnent désormais plus simplement sur un projet. Désormais, les utilisateurs doivent être affectés à l’équipe du projet et leur rôle doit être affecté dans leur profil utilisateur afin d’afficher les approbations affectées à leurs rôles Principal ou secondaire.
...
Auparavant, lorsque vous ajoutiez des réviseurs à un BAT à partir de la visionneuse de vérification, Workfront les plaçait dans l’étape actuellement principale.
