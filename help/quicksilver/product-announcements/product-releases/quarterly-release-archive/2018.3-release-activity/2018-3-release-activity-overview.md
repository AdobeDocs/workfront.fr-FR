...
* [Améliorations lors de l’export des vues de rôle et de projet du planificateur de ressources](../../../../product-announcements/product-releases/quarterly-release-archive/2018.3-release-activity/2018-3-beta-1-release-activity.md#improvements-when-exporting-the-role-and-project-views-of-the-resource-planner)
* [Rapport d’utilisation : renseigne les heures budgétisées à partir de la nouvelle zone d’établissement du budget de ressources.](../../../../product-announcements/product-releases/quarterly-release-archive/2018.3-release-activity/2018-3-beta-5-release-activity.md#utilization-report-populates-budgeted-hours)
* [Rapport d’utilisation : afficher les heures budgétées par utilisateur ou par utilisatrice dans un projet](../../../../product-announcements/product-releases/quarterly-release-archive/2018.3-release-activity/2018-3-beta-5-release-activity.md#utilization-view-budgeted-hours-by-user)
...
* [Filtrage des commentaires et des réponses par utilisateur ou par utilisatrice dans la visionneuse de relecture](../../../../product-announcements/product-releases/quarterly-release-archive/2018.3-release-activity/2018-3-beta-2-release-activity.md#filter-comments-and-replies-by-user-in-the-proofing-viewer)
...
* [Consigner le temps dans l’orientation Paysage de l’application mobile Workfront](../../../../product-announcements/product-releases/quarterly-release-archive/2018.3-release-activity/2018-3-beta-3-release-activity.md#log-time-in-the-workfront-mobile-app-in-landscape-orientation)
* [Réorganisation des icônes dans la barre de navigation inférieure de l’application mobile Workfront](../../../../product-announcements/product-releases/quarterly-release-archive/2018.3-release-activity/2018-3-beta-3-release-activity.md#rearrange-the-icons-in-the-bottom-navigation-bar-in-the-workfront-mobile-app)
...
* [API version 10 désormais disponible en prévisualisation](#api-version-10-now-available-in-preview)
...
* [Mise à jour de Workfront Fusion hérité - 20 septembre 2018](#legacy-workfront-fusionupdate-september-20-2018)
...
La prise en charge de l’API version 3 prend fin en novembre 2018. Pour plus d’informations sur le planning de prise en charge des versions de l’API Workfront, consultez la section [Versions de l’API et planning de prise en charge](../../../../wf-api/api/api-version-support-schedule.md).
...
Toutes les fonctionnalités reposant sur la technologie Flash ont été supprimées de Workfront avec la version 2018.3 et remplacées par une nouvelle solution.
...
Ces modifications sont effectuées en vue de la préparation de l’expérience d’authentification améliorée, actuellement disponible uniquement pour un nombre limité de clientes et de clients.
...
Avec la dernière mise à jour, la version héritée de Workfront Fusion offre désormais une conception améliorée qui rend le processus de création de nouveaux FLO plus intuitif. Les modifications spécifiques incluent :

* **Nouveau FLO :** cliquer sur le nouveau FLO permet désormais aux personnes d’accéder à l’écran Conceptions, plutôt que de demander au préalable de sélectionner le connecteur. Cette modification vous permet de vous orienter vers le FLO global et de comprendre que tout FLO doit commencer par un événement.
* **Ajouter une fonction :** le sélecteur de fonction a été mis à jour afin de faciliter la recherche et la sélection de la fonction souhaitée. Les descriptions des fonctions, ainsi que les champs d’entrée et de sortie, ont été mis à jour afin d’ajouter des conseils intuitifs. La nouvelle section « La plus appréciée » vous aide à commencer à utiliser les fonctions les plus couramment utilisées.
