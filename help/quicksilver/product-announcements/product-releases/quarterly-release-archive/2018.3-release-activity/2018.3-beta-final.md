...
title: Version finale de la version bêta 2018.3
...
# Version finale de la version bêta 2018.3
...
>[!NOTE]
 Certaines zones de l’intégration décrites dans la vidéo suivante ont été modifiées. Pour obtenir les informations les plus récentes sur Workfront pour les Microsofts Teams, reportez-vous à la section [Adobe Workfront pour les Microsofts Teams](../../../../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/use-workfront-with-ms-teams.md) .
...
* Connectez-vous à l’aide de vos informations d’identification Workfront ou SAML.
...
* Raccourcis de l’application dans l’écran d’accueil :
   ...
   * Accès aux tâches ou aux problèmes les plus récemment consultés
