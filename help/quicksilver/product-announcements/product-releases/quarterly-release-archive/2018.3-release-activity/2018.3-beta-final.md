...
>[!NOTE]
>
 Certaines zones de l’intégration décrites dans la vidéo suivante ont été modifiées. Pour obtenir les informations les plus récentes sur Workfront pour les Microsofts Teams, voir la section [Adobe Workfront pour les Microsofts Teams](../../../../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/use-workfront-with-ms-teams.md) .
