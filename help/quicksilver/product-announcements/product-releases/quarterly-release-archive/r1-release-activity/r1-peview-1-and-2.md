...
Avant cette modification, vous pouviez affecter des modèles de mise en page aux utilisateurs et utilisatrices, aux équipes et aux fonctions. L’affectation d’un modèle de mise en page à des groupes a la priorité d’affectation de modèle de mise en page . 
