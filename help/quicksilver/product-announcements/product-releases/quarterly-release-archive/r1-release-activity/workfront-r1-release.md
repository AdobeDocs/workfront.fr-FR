...
L&#39;intégration directe dans Outlook 365 vous permettra d&#39;éliminer le travail en double lorsque vous mettez à jour Workfront directement à partir d&#39;Outlook 365. Convertissez des e-mails en tâches, envoyez des conversations par e-mail et des pièces jointes en tant que mises à jour et répondez aux commentaires, sans jamais quitter Outlook.
...
**Maintenir les projets sur la bonne voie et respecter le budget**
Gérez vos ressources et leur utilisation, en maintenant les projets sur la bonne voie et dans le respect du budget, à l&#39;aide du nouveau rapport d&#39;utilisation. Affichez les heures prévues par rapport aux heures effectives par projet et rôle, et comparez régulièrement les ressources et services.
...
**Personnalisation de la terminologie et des notifications**
Rendez Workfront plus pertinent pour votre équipe en exploitant la fonctionnalité de terminologie personnalisée pour modifier des termes tels que « Portfolio » ou « Projet » en fonction de votre langage préféré, quel que soit le secteur d’activité. En outre, tous les utilisateurs et toutes les utilisatrices peuvent désormais personnaliser les types de notifications qu’ils reçoivent en régulant la fréquence des résumés.

Pour plus d’informations, voir : [Prévisualisation 3 de la version R 1](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-preview-3.md)

**Vue Jalon**
Les nouvelles icônes de statut de progression vous permettent de tirer le meilleur parti de vos rapports jalonnés. En outre, vous pouvez désormais modifier le pourcentage terminé directement dans la vue de jalon.
...
**Corbeille Workfront**
La nouvelle Corbeille Workfront vous permet de restaurer les projets, les tâches, les événements, ainsi que tous les documents, formulaires et mises à jour associés dans les 30 jours suivant leur suppression.
...
**Recherche et recherche d&#39;épreuve**
La nouvelle fonctionnalité de recherche de ProofHQ vous permet de rechercher et de trouver rapidement et facilement toutes les instances d&#39;un mot ou d&#39;une expression directement dans les BAT au fur et à mesure que vous les examinez. Cela s’applique à tous les documents texte, y compris les fichiers PDF et Microsoft Word.
...
**Rapports visuels et vues personnalisées améliorées**
De nouvelles mesures de rapports dans ProofHQ vous permettent de suivre les délais d’exécution, les pourcentages de retard, le nombre de commentaires et le délai jusqu’à la première activité. De nouvelles vues personnalisées créent une logique de filtre avancée afin d’obtenir les données exactes, au moment où vous en avez besoin.

Pour plus d’informations, voir : [Version R 1 finale](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-final.md)

Aperçu de **ProofHQ**
ProofHQ vous permet désormais de tester de nouvelles fonctionnalités dans un environnement de prévisualisation avant de les diffuser à tous vos utilisateurs.
