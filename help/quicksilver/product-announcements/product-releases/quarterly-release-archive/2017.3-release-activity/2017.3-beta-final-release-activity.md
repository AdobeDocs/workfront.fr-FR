...
* [Nouveau groupement pour les rapports d’heures budgétisées sur les ressources : Date d’affectation](#new-grouping-for-resource-budgeted-hour-reports-allocation-date)
...
>[!NOTE]
Cette fonctionnalité ne sera pas publiée dans l’environnement de production avec la version 17.3 ; il restera dans Aperçu jusqu’au début de 2018.
...
Pour plus d’informations sur l’activation et la configuration de Kanban pour une équipe agile, voir [Choix d’une méthodologie agile](../../../../agile/get-started-with-agile-in-workfront/create-an-agile-team.md#deciding) in [Création d’une équipe agile](../../../../agile/get-started-with-agile-in-workfront/create-an-agile-team.md).
...
Avant cette modification, vous pouviez afficher la Date d&#39;affectation dans la vue du rapport, mais aussi l&#39;utiliser dans un filtre, mais vous ne pouviez pas utiliser ce champ dans un regroupement.
...
* [Resource Planner : Afficher les données par éditeur de texte enrichi](#resource-planner-show-data-by-fte)
* [Resource Planner : Afficher les données par semaine et par trimestre](#resource-planner-show-data-by-week-and-quarter)
* [Resource Planner : Afficher par utilisateur](#resource-planner-view-by-user)
* [Resource Planner : Faire glisser et déposer des projets pour établir la priorité](#resource-planner-drag-and-drop-projects-to-establish-priority)
* [Resource Planner : Exporter les données du planificateur de ressources vers Excel](#resource-planner-export-the-data-in-the-resource-planner-to-excel)
