...
Pour plus d’informations sur la création d’une vue de mode de texte personnalisé qui capture les informations du problème d’origine, voir [Afficher : affiche les informations de problème d’origine sur les listes de tâches et de projets](../../../../reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-display-original-issue-info-task-project-list.md).
