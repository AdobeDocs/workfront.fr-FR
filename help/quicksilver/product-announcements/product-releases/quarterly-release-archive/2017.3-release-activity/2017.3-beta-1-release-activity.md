...
* [Inclure les informations d’affectation des utilisateurs dans le rapport d’utilisation d’un projet](#include-user-allocation-information-in-the-utilization-report-on-a-project)
...
Avant cette modification, vous ne pouviez afficher la chronologie de la planification que dans une vue d’une semaine, de deux semaines ou de trois semaines. Ces plages de dates sont toujours disponibles en plus des nouvelles plages de dates.
...
Le rapport Utilisation d’un projet prend désormais en compte la réaffectation des heures planifiées sur toute la durée d’une tâche. Lorsque l’affectation utilisateur pour les heures a été modifiée (comme décrit dans [Gestion des affectations d’utilisateurs dans les zones de planification](../../../../resource-mgmt/resource-scheduling/manage-allocations-scheduling-areas.md) in [Gestion des affectations d’utilisateurs dans les zones de planification](../../../../resource-mgmt/resource-scheduling/manage-allocations-scheduling-areas.md)), les données du rapport Utilisation peuvent être affectées si les dates sélectionnées dans le rapport Utilisation ne contiennent qu’une partie d’une tâche.
