...
title: Améliorations de projet 2019.1
description: Cette page décrit toutes les améliorations de projet incluses dans la version 2019.1. Cette fonctionnalité est actuellement disponible dans l’environnement de prévisualisation. Elle sera mise à disposition dans l’environnement de production en .
author: Luke
...
* [Restauration de modèles à partir de la corbeille](#restore-templates-from-the-recycle-bin)
* [Affichage des horodatages des champs de date sur l’Accueil](#show-timestamps-for-date-fields-in-home)
...
* [Améliorations d’Agile](#agile-improvements)
* [Ajout de tâches et de problèmes d’une liste à une itération](#add-tasks-and-issues-from-a-list-to-an-iteration)
* [Nouveaux formats de papier pour l’export d’un graphique de Gantt](#new-paper-sizes-for-gantt-chart-export)
* [Suppression de l’accès aux boîtes de dialogue dans le graphique de Gantt en mode Édition](#removed-access-to-dialog-boxes-in-the-gantt-chart-while-in-edit-mode)
* [Affichage des informations sur les tâches dans le graphique de Gantt de la liste des projets dans un programme ou un portfolio](#view-task-information-in-the-project-list-gantt-chart-in-a-program-or-portfolio)
* [Accès au graphique de Gantt de la liste des tâches dans les modèles](#access-the-task-list-gantt-chart-on-templates)
* [Modification du nom de la vue Projet dans le graphique de Gantt](#renamed-the-project-view-on-the-gantt-chart)
...
* [Affichage des listes en plein écran](#display-lists-in-full-screen)
* [Nouvelles listes dans des zones supplémentaires](#new-lists-in-additional-areas)
* [Envoi d’un rapport remis au format XLSX](#send-a-delivered-report-in-xlsx-format)
