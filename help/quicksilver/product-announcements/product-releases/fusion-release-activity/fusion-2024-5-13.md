...
Pour plus d’informations et d’instructions, voir [Effectuer un appel API personnalisé](/help/quicksilver/workfront-fusion/apps-and-their-modules/pdf-modules.md#make-a-custom-api-call) dans l’article des modules PDF Services.
