...
* [Usurpation d’adresses e-mail et réponses POP](email-spoofing-pop-reply-message.md)
* [Les clientes et clients des clusters 1, 2 et 3 doivent mettre à jour tous les blocs d’adresses IP de liste autorisée pour empêcher le blocage des services Adobe Workfront.](clusters-1-3-update-whitelist.md)
* [Supprimer le serveur SMTP personnalisé en tant qu’option d’e-mail sortant](remove-custom-smtp.md)
