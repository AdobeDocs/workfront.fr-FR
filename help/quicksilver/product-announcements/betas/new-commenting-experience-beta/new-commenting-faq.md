...
Il n’est actuellement pas prévu de proposer une vue combinée. Envoyez une demande à l’équipe d’assistance si nécessaire, afin que nous puissions mieux comprendre à quel point cette fonctionnalité est nécessaire.
...
Il n’est actuellement pas prévu d’ajouter des contrôles d’accès ou d’autorisation aux personnes pouvant utiliser cette nouvelle fonctionnalité. Envoyez une demande à l’équipe d’assistance, si nécessaire, afin que nous puissions mieux comprendre l’importance de cette fonctionnalité.

## Existe-t-il un moyen de contrôler qui peut modifier les commentaires ?

Il n’est actuellement pas prévu d’ajouter des contrôles d’autorisation ou d’accès pour savoir qui peut modifier les commentaires. Envoyez une demande à l’équipe d’assistance, si nécessaire, afin que nous puissions mieux comprendre l’importance de cette fonctionnalité.
