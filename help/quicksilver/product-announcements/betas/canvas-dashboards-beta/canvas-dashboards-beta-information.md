...
1. Dans l’angle supérieur droit de la page, cliquez sur le bouton Beta **Joindre les tableaux de bord de la zone de travail** .

   >[!NOTE]
   >
   > Le bouton **Rejoindre la version Beta des tableaux de bord de la zone de travail** n’est disponible que si votre organisation a été invitée à la version Beta fermée.
...
1. Cliquez sur le bouton **Envoyer des commentaires** dans le coin inférieur droit de la page, puis saisissez vos commentaires dans le formulaire qui s’affiche.
