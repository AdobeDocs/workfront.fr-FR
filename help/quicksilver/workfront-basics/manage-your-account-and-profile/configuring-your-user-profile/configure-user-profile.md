...
* Choisissez le formatage **[!UICONTROL mode sombre]** pour [!DNL CX Enterprise].
* Définissez les **[!UICONTROL préférences]** pour [!DNL CX Enterprise], y compris les préférences de langue principale et secondaire.
