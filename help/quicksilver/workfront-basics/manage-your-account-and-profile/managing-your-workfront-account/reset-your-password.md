...
>[!NOTE]
>
>Un administrateur [!DNL Workfront] peut configurer des restrictions de mot de passe personnalisées, comme expliqué dans les sections [Configuration des préférences de sécurité du système](../../../administration-and-setup/manage-workfront/security/configure-security-preferences.md) et [Configuration des stratégies de mot de passe pour l&#39;authentification](../../../administration-and-setup/manage-workfront/security/configure-password-policies-authentication.md).
>
...
1. Cliquez sur l’icône **[!UICONTROL Menu principal]** ![](assets/main-menu-icon.png) dans le coin supérieur droit de [!DNL Adobe Workfront], puis cliquez sur votre nom d’utilisateur en regard de votre image de profil.

   ![Ouvrez le menu principal et sélectionnez votre nom d’utilisateur.](assets/main-menu-options-350x481.png)

1. Cliquez sur le menu **[!UICONTROL Plus]** ![](assets/more-icon.png), puis sur **[!UICONTROL Modifier]**.
...
1. Saisissez votre ancien mot de passe, puis saisissez le nouveau mot de passe que vous souhaitez deux fois.
   ...
   * Caractères spéciaux (c’est-à-dire ! @ # $ % etc.)
   ...
   Les règles de mot de passe peuvent être plus strictes que cela, selon les paramètres de configuration définis par votre administrateur [!DNL Workfront].
