...
title: Gérer les formulaires personnalisés attachés aux objets
...
# Gérer les formulaires personnalisés attachés aux objets
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Autorisations Contribute ou supérieures aux objets pour lesquels vous gérez des formulaires personnalisés</p> <p>Pour plus d’informations sur la demande d’accès supplémentaire, voir <a href="../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Demander l’accès aux objets</a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. Dans la section **Forms personnalisée** pour les projets, les tâches et les problèmes, cliquez sur l’icône ![](assets/move-icon---dots.png) en regard du nom d’un formulaire personnalisé. Pour tous les autres objets, cliquez sur **Gérer Forms**. Cette option s’affiche uniquement si au moins un formulaire personnalisé est joint à l’objet.
1. Faites glisser un formulaire ![](assets/move-icon---dots.png) vers un nouvel emplacement de la liste.
...
1. Pour les projets, les tâches et l’envoi de formulaires personnalisés, cliquez sur l’icône **X** située à droite d’un formulaire pour le supprimer de l’objet.

   Pour tous les autres objets, cliquez sur **Gérer Forms**, puis cliquez sur l’icône **X** située à droite d’un formulaire pour le supprimer de l’objet.
...
1. Dans une liste d’objets, sélectionnez les objets auxquels les formulaires personnalisés sont attachés, puis cliquez sur l’icône **Modifier** ![](assets/edit-icon.png).
1. Cliquez sur **Formulaires personnalisés**.
...
1. Cliquez sur le menu déroulant **Effectuer une sélection** et sélectionnez des formulaires supplémentaires à ajouter à tous les objets sélectionnés.
   ...
   * Une fois que vous avez appliqué un formulaire supplémentaire, tous les champs du formulaire qui sont communs à d’autres formulaires s’affichent dans la section **Champs communs** et peuvent être modifiés.
...
1. Cliquez sur **Supprimer le formulaire** pour supprimer un formulaire personnalisé des objets.
   ...
   * Après avoir supprimé un formulaire, tous les champs de ce formulaire qui se trouvaient dans la section **Champs communs** sont supprimés de cette section et ne peuvent plus être modifiés ici.

1. Cliquez sur **Restaurer le formulaire** pour restaurer le formulaire à l’état où il se trouvait avant de modifier les objets.
