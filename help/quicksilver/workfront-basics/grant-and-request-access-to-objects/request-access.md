...
description: La visibilité des objets dans Adobe Workfront dépend de l’accès à ce type d’objet et de vos autorisations sur un objet individuel.
author: Alina
...
La visibilité des objets dans Adobe Workfront dépend de l’accès à ce type d’objet et de vos autorisations sur un objet individuel.
...
Si vous avez besoin d’autorisations pour des objets spécifiques dans Workfront, vous pouvez leur demander l’accès. Plutôt que d’envoyer un courrier électronique à l’administrateur Workfront ou au propriétaire de l’objet pour expliquer vos besoins, vous pouvez demander un accès (ou des autorisations) supplémentaire dans Workfront.
...
1. (Facultatif) Dans le **P.S.** , indiquez une note à l’utilisateur concernant les raisons pour lesquelles vous avez besoin d’un accès supplémentaire.
...
1. Cliquez sur le bouton **Plus** en ligne avec le nom du projet, puis cliquez sur **Demander plus d’accès**.\
...
1. (Facultatif) Dans le **P.S.** , indiquez une note expliquant pourquoi vous avez besoin d’un accès supplémentaire.
1. Cliquez sur **Demande d’accès**.\
   ![](assets/request-access-dialog-350x314.png)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>Tâches</td> 
   <td>Le propriétaire est le cessionnaire Principal ou, s’il manque ou s’il n’a pas l’accès nécessaire, le propriétaire du projet sur lequel réside la tâche, comme défini ci-dessus. <p>Ils peuvent ne pas être la même personne que le créateur de la tâche. </p></td> 
  </tr> 
  <tr> 
   <td>Événements</td> 
