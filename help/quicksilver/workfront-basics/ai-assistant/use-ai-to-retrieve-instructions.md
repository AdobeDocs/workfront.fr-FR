...
Par exemple, si vous demandez à l’assistant d’IA &quot;Comment créer une file d’attente de requêtes&quot;, elle renvoie des instructions pour créer la requête, extraites de l’article. [Création et gestion des files d’attente de requête](/help/quicksilver/manage-work/requests/create-and-manage-request-queues/create-request-queue.md).
