---
title: Vue d’ensemble de l’intégrité du projet
...
* L’administrateur Workfront doit activer l’assistant d’IA pour les utilisateurs de votre entreprise. L’assistant IA est activé par le biais des niveaux d’accès.
