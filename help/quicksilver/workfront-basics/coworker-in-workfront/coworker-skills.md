...
## Compétences en planification Workfront

### Architecte de solution Workfront Planning

Nom : `wf-planning-solution-architect`

Cette compétence peut répondre aux questions liées à la planification Workfront, notamment, mais sans s’y limiter :

* Conception de Workspace
* Syntaxe des champs de formule
* Filtrage des API
...
* Intégrations
* Limites de produit par niveau de prix

### Gestion de la planification Workfront

Nom : `manage-workfront-planning`

Cette compétence interroge et gère les objets Workfront Planning tels que :
...
### Gestion des objets Workfront

Nom : `manage-workfront-objects`

Cette compétence permet de créer et de mettre à jour des projets, tâches, événements, portefeuilles et programmes Workfront. Voici quelques exemples sans s’y limiter :

* Création d’un projet
* Ajouter une tâche
* Définition des dates prévues
* Attribution d’une tâche

### Données Query Workfront

Nom : `query-workfront-data`

Cette compétence recherche, répertorie et génère des rapports sur les objets Workfront tels que :
