...
Lorsque vous vous abonnez à des problèmes, des tâches ou des projets, vous recevez des notifications in-app lorsqu’une personne publie un commentaire à son sujet. Selon les fonctionnalités que vous avez activées, vous pouvez également recevoir des notifications push par courrier électronique et par application mobile pour les éléments auxquels vous êtes abonné.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Accès à [!UICONTROL View] ou supérieur au projet, à la tâche ou au problème (pour s’abonner)</p> <p>Autorisations d’[!UICONTROL Gérer] d’accès et de [!UICONTROL Partager] sur le projet, la tâche ou le problème (pour s’abonner à d’autres utilisateurs).</p> </td> 
  </tr> 
 </tbody> 
</table>
...
Le processus d’abonnement à un élément est identique pour tous les éléments.

Par exemple, pour vous abonner à un problème :
...
1. Cliquez sur **[!UICONTROL Plus]** ![](assets/more-icon.png), puis cliquez sur **[!UICONTROL Abonner]**.
   ...
   Une coche s’affiche sur la cloche et le numéro à côté se met à jour pour vous ajouter au nombre d’utilisateurs abonnés.

   Vous êtes maintenant abonné au problème. L’état de mise à jour des enregistrements du problème que vous avez abonnés au problème.
...
1. Vous pouvez également vous désabonner d’un élément auquel vous êtes abonné en cliquant sur le bouton [!UICONTROL Désabonner] dans l’email d’abonnement.
   ...
   L’état de mise à jour des enregistrements de l’élément que vous avez désabonnés du problème.

## Gestion des abonnés

Vous pouvez gérer les personnes qui s’abonnent à des projets, des tâches et des problèmes pour lesquels vous disposez des autorisations de gestion et de partage.
...
1. Accédez à l’élément auquel vous souhaitez abonner un autre utilisateur.

   >[!TIP]
   >
   >Pour abonner un autre utilisateur à des projets, vous pouvez effectuer l’une des opérations suivantes :
   >
   >* Accédez au projet auquel vous souhaitez vous abonner ou
   >   
...
1. Accédez à l’élément à partir duquel vous souhaitez désabonner un autre utilisateur.

   >[!TIP]
   >
   >Pour désabonner un autre utilisateur à des projets, vous pouvez effectuer l’une des opérations suivantes :
   >
   >* Accédez au projet duquel vous souhaitez désabonner d’autres utilisateurs, ou
   >   
   >* Accédez à une liste de projets ou à un rapport et sélectionnez un projet.
...
1. Cliquer sur **[!UICONTROL Enregistrer]**.
   ...
   L’utilisateur n’est pas informé de sa désinscription de l’élément, mais une entrée sur l’abonnement est ajoutée aux mises à jour système de l’élément.

## Réception d’une notification in-app

Immédiatement après qu’une personne a publié un commentaire sur un article auquel vous êtes abonné, vous recevez une notification in-app.

![](assets/in-app-not---cmmnt-sbscibd-to-350x164.png)

Pour plus d’informations, voir [Affichage et gestion des notifications in-app](../../workfront-basics/using-notifications/view-and-manage-in-app-notifications.md).
...
>[!NOTE]
>
>Même si vous désactivez le courrier électronique d’abonnement, vous continuerez à recevoir des notifications in-app chaque fois qu’une personne aura commenté un article auquel vous êtes abonné.

## Répertorier les utilisateurs abonnés à un élément

Pour voir qui s’abonne à un élément :

1. Accédez à un élément pour lequel vous souhaitez afficher les abonnés.
