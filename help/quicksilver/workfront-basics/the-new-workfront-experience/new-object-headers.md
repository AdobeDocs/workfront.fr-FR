...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Vous pouvez modifier la [!UICONTROL Project Owner] dans l’en-tête.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Planned Completion Date] </td> 
   <td> <p>Vous pouvez modifier la [!UICONTROL Planned Completion Date] et l’heure du projet dans l’en-tête si le projet est planifié à partir de la [!UICONTROL Completion Date]. Si le projet est planifié à partir de la [!UICONTROL Start Date], ces informations sont mises à jour à partir des tâches du projet.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Condition] </td> 
   <td> <p>Lorsque vous définissez le [!UICONTROL Condition Type] du projet sur Manuel, vous pouvez mettre à jour le [!UICONTROL Condition] du projet dans l’en-tête.</p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Lorsque vous êtes l’une des personnes approbatrices, utilisez les icônes suivantes pour gérer les approbations du projet :</p> <p> <img src="assets/nwe-approvals-approve-16x18.png" style="width: 16;height: 18;"> </img> [!UICONTROL Approve]</p> <p> <img src="assets/nwe-approvals-reject-16x19.png" style="width: 16;height: 19;"> </img> [!UICONTROL Reject]</p> <p> <img src="assets/nwe-approvals-recall-16x16.png" style="width: 16;height: 16;"> </img> [!UICONTROL Recall]</p> <p>Si vous n’êtes pas un approbateur ou une approbatrice, cliquez sur l’icône [!UICONTROL More] <img src="assets/more-icon-for-approvals-area.png"> pour afficher des informations sur l’étape d’approbation actuelle.</p> <p>Pour en savoir plus sur les approbations, voir <a href="../../review-and-approve-work/manage-approvals/approval-process-in-workfront.md" class="MCXref xref">Vue d’ensemble du processus d’approbation</a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">Chemin de navigation avec les objets parent</td> 
   <td> <p>Les objets parents de la tâche s’affichent dans le chemin de navigation. Cliquer sur le nom du parent ouvre cet objet parent.</p> <p>Pour plus d’informations, voir <a href="../../workfront-basics/the-new-workfront-experience/breadcrumb-overview.md" class="MCXref xref">Vue d’ensemble des chemins de navigation</a>.</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td role="rowheader">Icône d’objet </td> 
   <td> <p>L’icône [!UICONTROL Task] verte <img src="assets/nwe-tasks-icon.png"> s’affiche à gauche du nom de la tâche.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader"> <p>Bouton [!UICONTROL Work on It], [!UICONTROL Done] ou [!UICONTROL Start Task]</p> </td> 
   <td> <p>Si la tâche vous est assignée, vous pouvez cliquer sur le bouton [!UICONTROL Work on It] <span>ou [!UICONTROL Start Task]</span> pour indiquer que vous êtes en train de travailler sur la tâche ou sur le bouton [!UICONTROL Done] pour indiquer que vous avez terminé la tâche.</p> <p><span>Pour plus d’informations sur le remplacement du bouton [!UICONTROL Work On It] par un bouton [!UICONTROL Start Task], voir <a href="../../people-teams-and-groups/create-and-manage-teams/work-on-it-button-to-start-button.md" class="MCXref xref">Remplacer le bouton [!UICONTROL Work On It] par un bouton [!UICONTROL Start]</a></span>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Planned Completion Date]</td> 
   <td> <p>Vous pouvez modifier la [!UICONTROL Planned Completion Date] <span>et l’heure</span> de la tâche dans l’en-tête.</p> <p>Conseil : notez que la [!UICONTROL Commit Date] n’est pas visible dans l’en-tête. Vous pouvez l’afficher sur la page des [!UICONTROL Details].</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Status]</td> 
  ...
  <tr> 
   <td role="rowheader">Zone [!UICONTROL Approvals]</td> 
   <td> <p>Lorsque vous figurez parmi les approbateurs et les approbatrices, utilisez les icônes suivantes pour gérer les approbations de la tâche :</p> <p> <img src="assets/nwe-approvals-approve-16x18.png" style="width: 16;height: 18;"> </img> [!UICONTROL Approve]</p> <p> <img src="assets/nwe-approvals-reject-16x19.png" style="width: 16;height: 19;"> </img> [!UICONTROL Reject]</p> <p> <img src="assets/nwe-approvals-recall-16x16.png" style="width: 16;height: 16;"> </img> [!UICONTROL Recall]</p> <p>Si vous n’êtes pas un approbateur ou une approbatrice, cliquez sur l’icône [!UICONTROL More] <img src="assets/more-icon-for-approvals-area.png"> pour afficher des informations sur l’étape d’approbation actuelle.</p> <p>Pour en savoir plus sur les approbations, voir <a href="../../review-and-approve-work/manage-approvals/approval-process-in-workfront.md" class="MCXref xref">Vue d’ensemble du processus d’approbation</a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">Chemin de navigation avec les objets parent</td> 
   <td> <p>Les objets parents du problème s’affichent dans le chemin de navigation. Cliquer sur le nom du parent ouvre cet objet parent.</p> <p>Pour plus d’informations, voir <a href="../../workfront-basics/the-new-workfront-experience/breadcrumb-overview.md" class="MCXref xref">Vue d’ensemble des chemins de navigation</a>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Icône d’objet </td> 
   <td> <p>L’icône rose du [!UICONTROL Issue] <img src="assets/nwe-issues-icon.png"> s’affiche à gauche du nom du problème.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader">Nom du type d’objet</td> 
   <td> <p>Le texte « [!UICONTROL ISSUE] » s’affiche au-dessus du nom du problème dans l’en-tête.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Percent Complete]</td> 
   <td> <p>Vous pouvez modifier le pourcentage terminé du problème à partir de l’en-tête.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Assignments]</td> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Work on It], [!UICONTROL Done] <span>ou bouton [!UICONTROL Start Issue]</span></td> 
   <td>Si le problème vous est affecté, vous pouvez cliquer sur le bouton [!UICONTROL Work on It] <span>ou [!UICONTROL Start Issue]</span> pour indiquer que vous êtes en train de travailler sur le problème ou sur le bouton [!UICONTROL Done] pour indiquer que vous avez terminé le problème.<span>Pour plus d’informations sur le remplacement du bouton [!UICONTROL Work On It] par un bouton [!UICONTROL Start Task], consultez la section </span> <span href="../../people-teams-and-groups/create-and-manage-teams/work-on-it-button-to-start-button.md"><a href="../../people-teams-and-groups/create-and-manage-teams/work-on-it-button-to-start-button.md" class="MCXref xref">Remplacer le bouton [!UICONTROL Work On It] par un bouton [!UICONTROL Start].</a></span><span>.</span></td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Planned Completion Date]</td> 
   <td> <p>Vous pouvez modifier la [!UICONTROL Planned Completion Date] <span>et l’heure</span> du problème dans l’en-tête.</p> <p>Conseil : notez que la [!UICONTROL Commit Date] n’est pas visible dans l’en-tête. Vous pouvez l’afficher sur la page des [!UICONTROL Details].</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Status]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Vous pouvez accéder au [!UICONTROL Portfolio] à partir de l’en-tête du [!UICONTROL Program]. Cliquer sur le nom du parent ouvre cet objet parent.</p> <p>Pour plus d’informations, voir <a href="../../workfront-basics/the-new-workfront-experience/breadcrumb-overview.md" class="MCXref xref">Vue d’ensemble des chemins de navigation</a>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Icône d’objet </td> 
   <td> <p>L’icône orange du [!UICONTROL Program] <img src="assets/nwe-programs-icon.png"> s’affiche à gauche du nom du programme.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader">Nom du type d’objet</td> 
   <td> <p>Si le programme est marqué comme [!UICONTROL Active], le texte « [!UICONTROL PROGRAM] » s’affiche au-dessus du nom du programme dans l’en-tête.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Percent Complete]</td> 
   <td> <p>Vous ne pouvez pas modifier le [!UICONTROL Percent Complete] du programme dans l’en-tête. Ces informations sont mises à jour à partir des projets du programme.</p> <p>Conseil : par défaut, le pourcentage terminé du programme est une moyenne des valeurs de pourcentage terminé des projets dans un [!UICONTROL Current] ou un [!UICONTROL Approved Status] appartenant au programme.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Program Manager]</td> 
   <td> <p>Vous pouvez modifier le [!UICONTROL Program Manager] dans l’en-tête. Il s’agit du même nom que le ou la [!UICONTROL Program Owner].</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Planned Completion Date]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">Statut de l’activation</td> 
   <td> <p>Si le modèle est désactivé, le texte « [!UICONTROL TEMPLATE DEACTIVATED] » s’affiche au-dessus du nom du modèle dans l’en-tête.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Zone d’actions du modèle</td> 
   <td> <p>En regard du nom du modèle, la zone d’actions s’affiche.</p> <p> <img src="assets/actions-area-icons-without-share-button.png"> </p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Les objets parent de la tâche de modèle s’affichent dans le chemin de navigation. Cliquez sur le nom d’un objet parent pour l’ouvrir.</p> <p>Pour plus d’informations, voir <a href="../../workfront-basics/the-new-workfront-experience/breadcrumb-overview.md" class="MCXref xref">Vue d’ensemble des chemins de navigation</a>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Icône d’objet </td> 
   <td> <p>L’icône verte [!UICONTROL Task] <img src="assets/nwe-tasks-icon.png"> s’affiche à gauche du nom de la tâche de modèle.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader">Nom du type d’objet</td> 
   <td> <p>Le texte « [!UICONTROL TEMPLATE TASK] » s’affiche au-dessus du nom de la tâche de modèle dans l’en-tête.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Zone d’actions de la tâche de modèle</td> 
   <td> <p>La zone d’actions s’affiche à côté du nom de la tâche de modèle.</p> <p> <img src="assets/actions-area-icons-without-share-button.png"> </p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Assignments]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">Chemin de navigation vers les objets parent</td> 
   <td> <p>Les objets parent de l’enregistrement de facturation s’affichent dans le chemin de navigation. Cliquez sur le nom d’un objet parent pour l’ouvrir.</p> <p>Pour plus d’informations, voir <a href="../../workfront-basics/the-new-workfront-experience/breadcrumb-overview.md" class="MCXref xref">Vue d’ensemble des chemins de navigation</a>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Icône d’objet </td> 
   <td> <p>L’icône bleue [!UICONTROL Billing Record] <img src="assets/nwe-billing-record-icon-57x55.png" style="width: 57;height: 55;"> s’affiche à gauche du nom de l’enregistrement de facturation.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Status]</td> 
   <td> <p>Lorsque l’état de l’enregistrement de facturation est [!UICONTROL Billed], vous ne pouvez plus le modifier.</p> <p>Vous pouvez modifier le Statut de l’enregistrement de facturation dans l’en-tête.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">Statut de l’activation</td> 
   <td> <p>Si la personne a été désactivée, le texte et l’image de profil de l’en-tête sont grisés.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Zone d’actions de la personne</td> 
   <td> <p>La zone d’actions s’affiche en regard du nom de la personne.</p> <p> <img src="assets/actions-area-icons-without-share-button.png"> </p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Vous pouvez afficher les équipes auxquelles la personne appartient. Pointez la souris sur l’avatar d’une équipe pour afficher le nom de l’équipe. Vous ne pouvez pas modifier les équipes dans l’en-tête.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">Icône d’objet </td> 
   <td> <p>L’icône violette [!UICONTROL Team] <img src="assets/nwe-teams-icon.png"> s’affiche à gauche du nom de l’équipe.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">Icône d’objet </td> 
   <td> <p>L’icône orange [!UICONTROL Iteration] <img src="assets/nwe-iteration-icon-58x58.png" style="width: 58;height: 58;"> s’affiche à gauche du nom de l’itération.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>À côté du nom du groupe, le menu [!UICONTROL More] <img src="assets/more-menu.png"> s’affiche, ce qui vous permet de sélectionner les options suivantes :</p> 
    <ul> 
     <li> <p>[!UICONTROL Edit]</p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">Chemin de navigation avec les objets parent</td> 
   <td> <p>Les objets parent du document s’affichent dans le chemin de navigation. Cliquez sur le nom d’un objet parent pour l’ouvrir.</p> <p>Pour plus d’informations, voir <a href="../../workfront-basics/the-new-workfront-experience/breadcrumb-overview.md" class="MCXref xref">Vue d’ensemble des chemins de navigation</a>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Icône d’objet </td> 
  ...
  <tr> 
   ...
   <td> <p>La zone d’actions s’affiche à côté du nom du document.</p> <p> <img src="assets/actions-area-icons-for-a-document.png"> </p></td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">Icône d’objet </td> 
   <td> <p>L’icône bleue [!UICONTROL Company] <img src="assets/nwe-company-icon.png"> s’affiche à gauche du nom de l’entreprise.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>La zone d’actions s’affiche à côté du nom du plan.</p> <p> <img src="assets/actions-area-icons-without-share-button.png"> </p></td> 
  </tr> 
  <tr> 
   ...
   <td> <p>Sous la zone du nom du plan et des actions, vous pouvez effectuer les actions suivantes :</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Show conflicts]</strong> : cliquez sur ce bouton (bascule) pour afficher ou masquer les conflits dans les initiatives.</p> </li> 
     <li> <p><strong>[!UICONTROL Compare scenarios]</strong> : cliquez sur ce lien pour afficher une comparaison côte à côte des scénarios que vous avez créés.</p> </li> 
     <li> <p><strong>[!UICONTROL Scenario selection]</strong> : dans ce menu déroulant, vous pouvez copier un scénario ou en sélectionner un autre pour affichage.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">Icône d’objet </td> 
   <td> <p>L’icône violette [!UICONTROL Goal] <img src="assets/goal-icon.png" > s’affiche à gauche du nom de l’objectif.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader">Nom du type d’objet</td> 
   <td> <p>Le texte « [!UICONTROL GOAL] » s’affiche au-dessus du nom de l’objectif dans l’en-tête.</p> </td> 
  </tr> 
  <tr> 
