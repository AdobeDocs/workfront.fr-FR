...
L’icône **[!UICONTROL Menu principal]** ![Menu principal](assets/main-menu-icon-left-nav.png) ouvre le [!UICONTROL Menu principal], où vous pouvez accéder à une autre zone de Workfront.
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li>[!UICONTROL Boards] : <a href="/help/quicksilver/agile/boards-overview.md">Présentation des tableaux</a></li>
     <li>[!UICONTROL Blueprints] : <a href="/help/quicksilver/administration-and-setup/blueprints/blueprints-overview.md">présentation des blueprints</a></li>
     <li>[!UICONTROL Priority] : <a href="/help/quicksilver/workfront-basics/priorities/get-started-with-priorities.md">Prise en main des priorités</a></li>
