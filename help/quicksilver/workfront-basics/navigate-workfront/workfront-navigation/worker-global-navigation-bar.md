...
description: Le menu principal change en fonction du niveau d'accès qui vous a été attribué par votre administrateur [!DNL Adobe Workfront]. Par défaut, vous n’avez accès qu’aux zones qui incluent les fonctionnalités autorisées par votre niveau d’accès.
