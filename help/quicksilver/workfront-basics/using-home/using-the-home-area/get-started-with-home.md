...
Pour plus d’informations sur l’utilisation des regroupements, voir [Afficher les éléments dans le [!UICONTROL Liste de tâches] dans le [!UICONTROL Accueil] area](../../../workfront-basics/using-home/using-the-home-area/display-items-in-home-work-list.md).
...
>[!NOTE]
>
>Toutes les tâches ajoutées à [!UICONTROL Ma priorité] ne sont visibles que par vous, et personne ne peut donner la priorité au travail pour vous.

Pour plus d’informations sur l’utilisation de [!UICONTROL Ma priorité], voir [Définir la priorité du travail dans le [!UICONTROL Accueil] area](../../../workfront-basics/using-home/using-the-home-area/prioritize-work-in-home.md).
