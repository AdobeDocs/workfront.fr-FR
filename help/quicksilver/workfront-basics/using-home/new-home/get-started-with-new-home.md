...
description: La nouvelle page d’accueil est une nouvelle fonctionnalité puissante pour gérer votre travail. Vous pouvez personnaliser cet espace flexible pour mettre en avant le travail le plus important et optimiser la gestion des tâches, des problèmes, des demandes et des approbations.
author: Nolan
...
1. Accédez à votre page d’accueil en effectuant l’une des opérations suivantes :
   ...
   * Si la page d’accueil est définie comme page de destination, cliquez sur l’icône **Adobe Workfront** ![Icône Adobe Workfront](../new-home/assets/home-icon-30x29.png) dans le coin supérieur gauche de votre écran.
   * Cliquez sur l’icône **Menu principal** dans le coin supérieur droit de l’écran, ou sur l’icône **Menu principal** ![Icône Menu principal](../new-home/assets/main-menu-icon-left-nav.png) dans le coin supérieur gauche, le cas échéant, puis sur **Accueil**.
...
1. Accédez à votre page d’accueil, soit en cliquant sur l’icône **Adobe Workfront** ![Icône Adobe Workfront](../new-home/assets/home-icon-30x29.png) dans le coin supérieur gauche de votre écran si la page d’accueil est définie comme votre page de destination, soit en cliquant sur l’icône **Menu principal** dans le coin supérieur droit ![](assets/dots-main-menu.png) ou sur l’icône **Menu principal** ![Icône Menu principal](../new-home/assets/main-menu-icon-left-nav.png) dans le coin supérieur gauche, le cas échéant, puis en cliquant sur **Accueil**.
