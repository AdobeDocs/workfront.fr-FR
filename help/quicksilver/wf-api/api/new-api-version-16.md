      ...
      <td>
        <ul>
          <li>
            ...
            <p>Cette action renvoie une valeur booléenne qui indique si le client a désactivé l’option de mise à niveau automatique des titulaires de licence de contributeur.</p>
         </li>
        </ul>
      </td>
    </tr>  </tbody>
