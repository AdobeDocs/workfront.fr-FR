...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Accès en modification à la gestion des ressources qui inclut l’accès en modification des priorités et des heures du budget dans le planificateur de ressources.</p> <p>Modifier l'accès aux données financières qui inclut l'accès à Modifier les taux de coûts et à Modifier Finances générales, pour budgéter les ressources par coût</p> <p>Accès Modifier aux projets et aux utilisateurs et utilisatrices</p></td> 
  </tr> 
  <tr> 
