...
title: Configuration de la manière dont Workfront calcule l’heure de la ressource et la disponibilité de l’éditeur de texte enrichi pour la zone de planification
description: L’administrateur d’Adobe Workfront détermine la manière dont Workfront calcule la disponibilité des ressources et l’allocation des utilisateurs au niveau du système (en tenant compte des heures ainsi que de la disponibilité de l’éditeur de texte enrichi) lorsqu’il configure les préférences de gestion des ressources.
author: Alina
...
# Configuration de la manière dont Workfront calcule l’heure de la ressource et la disponibilité de l’éditeur de texte enrichi pour la zone de planification
...
L’administrateur d’Adobe Workfront détermine la manière dont Workfront calcule la disponibilité des ressources et l’allocation des utilisateurs au niveau du système (en tenant compte des heures ainsi que de la disponibilité de l’éditeur de texte enrichi) lorsqu’il configure les préférences de gestion des ressources.

Ils peuvent choisir d’utiliser l’une des méthodes suivantes :
...
* Lorsque vous autorisez Workfront à affecter automatiquement des ressources, comme décrit dans l’article suivant :
...
* Lors de l’affichage des indicateurs d’attribution, comme décrit dans l’article suivant :

   * La section &quot;Indicateurs d’affectation&quot; de l’article  [Gestion des affectations d’utilisateurs dans les zones de planification](../../resource-mgmt/resource-scheduling/manage-allocations-scheduling-areas.md).
