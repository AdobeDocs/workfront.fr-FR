...
1. Dans l’équilibreur de charge de travail, accédez au **Travail attribué** et développez un utilisateur.
1. Utilisez l’une des méthodes suivantes :
   ...
   * Cliquez sur le bouton **Plus** icon ![](assets/more-icon-task-list.png) à droite du nom d’un élément de travail, cliquez sur **Attribuez-le à**, supprimez ensuite le nom des entités affectées à l’élément de travail ou saisissez un autre nom, puis cliquez sur **Enregistrer**.
