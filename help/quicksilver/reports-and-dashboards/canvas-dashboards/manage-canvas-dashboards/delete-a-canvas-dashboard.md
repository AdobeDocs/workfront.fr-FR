...
title: Supprimer un tableau de bord de la zone de travail
...
> Si vous supprimez un tableau de bord contenant un rapport classique, ce dernier ne sera pas supprimé.
...
1. Dans le coin supérieur droit, sélectionnez l’icône **Plus** ![Plus](assets/more-icon.png), puis sélectionnez **Supprimer le tableau de bord**.
   ![Supprimer le tableau de bord](assets/delete-dashboard.png)
