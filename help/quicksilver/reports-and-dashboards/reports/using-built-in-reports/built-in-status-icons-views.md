...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>Indique que le statut du projet est Ciblé (vert), En difficulté (rouge) ou À risque (jaune). <br>Pour plus d'informations sur le statut du projet, voir <a href="../../../manage-work/projects/manage-projects/project-condition-and-condition-type.md" class="MCXref xref">Aperçu du statut du projet et du type de statut</a>.</td> 
   <td>Projets</td> 
