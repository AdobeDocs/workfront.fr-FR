...
description: L’exportation de données peut être motivée, entre autres, par l’option ÉDITION.
author: Nolan
...
* Il existe une limite pour afficher seulement 2 000 résultats sur une page de l’application web Workfront. Si votre rapport en produit plus de 2 000, vous pouvez l’exporter dans l’un des formats mentionnés ci-dessous et obtenir tous les résultats du rapport dans une seule liste.
...
* **256 colonnes**: Il s’agit d’une limite imposée par Excel aux documents qui contiennent plus de 256 colonnes. Ces documents ne peuvent pas être exportés manuellement ou envoyés dans un rapport remis. Cette limite existe uniquement pour les fichiers Excel et non pour les autres formats pris en charge.
...
* [Exporter les données d’un rapport ou d’une liste](#export-data-from-a-report-or-list)
...
1. Cliquez sur **Exporter**, puis sélectionnez un format.
   ...
   >[!NOTE]
   Pour exporter un rapport Tableau de bord, vous devez disposer d’une licence Plan .\
   ![](assets/nwe-dashboard-export-note-350x271.png)

   Ou

   Cliquez sur le bouton **Exporter** icon ![](assets/export-icon-nwe.png), puis sélectionnez un format.
...
Pour plus d’informations sur l’export de données depuis un tableau de bord, voir [Exportation d’un tableau de bord](../../../reports-and-dashboards/dashboards/creating-and-managing-dashboards/export-dashboard.md).
...
* Lorsque vous exportez des listes de tâches et de problèmes dans un projet :
   ...
   * *Problèmes liés au projet*(*dans des formats délimités par des tabulations, dans PDF, Excel (.xlsx) ou Excel*
...
*Nom_rapport*(*dans des formats délimités par des tabulations, dans PDF, Excel (.xlsx) ou Excel*

### Titles {#titles}

Lorsque vous exportez une liste d’objets, seul le fichier au format PDF comporte un titre. Si vous exportez une liste ou un rapport dans des formats délimités par des tabulations, Excel (.xlsx) ou Excel, le fichier ne comporte pas de titre.

* [Titres pour les listes exportées](#titles-for-exported-lists)
* [Titre des rapports exportés](#titles-for-exported-reports)
...
Si le rapport est exporté dans des formats délimités par des tabulations, Excel ou Excel, le rapport exporté n’aura pas de titre. Le titre du fichier exporté est le nom du rapport tel qu&#39;il apparaît dans l&#39;application web Workfront.

Si le rapport comporte une description, il sera inclus dans le fichier exporté.
