...
title: Affichage de l’utilisation des rapports
description: Affichage de l’utilisation des rapports
author: Nolan
...
* Liste des tableaux de bord qui contiennent le rapport\
   Pour plus d’informations sur l’affichage du nom des tableaux de bord sur lesquels des rapports peuvent être ajoutés dans une liste de rapports, consultez l’article [Comprendre comment organiser les rapports sur un tableau de bord](../../../reports-and-dashboards/reports/report-usage/understand-how-organize-reports-dashboard.md).
...
Pour plus d’informations sur les champs en fonction desquels vous pouvez filtrer un rapport, reportez-vous à l’article . [Filtrage d’une liste de rapports par informations d’utilisation](#filter-a-report-list-by-usage-information).
...
1. (Facultatif) Sélectionnez le **Utilisation du rapport** pour afficher les informations les plus courantes sur l’utilisation des rapports.\
   Ou

1. Cliquez sur **Nouvelle vue** pour créer une vue personnalisée.
1. Cliquez sur **Ajouter une colonne**.
1. Commencez à saisir les champs suivants et sélectionnez-les lorsqu’ils apparaissent dans la liste sous **Rapport** pour les ajouter à une nouvelle colonne :
   ...
   * **Vues**: Affiche le nombre de vues dans l’une des périodes suivantes :
      ...
      * **Ce mois, ce trimestre, cette année**
      * **Mois, trimestre, année derniers**
...
1. Commencez à saisir les champs suivants et sélectionnez-les lorsqu’ils apparaissent dans la liste sous **Rapport** pour les ajouter en tant que nouvelle règle de filtrage :
...
1. Cliquez sur **Enregistrer le filtre**.\
   ...
   Pour plus d’informations sur la création d’un rapport, reportez-vous à l’article [Création d’un rapport personnalisé](../../../reports-and-dashboards/reports/creating-and-managing-reports/create-custom-report.md). Pour créer un rapport, vous devez disposer de l’accès Modifier aux rapports au niveau d’accès .\
   Pour plus d’informations sur l’accès aux rapports, reportez-vous à l’article [Accorder l’accès aux rapports, aux tableaux de bord et aux calendriers](../../../administration-and-setup/add-users/configure-and-grant-access/grant-access-reports-dashboards-calendars.md).
...
* Chaque fois qu’un rapport est affiché sur un tableau de bord ou un onglet personnalisé, il est compté comme une vue. L’utilisateur qui affiche ce rapport sur son tableau de bord est affiché en tant que Dernière vue par : Nommez l’utilisateur et la date d’affichage du tableau de bord s’affiche comme la date Dernière consultation.
* Workfront ne collecte pas d’informations d’utilisation pour les rapports natifs.\
   Pour plus d’informations sur les rapports intégrés de Workfront, reportez-vous à l’article [Utilisation des rapports intégrés d’Adobe Workfront](../../../reports-and-dashboards/reports/using-built-in-reports/use-workfront-built-in-reports.md).
...
* Workfront ne collecte pas d’informations d’utilisation sur les rapports distribués. Un rapport livré ne compte pas comme une vue.\
   Pour plus d’informations sur les rapports distribués, voir l’article [Présentation de la diffusion des rapports](../../../reports-and-dashboards/reports/creating-and-managing-reports/set-up-report-deliveries.md).
