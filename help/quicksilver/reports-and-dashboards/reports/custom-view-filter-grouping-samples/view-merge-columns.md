...
title: '« Vue : fusionner les informations de plusieurs colonnes en une colonne partagée »'
...
1. En utilisant le mode texte pour une vue, ajoutez le texte suivant à la première colonne que vous souhaitez fusionner :
   ...
   **Exemple :** voici le code en mode texte pour une colonne fusionnée qui contient trois colonnes distinctes, en commençant par la deuxième colonne de la liste. Les valeurs fusionnées sont le nom du projet, la date de début prévue et le nom de la personne propriétaire du projet, et il n’y a pas de saut entre les trois valeurs :
...
1. Cliquez sur **Passer en mode texte** et ajoutez le code suivant dans la colonne centrale que vous avez ajoutée à l’étape 1 :
...
1. Cliquez sur la première colonne et cliquez sur **Passer en mode texte**, puis ajoutez le texte suivant à la colonne :
   ...
   **Exemple :** voici le code du mode texte pour une colonne partagée qui contient le nom du projet, la date de début prévue et le nom de la personne propriétaire du projet avec un saut de ligne. La colonne partagée est la deuxième colonne d’une vue de projet.
