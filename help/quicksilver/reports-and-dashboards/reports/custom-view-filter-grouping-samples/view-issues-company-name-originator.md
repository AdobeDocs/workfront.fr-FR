...
title: "Afficher : problèmes avec le nom de la société de l’auteur"
...
1. Cliquez sur l’en-tête de la colonne restante, puis sur **Passer en mode Texte**, puis cliquez sur **Modifier le mode Texte**.
