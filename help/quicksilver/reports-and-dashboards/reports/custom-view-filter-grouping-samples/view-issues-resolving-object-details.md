...
title: '« Vue : problèmes avec détails de l’objet de résolution »'
...
Cette vue utilise la balise

```
sharecol=true
```

pour combiner plusieurs champs sous le même en-tête de colonne. Pour plus d’informations sur la balise
