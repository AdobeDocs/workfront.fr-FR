...
# Affichage : affichage de projet à plusieurs lignes
...
* Affichez les informations du projet dans un format multiligne.\
  ...
  pour combiner plusieurs champs sous le même en-tête de colonne. Pour en savoir plus sur cette balise, voir [Vue : fusionner les informations de plusieurs colonnes dans une seule colonne partagée](../../../reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-merge-columns.md).
