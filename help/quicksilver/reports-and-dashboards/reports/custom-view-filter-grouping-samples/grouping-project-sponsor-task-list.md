...
title: '''Groupement : Parraineur de projet pour une liste de tâches"'
...
# Regroupement : Sponsor de projet pour une liste de tâches
...
1. Dans le **Regroupement** menu déroulant, sélectionnez **Nouveau groupement**.
