...
group.0.name=Entrée du projet
group.0.valueexpression=IF(ABS(DATEDIFF({entryDate},$$TODAY))&lt;=30,&quot;30 derniers jours&quot;, IF(ABS(DATEDIFF({entryDate},$$TODAY))>30&amp;&amp;ABS(DATEDIFF({entryDate},$$TODAY)&lt;=60,&quot;30 60 jours&quot;,&quot;Plus de 60 jours&quot;))
