...
title: 'Groupement : répartition du pourcentage de la tâche 2'
description: "Dans ce groupement de tâches personnalisé, vous pouvez afficher les tâches regroupées selon une plage de valeurs de pourcentage de réalisation. Les ventilations présentent une valeur de 10 % d’incréments de point de pourcentage : 1 à 10 %, 11 à 20 %, etc."
...
![task_10__ventilation_grouping.png](assets/task-10--breakdown-grouping-350x547.png)
