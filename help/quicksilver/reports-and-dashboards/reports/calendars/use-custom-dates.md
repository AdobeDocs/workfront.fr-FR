...
# Utilisation de champs de date personnalisés dans un rapport de calendrier
...
1. Vous devez disposer de champs de date personnalisés et d’une valeur dans le champ disponible dans votre [!DNL Workfront] instance. Si aucun formulaire personnalisé n’est configuré avec des dates personnalisées, suivez les instructions des deux premières sections de la section [Création ou modification d’un formulaire personnalisé](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/create-or-edit-a-custom-form.md).
   ...
   <table style="table-layout:auto">
    ...
    <tbody>
     ...
     <tr>
      ...
      <td>Choisir <strong>[!UICONTROL Dates personnalisées]</strong>.<br></td>
     </tr>
     <tr>
