...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Autorisations en gestion pour le tableau de bord</p> <p>Autorisations d’affichage du rapport</p> <p>Pour plus d’informations sur la demande d’accès supplémentaire, voir <a href="../../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Demander l’accès aux objets</a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
Vous devez créer un rapport avant d’y ajouter un tableau de bord.
...
1. Accédez à un rapport pour lequel vous disposez des autorisations de gestion et que vous souhaitez ajouter à un tableau de bord.
1. Cliquez sur le menu déroulant **Actions de rapport**.
1. Cliquez sur **Ajouter au tableau de bord**. Un maximum de 10 tableaux de bord récemment modifiés (appartenant à la personne connectée) s’affichent dans l’ordre du plus récent au plus ancien.
