...
title: Ajouter d’autres personnes chargées de l’approbation à l’approbation de documents envoyés
description: Vous pouvez ajouter d’autres personnes chargées de l’approbation à l’approbation d’un document directement à partir de la zone d’accueil.
author: Courtney
...
1. Sélectionnez une approbation de **document**.

1. Cliquez sur **Gérer les approbations** dans le coin supérieur droit du panneau de droite.
1. Dans la zone **Demander à une personne d’approuver ce document**, saisissez le nom de la personne chargée de l’approbation.
