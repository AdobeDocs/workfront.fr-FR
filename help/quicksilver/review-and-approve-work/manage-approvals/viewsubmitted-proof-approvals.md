...
title: Afficher des approbations d’épreuves soumises
description: Les validations de vérification s’affichent dans la zone d’accueil uniquement si votre environnement Adobe Workfront est intégré à un compte Workfront Proof Premium. Si vous ne pouvez pas utiliser le correctif comme décrit ici, contactez votre administrateur Workfront.
author: Courtney
...
1. Cliquez sur une approbation **BAT** dans la liste de travail.
...
1. (Facultatif) Cliquez sur **Aller à BAT** dans le coin supérieur droit du panneau de droite pour lancer la visionneuse de vérification de l’orthographe.
