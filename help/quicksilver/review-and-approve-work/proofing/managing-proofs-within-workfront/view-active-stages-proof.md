...
title: Afficher les étapes actives sur une épreuve
description: Vous pouvez afficher les étapes actives actuelles sur un BAT contenant un workflow automatisé.
author: Courtney
...
1. Passez la souris sur le document qui contient le BAT que vous souhaitez afficher, puis sélectionnez **Workflow de vérification de BAT** pour afficher les étapes du BAT.
