...
title: Ajouter des étapes et des utilisateurs et utilisatrices à un workflow automatisé dans une épreuve
description: Si vous êtes la personne propriétaire de l’épreuve, vous pouvez ajouter des étapes à un workflow automatisé existant.
author: Courtney
...
# Ajouter des étapes et des utilisateurs et utilisatrices à un workflow automatisé dans une épreuve

Si vous êtes la personne propriétaire de l’épreuve, vous pouvez ajouter des étapes à un workflow automatisé existant.
...
## Ajouter des étapes et des utilisateurs et utilisatrices à un workflow automatisé
...
1. Dans le coin supérieur droit d’Adobe Workfront, cliquez sur **Nouvelle étape**.
