---
title: Affichage et gestion des détails sur les versions du BAT
description: Affichage et gestion des détails sur les versions du BAT
author: Courtney
draft: Probably
...
# Affichage et gestion des détails sur les versions du BAT
...
1. Dans une liste de documents, passez la souris sur la ligne contenant le BAT, puis cliquez sur **Détails du document**.
...
1. Dans le **Version** dans le résumé, cliquez sur la version, puis sur **Détails** dans la liste déroulante qui s’affiche.

1. Sur la page Détails du document , cliquez sur **Workflow de vérification** dans le panneau de gauche pour effectuer l’une des opérations suivantes :

   * Ajoutez un workflow automatisé. Pour plus d’informations, reportez-vous à la section de l’article .
   * Partagez l’URL publique du BAT. Pour plus d’informations, voir [Partage d’un lien de BAT](../../../../review-and-approve-work/proofing/managing-proofs-within-workfront/share-a-proof-in-workfront.md#share) in [Partage d’un BAT dans Adobe Workfront](../../../../review-and-approve-work/proofing/managing-proofs-within-workfront/share-a-proof-in-workfront.md).
