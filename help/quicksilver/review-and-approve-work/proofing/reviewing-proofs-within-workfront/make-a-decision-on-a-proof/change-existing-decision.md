...
description: Tant que le BAT est actif (non verrouillé ou archivé), vous pouvez modifier votre décision à tout moment.
author: Courtney
...
1. Dans la zone **BAT Decision** qui s’affiche, cliquez sur **Supprimer la décision** sous la décision que vous avez prise précédemment.
