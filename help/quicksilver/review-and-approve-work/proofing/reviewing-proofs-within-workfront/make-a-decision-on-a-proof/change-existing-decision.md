...
title: Modifier une décision existante sur un BAT
description: Tant que le BAT est principal (non verrouillé ou archivé), vous pouvez modifier votre décision à tout moment.
author: Courtney
...
# Modifier une décision existante sur un BAT

Tant que le BAT est principal (non verrouillé ou archivé), vous pouvez modifier votre décision à tout moment. 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"><strong>Rôle BAT</strong> </td> 
...
1. Cliquez sur la décision que vous avez prise au centre supérieur de la visionneuse de vérification.
1. Dans le **Décision du BAT** s’affiche, cliquez sur **Supprimer la décision** sous la décision que vous avez prise précédemment.
