...
1. Cliquez sur **Comparaison des bons à tirer**.
   ...
   Pour plus d’informations sur les outils que vous pouvez utiliser pour comparer les deux bons à tirer, voir  [Utilisation des outils de comparaison](../../../../workfront-proof/wp-work-proofsfiles/review-proofs-wpv/compare-proofs.md#using-compare-tools) in [Comparaison des bons à tirer dans la visionneuse de BAT](../../../../workfront-proof/wp-work-proofsfiles/review-proofs-wpv/compare-proofs.md).

## Comparer deux versions du même BAT

Pour plus d’informations sur la comparaison de deux versions d’un même BAT, voir [Comparaison des versions de BAT](../../../../workfront-proof/wp-work-proofsfiles/review-proofs-wpv/compare-proofs.md#comparing-proof-versions) in [Comparaison des bons à tirer dans la visionneuse de BAT](../../../../workfront-proof/wp-work-proofsfiles/review-proofs-wpv/compare-proofs.md).
