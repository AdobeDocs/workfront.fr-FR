...
title: 'Révision et approbation des intégrations natives : index des articles'
description: 'Les articles suivants contiennent des informations sur les intégrations de documents natifs à Adobe Workfront : GenStudio for Performance Marketing, Creative Cloud Express, Frame.io, Adobe Experience Manager, etc.'
...
# Réviser et approuver les intégrations natives : index des articles

<!--Audited: 12/2025-->

Les articles suivants contiennent des informations sur les intégrations de documents natifs à Adobe Workfront
...
* [Lier du contenu et des dossiers de Experience Manager Assets à l’espace de stockage dans le cloud Adobe](/help/quicksilver/review-and-approve-work/native-integrations/link-aem-assets-cloud-storage.md)
