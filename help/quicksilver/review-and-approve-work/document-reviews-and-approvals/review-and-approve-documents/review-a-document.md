...
Pour réviser un document à partir de la visionneuse Frame.io, votre instance Workfront doit être intégrée à Frame.io. Pour plus d’informations, consultez la [Présentation de la révision et de l’approbation unifiées](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/document-approvals-overview.md).