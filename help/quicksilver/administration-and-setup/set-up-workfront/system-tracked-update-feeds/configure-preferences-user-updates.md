...
>* Les images ne sont accessibles que par le biais de la variable [!UICONTROL Mises à jour] sur un objet et ne sont pas disponibles dans la variable [!UICONTROL Documents] .
>
...
1. Sélectionnez la **[!UICONTROL Préférences]** .

   ![Préférences utilisateur pour les flux de mise à jour](assets/updatefeeds-preferences-350x137.png)

1. Sélectionnez la **[!UICONTROL Autoriser les utilisateurs à ajouter des images dans les mises à jour]** .
