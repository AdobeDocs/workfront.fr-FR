...
description: Adobe Workfront enregistre l’activité de certains objets dans leur zone [!UICONTROL Mises à jour]. Une mise à jour système comprend une brève note décrivant le type de modification apportée à l'objet. [!DNL Workfront] les administrateurs peuvent définir le type de modifications que le système doit suivre dans la section [!UICONTROL Mises à jour].
author: Alina
...
# Flux des mises à jour suivies par le système : index des articles
