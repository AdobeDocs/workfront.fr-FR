...
title: Configuration des utilisateurs pour la journalisation du temps en heures ou en jours
...
Les utilisateurs disposant d’une licence [!UICONTROL Standard] ou [!UICONTROL Planner] peuvent configurer s’ils consignent le temps [!DNL Adobe Workfront] en heures ou en jours. En tant qu’administrateur ou administratrice de [!DNL Workfront], vous pouvez configurer ce paramètre pour des utilisateurs et utilisatrices individuels ou pour plusieurs utilisateurs et utilisatrices de votre entreprise. Par défaut, les utilisateurs et utilisatrices consignent le temps en heures.
