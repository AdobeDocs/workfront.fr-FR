...
1. Dans la **Menu Principal** ![](assets/main-menu-icon.png), cliquez sur **Configuration**.
...
1. Pour le **Rapports** , cliquez sur l’objet **Paramètres** en regard du niveau d’accès le plus élevé disponible, puis désélectionnez **Affichage des rapports intégrés**.
