   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr data-mc-conditions=""> 
      ...
      <td>Activez cette option pour émettre un nouveau jeton d’actualisation chaque fois que le jeton d’actualisation est utilisé. Votre application doit stocker le nouveau jeton d’actualisation après chaque actualisation.</td> 
     </tr> 
     <tr data-mc-conditions=""> 
