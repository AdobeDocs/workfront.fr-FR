...
# Affichage et gestion des applications OAuth2 personnalisées

En tant que [!DNL Adobe Workfront] administrateur, vous pouvez afficher et gérer les applications OAuth2 pour votre instance de [!DNL Workfront], qui permettent à d’autres applications d’accéder à [!UICONTROL Workfront].
...
1. Afficher les détails dans la zone Secret client :
   ...
   * Notes
      ...
      Pour ajouter des notes à un secret client, reportez-vous à la section [Ajout ou modification de notes pour le secret client](#add-or-edit-notes-for-client-secret).
...
1. Cliquez sur prêt à l’emploi ou appuyez sur **[!UICONTROL Entrée]** pour enregistrer le texte de la note.
