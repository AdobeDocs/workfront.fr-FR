...
title: Création et modification des plannings d’un groupe
...
Pour obtenir des informations générales sur la création et la modification d’un planning, voir [Création d’un planning](../../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/create-schedules.md).
