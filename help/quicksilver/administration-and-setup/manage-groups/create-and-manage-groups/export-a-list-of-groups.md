...
description: Lorsque vous affichez des groupes que vous gérez, vous pouvez exporter une liste de ces groupes.
author: Caroline
...
Lorsque vous affichez des groupes que vous gérez, vous pouvez exporter une liste de ces groupes.
...
1. Si vous souhaitez exporter l’ensemble du groupe de groupes que vous gérez, cliquez sur l’icône Exporter ![](assets/export.png).

   Ou

   Pour exporter certains des groupes que vous gérez, sélectionnez-les, puis cliquez sur l’icône Exporter ![](assets/export.png).

1. Sélectionnez le format de fichier souhaité pour la liste exportée.
