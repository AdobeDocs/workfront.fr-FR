...
Pour plus d’informations sur les modèles de disposition et les profils métier, voir [Présentation des profils métier](/help/quicksilver/administration-and-setup/add-users/create-and-manage-users/business-profiles.md).
...
1. Dans la zone qui s’affiche, cliquez sur **Ajouter un utilisateur, une fonction, une équipe, un groupe ou un niveau d’accès**, commencez à saisir le nom d’un utilisateur, d’une fonction, d’une équipe, d’un groupe ou d’un niveau d’accès, puis cliquez sur le nom lorsqu’il apparaît dans la liste déroulante.
...
* À un certain niveau d’accès, l’utilisateur est affecté à
...
* Niveau d’accès : si la personne n’est pas affectée à un modèle de mise en page en tant qu’utilisateur individuel, ni en tant qu’utilisateur disposant d’une fonction principale, ni en tant que membre d’une équipe interne, ni en tant que membre d’un groupe interne, le modèle lui est affecté.
