...
1. Dans le **Zone de navigation supérieure**, cliquez sur **Sélectionner une landing page**, puis sélectionnez la zone que les utilisateurs doivent voir lorsqu’ils se connectent.

   >[!IMPORTANT]
   >
   >La consultation des zones Scénarios et Objectifs nécessite des licences supplémentaires. Pour plus d’informations sur les objectifs de Workfront, voir [Présentation des objectifs d’Adobe Workfront](https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&amp;topicId=Content%2FWorkfront_Goals%2FGoal_management%2Fwf-goals-overview.htm&amp;_LANG=en) ou pour plus d’informations sur le planificateur de scénario Workfront, voir [Présentation du planificateur de scénarios](../../../scenario-planner/scenario-planner-overview.md).
