...
description: Vous pouvez copier un modèle de mise en page existant. Cela s’avère utile lorsque votre entreprise a besoin de plusieurs modèles de mise en page qui partagent plusieurs des mêmes paramètres.
author: Alina
...
Vous pouvez copier un modèle de mise en page existant. Cela s’avère utile lorsque votre entreprise a besoin de plusieurs modèles de mise en page qui partagent plusieurs des mêmes paramètres.
...
1. Dans l’écran qui s’affiche, saisissez une nouvelle **Nom du modèle de mise en page** et (facultatif) a **Description** pour cela.

1. Affectez le modèle aux utilisateurs qui en ont besoin, comme décrit dans la section [Affecter des utilisateurs à un modèle de mise en page](../../../administration-and-setup/customize-workfront/use-layout-templates/assign-users-to-layout-template.md).
