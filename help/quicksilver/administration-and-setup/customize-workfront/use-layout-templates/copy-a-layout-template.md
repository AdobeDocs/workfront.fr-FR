...
1. Dans l’écran qui s’affiche, saisissez un nouveau **Nom de modèle de disposition** et (facultatif) une **Description**.

1. Affectez le modèle aux personnes qui en ont besoin, comme décrit dans la section [Affecter des utilisateurs et des utilisatrices à un modèle de disposition](../../../administration-and-setup/customize-workfront/use-layout-templates/assign-users-to-layout-template.md).
