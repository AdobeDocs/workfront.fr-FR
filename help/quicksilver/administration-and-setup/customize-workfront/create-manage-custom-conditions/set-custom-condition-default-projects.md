---
title: Définition d’une condition personnalisée comme condition par défaut pour les projets
...
# Définition d’une condition personnalisée comme condition par défaut pour les projets

Si le type de condition d’un projet est défini sur État de progression au lieu de Manuel, Adobe Workfront affiche automatiquement l’une des trois conditions par défaut intégrées au projet (Sur la cible, À risque ou En danger) au fur et à mesure de son évolution, comme expliqué dans la section [Présentation de la condition et du type de condition du projet](../../../manage-work/projects/manage-projects/project-condition-and-condition-type.md).
