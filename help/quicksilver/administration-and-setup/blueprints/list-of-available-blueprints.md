...
**[!UICONTROL Plan de livraison de services contractuels]**
Ce plan directeur contient un modèle qui organise le travail lié à la prestation de services orientés clients. Il est conçu pour créer une approche uniforme de la prestation des services sous contrat.

**[!UICONTROL Plan d’événement d’entreprise]**
Ce plan directeur contient un modèle que l’organisation de services professionnels [!DNL Workfront] utilise depuis des années lors des missions de mise en œuvre avec les équipes des ressources humaines pour soutenir les activités de fidélisation des employés, en particulier les événements et les parties de l’entreprise.

**[!UICONTROL Désactiver la liste de contrôle informatique des employés licenciés]**
Ce plan directeur contient un modèle que l’organisation de services professionnels [!DNL Workfront] utilise depuis des années lors des missions de mise en œuvre avec les équipes informatiques de l’entreprise afin de gérer les différentes activités qui doivent avoir lieu lorsqu’un employé quitte son emploi. Il est essentiel de désactiver l’accès des membres du personnel et d’apporter d’autres changements aux systèmes afin de réduire l’exposition au risque et de s’assurer que les autres membres de l’équipe puissent rester productifs et productives en l’absence de la personne licenciée.
...
**[!UICONTROL Production de ressources numériques] (gérée)**
...
Le plan directeur [!UICONTROL Révision des ressources numériques] d’un processus intégré contient un modèle unique pour organiser le processus de travail associé à la révision d’une ressource existante. Le modèle fournit un processus allégé pour une équipe qui s’appuie sur des procédures opérationnelles standard pour définir la manière de faire le travail et utilise le projet uniquement pour hiérarchiser les tâches et suivre la progression.

**[!UICONTROL Révision Des Ressources Numériques] (Gérée)**
...
**[!UICONTROL Modifier la liste de contrôle informatique pour le transfert d&#39;employé]**
...
Ce plan directeur contient la configuration des structures organisationnelles pour les étendre à un service financier.

**[!UICONTROL Initiative stratégique interne générale]**
Le plan directeur [!UICONTROL Initiative stratégique interne générale] contient un modèle de projet dans lequel exécuter un projet pour toute optimisation interne, déploiement de processus ou autre investissement stratégique. Il est conçu pour être suffisamment général pour fonctionner pour toutes les organisations dans l’ensemble de l’entreprise.

**[!UICONTROL Configuration de l&#39;organisation des ressources humaines]**
Ce plan directeur contient la configuration des structures organisationnelles pour les étendre à un service de ressources humaines.

**[!UICONTROL Configuration de l&#39;organisation informatique]**
Ce plan directeur contient la configuration des structures organisationnelles pour les étendre à un cas d’utilisation des technologies de l’information.

**[!UICONTROL Principes de base des instances héritées | Liste de contrôle]**
Ce plan directeur contient un modèle de projet (ou une liste de contrôle) que vous pouvez consulter avec une courte liste de questions, de ressources et de liens pour une compréhension claire de la configuration de votre instance Workfront. Utilisez-le lorsque vous avez récemment hérité d’une instance de Workfront et que vous avez besoin de conseils pour savoir par où commencer.

**[!UICONTROL Exécution de campagne intégrée]**
Le plan directeur [!UICONTROL Exécution de campagne intégrée] contient un modèle de projet unique qui organise le travail distribué entre plusieurs équipes pour exécuter une campagne multicanal.
...
Ce plan directeur contient un modèle que l’organisation [!DNL Workfront professional services] utilise depuis des années lors des missions de mise en œuvre avec les équipes de ressources humaines pour aider les nouveaux employés à suivre leurs activités d’intégration.
...
**[!UICONTROL Post-Implémentation : Nouveau Cas D’Utilisation De Déploiement]**
Ce plan directeur contient un modèle unique qui organise le travail qu’un client [!DNL Workfront] devra effectuer pour gérer l’extension aux processus suivants après leur implémentation initiale.

**[!UICONTROL Impression de la production de ressources] (intégrée)**
Le package [!UICONTROL Impression de production de ressources] contient un modèle qui organise le travail pour un processus d’impression de production standard. Le modèle fournit un processus allégé de création de ressources d’impression originales pour une équipe qui s’appuie sur des procédures d’exploitation standard pour définir la manière de travailler et qui utilise le projet uniquement pour prioriser le travail et suivre la progression.

**[!UICONTROL Impression de la production des ressources] (gérée)**
Le package [!UICONTROL Impression de production de ressources] contient un modèle qui organise le travail pour un processus d’impression de production standard. Ce package est conçu comme un point d’entrée pour la gestion de la création de ressources d’impression dans Workfront. Utilisez ce package pour créer les bases de la création de contenu d’impression, puis personnalisez-le afin de répondre aux besoins d’autres processus créatifs pour les supports imprimés.
...
**[!UICONTROL Configuration de l’organisation Professional Services]**
Ce plan directeur contient la configuration des structures organisationnelles pour l’étendre à un cas d’utilisation de Services professionnels.

**[!UICONTROL Suivi des processus de recrutement]**
Ce plan directeur définit une liste de contrôle à utiliser pour les ressources de recrutement internes afin d’aider les parties prenantes de l’entreprise à suivre l’avancement des demandes d’effectifs. Il est conçu pour prendre en charge un niveau de maturité géré.
...
**[!UICONTROL Auto-évaluation du contrôle des risques : planification clé de la réduction des risques]**
L’[!UICONTROL autoévaluation du contrôle des risques] (RSCA) définit un processus permettant d’identifier les risques et de mesurer les contrôles que vous avez mis en place pour les atténuer. Ce modèle formalise le processus d’évaluation des nouveaux risques, de mise en place de contrôles appropriés et de connaissances sur la mesure et la documentation de l’efficacité du contrôle.

**[!UICONTROL Auto-évaluation du contrôle des risques : attestation trimestrielle]**
L’[!UICONTROL auto-évaluation du contrôle des risques] (RSCA) définit un processus permettant d’identifier les risques et de mesurer les contrôles mis en place par votre organisation pour atténuer ces risques. Ce modèle fournit une structure pour vous aider à créer un registre initial des risques, à établir un plan d’atténuation de chaque risque et à fournir une documentation pour montrer le fonctionnement des contrôles.

**[!UICONTROL Production d’actifs sociaux] (intégrée)**
...
**[!UICONTROL Production de ressources sociales] (gérée)**
...
Ce plan directeur contient un seul tableau de bord pour aider les administrateurs système à gérer et à nettoyer régulièrement le système contre tout encombrement qui pourrait s’accumuler au fil du temps.
...
**[!UICONTROL Production de ressources vidéo] (gérée)**
