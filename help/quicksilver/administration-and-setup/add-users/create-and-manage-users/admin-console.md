...
1. Dans la zone **Ajouter des utilisateurs/utilisatrices à ce profil de produit** , saisissez l’adresse e-mail ou le nom d’un utilisateur ou d’une utilisatrice que vous souhaitez ajouter, puis sélectionnez **Enregistrer**.
   ...
   <span class="preview">Si votre administrateur Workfront a défini un niveau d’accès par défaut pour les utilisateurs créés dans Admin Console, l’utilisateur est créé avec ce niveau d’accès à la place. Pour plus d’informations, voir [Configuration des préférences système](/help/quicksilver/administration-and-setup/manage-workfront/security/configure-security-preferences.md).</span>
...
[Modifier les détails de l’utilisateur](https://helpx.adobe.com/fr/enterprise/using/bulk-upload-users.html#edit-user-details?lang=fr) dans l’article Gestion de plusieurs utilisateurs dans la documentation d’Adobe.
