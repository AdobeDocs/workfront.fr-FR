...
Associé à la licence Work, ce niveau d’accès intégré est conçu pour les utilisateurs qui effectuent le travail dans Workfront. Ils ne planifient pas le travail; ils le terminent.
...
Associé à la licence Request , ce niveau d’accès intégré est conçu pour les utilisateurs qui effectuent et reçoivent des demandes de travail simples dans Workfront. Par défaut, elles sont limitées à la zone Demandes .
