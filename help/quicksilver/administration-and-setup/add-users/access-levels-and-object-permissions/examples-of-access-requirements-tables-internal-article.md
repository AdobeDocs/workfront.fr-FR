---
title: Exemples de tableaux des exigences d’accès - article interne
...
<table>
  ...
  <tr>
   ...
   <td> <p>Frame.io entreprise, AEM, Creative Cloud</p>
   </td>
  </tr>
   <tr>
   <td>Configurations des niveaux d’accès
...
## les packages 2017 doivent être supprimés de la ligne packages .

Forfaits 2017
Licences : révision, travail, planificateur
Package : équipe, pro, entreprise, entreprise

Packages 2023
Licences : contributeur, léger, standard
Package : select, prime, ultimate

Packages de workflows 2025
Licences : contributeur, léger, standard
Package : sélection de workflow, Workflow principal, Workflow ultime
...
## Exigences d’accès pour les types d’enregistrements centralisés dans Workfront Planning
...
## Conditions d’accès requises pour la plupart des planificateurs de scénarios
...
<td><p>Configurations des niveaux d’accès</p> </td> 
   <td> <p>Modifier l’accès au planificateur de scénarios</p> </td> 
  </tr> 
  <tr> 
   <td> <p>Autorisations d’objet </p> </td> 
   <td> <p>Gérer les autorisations d’un plan</p>  </td> 
  </tr> 
 </tbody> 
</table>
...
## Conditions d’accès requises pour la plupart des objectifs Workfront

>[!NOTE]
>
>Vous pouvez continuer à utiliser les objectifs Adobe Workfront si votre société a déjà acheté ce package par le passé. Les Objectifs Adobe Workfront ne peuvent plus être achetés.
...
## Conditions d’accès requises pour l’automatisation et l’intégration d’Adobe Workfront
