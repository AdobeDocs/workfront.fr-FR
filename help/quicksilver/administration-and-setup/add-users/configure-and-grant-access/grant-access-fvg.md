---
title: Accorder l’accès aux filtres, aux vues et aux regroupements
...
En tant qu&#39;administrateur Adobe Workfront, vous pouvez utiliser un niveau d&#39;accès pour définir l&#39;accès d&#39;un utilisateur aux contrôles de filtrage, d&#39;affichage et de regroupement pour les listes et les rapports, comme expliqué dans la section [Présentation des niveaux d’accès](../../../administration-and-setup/add-users/access-levels-and-object-permissions/access-levels-overview.md).
...
1. Cliquez sur l’icône d’engrenage ![](assets/gear-icon-settings.png) sur le **Affichage** ou **Modifier** à droite de Filtres, puis sélectionnez les fonctionnalités sous lesquelles vous souhaitez accorder **Ajuster vos paramètres**.
