...
1. Attribuez le nouveau niveau d&#39;accès à un utilisateur, comme décrit dans la section [Ajout d&#39;utilisateurs](../../../administration-and-setup/add-users/create-and-manage-users/add-users.md).
   ...
   >[!NOTE]
   >
   >Vous pouvez permettre aux utilisateurs d’avoir un accès administratif aux utilisateurs. Pour plus d’informations sur l’accès administratif des utilisateurs afin qu’ils puissent gérer les comptes d’utilisateurs, voir [Octroi de l’accès aux utilisateurs](../../../administration-and-setup/add-users/configure-and-grant-access/grant-access-other-users.md).
