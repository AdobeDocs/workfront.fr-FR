...
* Annonces sur les produits {#product-announcements}
  ...
  * Versions de produit {#product-releases}
    ...
    * Version Du T3 2026 {#release-26-q3}
      ...
      * [Améliorations apportées à l’administration au troisième trimestre 2026](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-admin-and-setup.md)
      ...
      * [Améliorations de la maison au troisième trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-home.md)
      * [Améliorations du projet au troisième trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-projects.md)
      ...
      * [Améliorations de la gestion des ressources pour le troisième trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-resource-mgmt.md)
      * [Autres améliorations du troisième trimestre 2026](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-other.md)
    ...
    * Version du 3e trimestre 2025 {#release-25-q3}
      ...
      * {hide-from-toc}[Améliorations apportées aux projets](/help/quicksilver/product-announcements/product-releases/25-q3-release-activity/25-q3-project-enhancements.md)
    ...
    * Activité des versions de la planification Adobe Workfront{#planning-release-activity}
      * [Activité des versions de la planification Adobe Workfront](product-announcements/product-releases/planning-release-activity/planning-release-activity-article-index.md)
      ...
      * [Activité des versions pour la planification Adobe Workfront du quatrième trimestre 2025](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-25-q4.md)
      * [Activité des versions du troisième trimestre 2025 pour la planification Adobe Workfront](product-announcements/product-releases/planning-release-activity/planning-release-activity-25-q3.md)
      * [Activité des versions du deuxième trimestre 2025 pour la planification Adobe Workfront](product-announcements/product-releases/planning-release-activity/planning-release-activity-25-q2.md)
      * [Activité des versions du premier trimestre 2025 pour la planification Adobe Workfront](product-announcements/product-releases/planning-release-activity/planning-release-activity-25-q1.md)
      * [Activité des versions pour la planification Adobe Workfront du quatrième trimestre 2024](product-announcements/product-releases/planning-release-activity/planning-release-activity-24-q4.md)
    * Activité de publication de la disponibilité limitée Adobe Workfront{#limited-availability-release-activity}
      * {hide-from-toc}[Activité de mise à jour des fonctionnalités de disponibilité limitée d’](/help/quicksilver/product-announcements/product-releases/limited-availability-release-activity/limited-availability-release-activity-article-index.md)
      * {hide-from-toc}[Activité de la version du premier trimestre 2026 pour les fonctionnalités à disponibilité limitée d’Adobe Workfront](/help/quicksilver/product-announcements/product-releases/limited-availability-release-activity/limited-availability-release-activity-26-q1.md)
      * {hide-from-toc}[Activité de la version du deuxième trimestre 2026 pour les fonctionnalités à disponibilité limitée d’Adobe Workfront](/help/quicksilver/product-announcements/product-releases/limited-availability-release-activity/limited-availability-release-activity-26-q2.md)
      * {hide-from-toc}[Activité de la version du quatrième trimestre 2026 pour les fonctionnalités à disponibilité limitée d’Adobe Workfront](/help/quicksilver/product-announcements/product-releases/limited-availability-release-activity/limited-availability-release-activity-26-q4.md)
  ...
  * Programmes bêta {#beta}
    ...
    * Version bêta des tableaux de bord de la zone de travail {#canvas-dashboards-beta}
      ...
      * {hide-from-toc}[Présentation de la version Beta de la zone de travail de création de rapports](product-announcements/betas/canvas-dashboards-beta/reporting-canvas-beta-overview.md)
      * {hide-from-toc}[Version Beta des tableaux de bord de la zone de travail : activité de publication](product-announcements/betas/canvas-dashboards-beta/canvas-dashboards-release-activity.md)
    * Nouvelle version bêta de l’expérience de commentaires {#new-commenting-experience-beta}
      * {hide-from-toc}[Nouvelles informations sur l’expérience bêta de commentaires](product-announcements/betas/new-commenting-experience-beta/new-commenting-beta-experience-information.md)
      * {hide-from-toc}[Nouvelle expérience de commentaire](product-announcements/betas/new-commenting-experience-beta/unified-commenting-experience.md)
      * {hide-from-toc}[Nouvelle activité de mise à jour d’expérience de commentaire](product-announcements/betas/new-commenting-experience-beta/new-commenting-beta-experience-release-activity.md)
      * {hide-from-toc}[Nouvelles questions fréquentes sur l’expérience de commentaire](product-announcements/betas/new-commenting-experience-beta/new-commenting-faq.md)
* Administration et configuration {#administration-and-setup}
  ...
  * Configurer Workfront {#set-up-wf}
    ...
    * Configurer les paramètres système par défaut {#configure-system-defaults}
      ...
      * [Activer le stockage dans le cloud Adobe pour votre organisation](administration-and-setup/set-up-workfront/configure-system-defaults/enable-esm.md)
      * [Conversion de portefeuilles hérités en espace de stockage Adobe](administration-and-setup/set-up-workfront/configure-system-defaults/convert-portfolios-to-acs.md)
      ...
      * [Collaborateurs ou collaboratrices IA](/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/ai-collaborators-overview.md)
  ...
  * Gestion d’Adobe Workfront {#manage-wf}
    ...
    * Sécurité {#security}
      ...
      * {hide-from-toc}[Présentation de l’authentification améliorée](administration-and-setup/manage-workfront/security/get-started-enhanced-authentication.md)
      * {hide-from-toc}[Mise à jour des métadonnées SAML 2.0 dans votre fournisseur d’identité lors de l’utilisation de l’authentification améliorée](administration-and-setup/add-users/single-sign-on/update-saml-2-metadata-ip-eauth.md)
  ...
  * Configurer les intégrations {#configure-integrations}
    ...
    * [Migration de Workfront OAuth2 vers Adobe Developer Console](/help/quicksilver/administration-and-setup/configure-integrations/migrate-oauth2-to-developer-console.md)
  ...
  * Conseils, astuces et résolution des problèmes pour l’administration et la configuration {#admin-setup-tips}
    ...
    * {hide-from-toc}[Mettre à jour les options de mise à niveau automatique dans les niveaux d’accès](administration-and-setup/tips-tricks-and-troubleshooting/update-auto-upgrade-in-access-levels.md)
* Concepts de base Adobe Workfront {#basics}
  ...
  * Page d’accueil {#home}
    ...
    * {hide-from-toc}[Passer de la maison héritée à la nouvelle maison](/help/quicksilver/workfront-basics/using-home/new-home/move-to-new-home.md)
  ...
  * Serveur MCP Workfront {#workfront-mcp-server}
    * [Serveur MCP Workfront : index des articles](/help/quicksilver/workfront-basics/workfront-mcp-server/workfront-mcp-server.md)
  ...
  * Utiliser les notifications {#use-notifications}
    ...
    * {hide-from-toc}[Présentation des notifications Experience Cloud](/help/quicksilver/workfront-basics/using-notifications/exp-cloud-notifications-overview.md)
  ...
  * Gérer votre compte et votre profil {#manage-account-profile}
    ...
    * Gérer votre compte Adobe Workfront {#manage-workfront-account}
      ...
      * {hide-from-toc}[Réinitialiser le mot de passe d’un utilisateur avec l’authentification améliorée](workfront-basics/manage-your-account-and-profile/managing-your-workfront-account/reset-user-password-eauth.md)
...
* Documents {#documents}
  ...
  * Gérer les documents {#manage-documents}
    ...
    * {hide-from-toc}[AddBuilder dans les détails du document Workfront](/help/quicksilver/documents/managing-documents/app-builder-doc-details.md)
  ...
  * Adobe Cloud Drive {#adobe-cloud-drive}
    ...
    * [Présentation d’Adobe Cloud Drive](documents/adobe-cloud-drive/adobe-cloud-drive-overview.md)
    * [Installation d’Adobe Cloud Drive](documents/adobe-cloud-drive/install-adobe-cloud-drive.md)
...
* Rapports {#reporting}
  ...
  * Tableaux de bord de la zone de travail {#canvas-dashboards}
    * {hide-from-toc}[Présentation des tableaux de bord Zone de travail](reports-and-dashboards/canvas-dashboards/canvas-dashboards-overview.md)
  ...
  * Tableaux de bord {#dashboards}
    ...
    * Créer et gérer des tableaux de bord {#create-dashboards}
      ...
      * {hide-from-toc}[Présentation des tableaux de bord Zone de travail](reports-and-dashboards/dashboards/creating-and-managing-dashboards/canvas-dashboards-overview.md)
...
* Gérer les ressources {#manage-resources}
  ...
  * Planification de ressources dans Adobe Workfront {#resource-planning-in-adobe-workfront}
...
* Réviser et approuver le travail {#review-and-approve-work}
  ...
  * Approbations unifiées {#document-reviews-and-approvals}
    ...
    * Configurer et gérer les approbations de ressources et de documents {#manage-asset-review-and-approval}
      ...
      * [Gestion des modèles d’approbation](review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/manage-approval-templates.md)
    ...
    * Réviser et approuver les ressources et les documents {#review-and-approve-documents}
      ...
      * [Afficher le score et les commentaires des réviseurs de contenu](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/view-ai-reviewer-feedback.md)
...
* Adobe Workfront Planning {#adobe-workfront-planning}
  * [Index des informations générales et des articles pour Adobe Workfront Planning](planning/planning-information.md)
  * Informations générales sur Adobe Workfront Planning {#adobe-workfront-planning-general-information}
    * [Informations sur la planification Adobe Workfront : index des articles](planning/general/planning-general-article-index.md)
    * [Commencer à utiliser la planification Adobe Workfront](planning/general/planning-overview.md)
    ...
    * [Vue d’ensemble des limites d’objets de la planification Adobe Workfront](planning/general/limitations-overview.md)
    * [Commencer avec la version d’essai gratuite de la planification Adobe Workfront](planning/general/trial-workfront-planning.md)
  * Création de rapports Adobe Workfront Planning {#adobe-workfront-planning-reporting}
    * [Rapports Adobe Workfront Planning : index des articles](planning/reporting/reporting-in-planning-article-index.md)
    * [Affichage des informations sur Workfront Planning dans les rapports](planning/reporting/planning-information-in-reports.md)
  ...
  * Bonnes pratiques relatives à Adobe Workfront Planning {#adobe-workfront-planning-best-practices}
    ...
    * [Concevoir la réussite : modéliser la hiérarchie de vos campagnes](planning/best-practices.md/model-campaign-hierarchy.md)
  ...
  * Champs de la planification Adobe Workfront {#adobe-workfront-planning-fields}
  ...
  * Accès à la planification Adobe Workfront {#adobe-workfront-planning-access}
    * [Informations sur l’accès à la planification Adobe Workfront : index des articles](planning/access/access-information.md)
    * [Vue d’ensemble de l’accès à la planification Adobe Workfront](planning/access/access-overview.md)
    * [Vue d’ensemble du partage d’autorisations dans la planification Adobe Workfront](planning/access/sharing-permissions-overview.md)
    * [Vue d’ensemble du type de licence lors de l’utilisation de la planification Adobe Workfront](planning/access/license-type-overview.md)
    ...
    * [Partager les champs de planification Workfront](planning/access/share-fields.md)
  ...
  * Enregistrements de la planification Adobe Workfront {#adobe-workfront-planning-records}
    ...
    * [Créer des objets Workfront à partir de la planification Workfront en les connectant à des enregistrements](planning/records/create-workfront-objects-from-workfront-planning.md)
    * [Configurer des automatisations de la planification Adobe Workfront](planning/records/configure-automations-to-create-records.md)
    * [Créer des objets à l’aide de l’automatisation des enregistrements de la planification Workfront](/help/quicksilver/planning/records/create-wf-objects-using-planning-automations.md)
  * Demandes de la planification Adobe Workfront {#adobe-workfront-planning-requests}
    * [Demandes de la planification Adobe Workfront : index des articles](planning/requests/requests-article-index.md)
    * [Créer et gérer un formulaire de demande dans la planification Adobe Workfront](planning/requests/create-request-form.md)
    * [Envoyer des demandes de la planification Adobe Workfront pour créer des enregistrements](planning/requests/submit-requests.md)
    * [Demandes de partage de Planning](planning/requests/share-requests.md)
    * [Annuler la publication d’un formulaire de demande dans la planification Adobe Workfront](planning/requests/unpublish-request-form.md)
    * [Ajouter une approbation à un formulaire de demande dans la planification Adobe Workfront](planning/requests/add-approval-to-request-form.md)
    * [Approuver une demande dans la planification Adobe Workfront](planning/requests/approve-request.md)
  ...
  * Notifications de la planification Adobe Workfront {#adobe-workfront-planning-notifications}
    * [Notifications de la planification Adobe Workfront : index des articles](planning/notifications/notifications-information.md)
    * [Gérer les préférences de notification de la planification Adobe Workfront](planning/notifications/manage-notification-preferences.md)
    * [Gérer les notifications par e-mail de la planification Adobe Workfront](planning/notifications/manage-planning-email-notifications.md)
    * [Gérer les notifications in-app de la planification Adobe Workfront](planning/notifications/manage-planning-in-app-notifications.md)
  * Intégration de la planification Adobe Workfront et de GenStudio for Performance Marketing {#planning-and-genstudio-integration}
    * [Intégration de la planification Adobe Workfront et d’Adobe GenStudio for Performance Marketing : index des articles](planning/planning-and-genstudio-integration/planning-and-genstudio-integration-article-index.md)
    * [Commencer avec l’intégration de la planification Adobe Workfront et d’Adobe GenStudio for Performance Marketing](planning/planning-and-genstudio-integration/get-started-with-workfront-planning-and-genstudio-integration.md)
    ...
    * {hide-from-toc}[Promouvoir un espace de travail Workfront Planning vers GenStudio](planning/planning-and-genstudio-integration/promote-planning-workspace-to-genstudio.md)
  * Adobe Workfront Planning en tant que produit autonome {#planning-standalone}
    * [Adobe Workfront Planning en tant que produit autonome : index des articles](planning/planning-sta/planning-sta-article-index.md)
    * [Prise en main d’Adobe Workfront Planning en tant que produit autonome](planning/planning-sta/planning-sta-overview.md)
    * [Accès nécessaire pour Adobe Workfront Planning en tant que produit autonome](planning/planning-sta/access-needed-for-planning-sta.md)
...
* Intégrations Adobe Workfront {#adobe-workfront-integrations}
  ...
  * Adobe Workfront pour Creative Cloud {#workfront-for-creative-cloud}
    ...
    * Charger des documents et des épreuves avec le plug-in Adobe Workfront pour les applications Creative Cloud {#upload-docs-proofs-wf-cc}
      * {hide-from-toc}[Chargez des documents et des épreuves à partir du  [!DNL Adobe Workfront plugin]  vers le  [!DNL Creative Cloud]](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/upload-documents-and-proofs.md)
...
* Workfront Proof {#workfront-proof}
  ...
  * Workfront Proof mobile {#wf-proof-mobile}
    ...
    * Conseils, astuces et résolution des problèmes pour l’application mobile de Workfront Proof {#ttt-wf-proof-mobile-apps}
      ...
      * {hide-from-toc}[Connexion à l’application mobile Workfront Proof impossible](workfront-proof/wp-mobile/tips-tricks-and-troubleshooting/unable-to-log-in.md)
...
* API Adobe Workfront {#adobe-workfront-api}
  ...
  * Notes de l’API {#api-notes}
    ...
    * [Nouveautés de la version 22 de l’API](/help/quicksilver/wf-api/api/new-api-version-22.md)
...
* API ProofHQ {#proofhqpapi}
  ...
  * Général {#general}
    ...
    * {hide-from-toc}[Exemples de code](proofhq-api/general/code-samples.md)
