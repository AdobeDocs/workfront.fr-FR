...
* Annonces sur les produits {#product-announcements}
   ...
   * Versions de produit {#product-releases}
      ...
      * Version du 1er trimestre 2025 {#release-25-q1}
         ...
         * [Améliorations de la vérification au 1er trimestre 2025](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-proofing-enhancements.md)
         * [Améliorations du rapport et du tableau de bord du premier trimestre 2025](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-report-and-dashboard-enhancements.md)
         * [Autres améliorations au cours de la période de publication du premier trimestre 2025](/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-other-enhancements.md)
      ...
      * Version du 4e trimestre 2024 {#release-24-q4}
         ...
         * [Améliorations du tableau de bord et du rapport 2024](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-report-and-dashboard-enhancements.md)
...
* Concepts de base Adobe Workfront {#basics}
   ...
   * Priorités {#priorities}
      ...
      * [Priorités : Versions à venir](workfront-basics/priorities/priorities-upcoming-releases.md)
      * [Prise en main des priorités](workfront-basics/priorities/get-started-with-priorities.md)
      * [Afficher les détails des projets et des tâches dans la liste de travail Priorités](workfront-basics/priorities/view-task-project-details.md)
   ...
   * Assistant IA {#ai-assistant}
      ...
      * [Utilisation de l’assistant IA pour travailler avec des projets, des tâches et des problèmes](/help/quicksilver/workfront-basics/ai-assistant/work-with-pti-through-ai-assisant.md)
...
* Agile {#agile}
   ...
   * Commencer avec les panoramas dans Adobe Workfront {#boards-in-workfront}
...
* Gérer le travail {#manage-work}
   ...
   * Projets {#projects}
      ...
      * Gérer des projets {#manage-projects}
         ...
         * [Résumer les mises à jour à l’aide de l’assistant AI](/help/quicksilver/manage-work/projects/manage-projects/summarize-projects-ai-assistant.md)
   ...
   * Tâches {#tasks}
      ...
      * Durée de tâche et types de durée {#task-duration-and-duration-types}
   ...
   * Gestion de portfolio {#portfolio-management}
      ...
      * Créer et gérer des programmes {#create-and-manage-programs}
         * [Présentation des programmes dans  [!DNL Adobe Workfront]](manage-work/portfolios/create-and-manage-programs/programs-overview.md)
...
* Rapports {#reporting}
   ...
   * Rapports {#reports}
      ...
      * Concepts de base du reporting {#report-basics}
      ...
      * Créer et gérer des rapports {#create-manage-reports}
         ...
         * [Créer un rapport sur la zone Mises à jour](reports-and-dashboards/reports/creating-and-managing-reports/create-journal-entry-report.md)
      ...
      * Exemples de vues, de filtres et de regroupements personnalisés {#custom-view-samples}
         ...
         * [Afficher : affiche les informations de problème d’origine dans les listes de tâches ou de projets](reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-display-original-issue-info-task-project-list.md)
   ...
   * Connexion aux données Workfront {#data-lake}
      ...
      * [Création d’un compte ou d’une connexion de lecteur pour Snowflake](reports-and-dashboards/data-lake/create-a-reader-account.md)
      ...
      * [Affichage des mesures d’utilisation de la connexion aux données Workfront](reports-and-dashboards/data-lake/view-usage-metrics.md)
* Gérer les ressources {#manage-resources}
   ...
   * Planification des ressources dans Adobe Workfront {#resource-planning-in-adobe-workfront}
      ...
      * Groupes de ressources {#resource-pools}
      ...
      * [Accès aux ressources de budget nécessaires dans Workfront](resource-mgmt/resource-planning/access-needed-to-budget-resources.md)
   ...
   * Relecture {#proofing}
      ...
      * Réviser des épreuves dans Adobe Workfront {#review-proofs-in-workfront}
         ...
         * Réviser une épreuve {#review-a-proof}
            ...
            * [Vérification du contenu interactif à l’aide de l’outil de révision Adobe Workfront](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/review-proof-in-web-viewer-extension.md)
         * Commenter une épreuve {#comment-on-a-proof}
...
* Feuilles de temps {#timesheets}
   ...
   * Détails sur la feuille de temps {#details}
   ...
   * Configurer l’enregistrement des heures {#configure-timesheet-preferences}
...
* Objectifs Adobe Workfront {#adobe-workfront-goals}
   ...
   * Gestion des objectifs dans Objectifs Adobe Workfront {#goal-management}
      * [Gérer des objectifs dans Objectifs Adobe Workfront](workfront-goals/goal-management/goal-management.md)
   ...
   * Examen des objectifs et sections dans Objectifs Adobe Workfront {#goal-review-and-adobe-workfront-goals-sections}
...
* Adobe Workfront Planning {#adobe-workfront-planning}
   ...
   * Informations générales sur Adobe Workfront Planning {#adobe-workfront-planning-general-information}
      ...
      * [Bonnes pratiques relatives à la planification Adobe Workfront](planning/general/planning-best-practices.md)
   ...
   * Enregistrements d’Adobe Workfront Planning {#adobe-workfront-planning-records}
      ...
      * [Création d’objets à l’aide d’automatismes d’enregistrement Workfront Planning](/help/quicksilver/planning/records/create-wf-objects-using-planning-automations.md)
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Prise en main d’Adobe Workfront Fusion {#get-started-with-workfront-fusion}
      * [Commencer avec Adobe Workfront Fusion](workfront-fusion/get-started/get-started.md)
      ...
      * [Créer un scénario d’intégration des pratiques dans Adobe Workfront Fusion](workfront-fusion/get-started/create-a-practice-scenario.md)
      * [Assistant IA dans Workfront Fusion](/help/quicksilver/workfront-fusion/get-started/fusion-ai-assistant.md)
      * [Sécurisation des performances Adobe Workfront Fusion](workfront-fusion/get-started/fusion-performance-guardrails.md)
      ...
      * [Utilisation de fichiers volumineux dans Fusion](/help/quicksilver/workfront-fusion/get-started/fusion-large-files.md)
   ...
   * Principes de base d’Adobe Workfront Fusion {#workfront-fusion-basics}
      ...
      * [Modifier les paramètres du profil dans Adobe Workfront Fusion](workfront-fusion/workfront-fusion-basics/change-profile-settings.md)
      * [Supprimer les données de l’utilisateur ou de l’utilisatrice dans Adobe Workfront Fusion](workfront-fusion/workfront-fusion-basics/delete-user-data.md)
   ...
   * Adobe Workfront Fusion dans Adobe Experience Cloud {#fusion-in-experience-cloud}
      ...
      * [Ajouter des utilisateurs et utilisatrices à Adobe Workfront Fusion via Adobe Admin Console](/help/quicksilver/workfront-fusion/fusion-in-admin-console/add-fusion-users-admin-console.md)
      * [Supprimer des utilisateurs et utilisatrices dans Adobe Workfront Fusion via Adobe Admin Console](/help/quicksilver/workfront-fusion/fusion-in-admin-console/delete-fusion-users-admin-console.md)
   ...
   * Connexions dans Adobe Workfront Fusion {#connections-in-fusion}
      ...
      * [Connecter Adobe Workfront Fusion à un service web qui utilise l’autorisation par jeton API](workfront-fusion/connections/connect-wf-web-service-uses-api-token-auth.md)
      ...
      * [Appeler l’API MS Graph REST via Adobe Workfront Fusion HTTP > Créer un module de requête OAuth 2.0](workfront-fusion/connections/call-the-ms-graph-rest-api.md)
   ...
   * Erreurs dans Adobe Workfront Fusion {#errors-in-fusion}
      ...
      * [Erreur de traitement dans Adobe Workfront Fusion](workfront-fusion/errors/error-processing.md)
      ...
      * [Gestion des erreurs de nouvelle tentative dans Adobe Workfront Fusion](workfront-fusion/errors/retry.md)
      * [Gestion de la génération d’erreurs dans Adobe Workfront Fusion](workfront-fusion/errors/throw.md)
   ...
   * Mappage dans Adobe Workfront Fusion {#mapping-in-fusion}
      * [Mapper dans Adobe Workfront Fusion](workfront-fusion/mapping/mapping.md)
   ...
   * Scénarios dans Adobe Workfront Fusion {#scenarios-in-fusion}
      ...
      * [Vue d’ensemble du scénario Adobe Workfront Fusion](workfront-fusion/scenarios/scenario-overview.md)
      ...
      * [Flux d’exécution des scénarios dans Adobe Workfront Fusion](workfront-fusion/scenarios/scenario-execution-flow.md)
      ...
      * [Génération d’un segment de scénario à l’aide d’AI](/help/quicksilver/workfront-fusion/scenarios/add-a-module-with-ai.md)
      * Modèles de scénarios Adobe Workfront Fusion {#fusion-scenario-templates}
         ...
         * [Créer des scénarios avec des modèles Adobe Workfront Fusion](workfront-fusion/scenarios/templates/create-scenarios-with-fusion-templates.md)
      ...
      * [Exemple de scénario Adobe Workfront Fusion : connexion de l’e-mail, analyseur de texte et Google Sheets](workfront-fusion/scenarios/example-connect-email-text-parser-gsheets.md)
   ...
   * Applications Workfront Fusion et leurs modules {#fusion-apps-and-modules}
      ...
      * [Modules de magasin de données](workfront-fusion/apps-and-their-modules/data-store-modules.md)
      ...
      * Modules HTTP {#fusion-http-modules}
         ...
         * [HTTP > Effectuer une requête](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-a-request.md)
         * [HTTP > Effectuer une requête d’autorisation de base](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-a-basic-auth-request.md)
         * [HTTP > Effectuer une requête OAuth 2.0](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-an-oauth-2-request.md)
         * [HTTP > Effectuer une requête d’autorisation de certificat client](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-a-client-cert-auth-request.md)
         * [HTTP > Effectuer une requête d’autorisation par clé API](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-an-api-key-auth-request.md)
         * [HTTP > Autres modules](workfront-fusion/apps-and-their-modules/http-modules/http-modules.md)
         * [Utiliser le protocole TLS mutuel dans les modules HTTP d’Adobe Workfront Fusion](workfront-fusion/apps-and-their-modules/http-modules/use-mtls-in-http-modules.md)
      ...
      * [Modules des modèles Microsoft Word](workfront-fusion/apps-and-their-modules/microsoft-word-templates-modules.md)
...
* Intégrations Adobe Workfront {#adobe-workfront-integrations}
   ...
   * Adobe Workfront pour Creative Cloud {#workfront-for-creative-cloud}
      ...
      * Installer le plugin Adobe Workfront pour les applications Creative Cloud {#install-wf-cc}
...
* Workfront Proof {#workfront-proof}
   ...
   * Commencer avec Workfront Proof {#get-started-wf-proof}
   ...
   * Travailler avec des épreuves et des fichiers dans Workfront Proof {#work-with-proofs-in-wf-proof}
      ...
      * Réviser des épreuves dans la visionneuse de relecture de bureau {#review-proofs-in-viewer}
      ...
      * Réviser des épreuves dans la visionneuse de relecture web {#review-proofs-web-proofing-viewer}
   ...
   * Paramètres de facturation de Workfront Proof {#wf-proof-billing-settings}
   ...
   * Notifications et rappels d’épreuves {#proof-notifications-and-reminders}
      ...
      * Envoyer des messages aux personnes chargées des révisions {#send-messages-to-reviewers}
   ...
   * Intégrations de Workfront Proof {#wf-proof-integrations}
