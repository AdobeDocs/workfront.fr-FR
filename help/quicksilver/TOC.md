...
* Annonces sur les produits {#product-announcements}
   ...
   * Versions de produit {#product-releases}
      ...
      * Activité de publication d’Adobe Workfront Planning {#planning-release-activity}
      ...
      * {#interface-modernization} de modernisation des interfaces
   ...
   * Personnaliser Adobe Workfront {#customize}
      ...
      * Formulaires personnalisés {#custom-forms}
         ...
         * Concevoir un formulaire personnalisé {#design-a-form}
            ...
            * [Ajouter une logique d’affichage et ignorer la logique à un formulaire](/help/quicksilver/administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/display-skip-logic-form-designer.md)
...
* Rapports {#reporting}
   ...
   * {#data-lake} de Workfront Data Connect
...
* Vérifier et approuver un travail {#review-and-approve-work}
   ...
   * Examen et approbation des ressources et des documents {#document-reviews-and-approvals}
      ...
      * Configuration et gestion des {#manage-asset-review-and-approval} d’approbation des ressources et des documents
         ...
         * [Utiliser les approbations et les relectures de nouveaux documents ensemble](review-and-approve-work/document-reviews-and-approvals/doc-approvals-and-proofing.md)
...
* Adobe Workfront Planning {#adobe-workfront-planning}
   ...
   * {#adobe-workfront-planning-requests} des demandes Adobe Workfront Planning
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Organisations dans Adobe Workfront Fusion {#organizations-in-fusion}
      ...
      * [Affichage des journaux d’activité pour une organisation dans Adobe Workfront Fusion](/help/quicksilver/workfront-fusion/organizations/view-activity-logs-for-an-org.md)
   ...
   * Applications Workfront Fusion et leurs modules {#fusion-apps-and-modules}
      ...
      * [Adobe I/O des modules d’événement](workfront-fusion/apps-and-their-modules/adobe-io-events-modules.md)
      ...
      * [Adobe des modules User Management](workfront-fusion/apps-and-their-modules/adobe-user-management-modules.md)
      ...
      * [Modules Microsoft Dynamics 365 - Finances et opérations](workfront-fusion/apps-and-their-modules/dynamics-finance-operations-modules.md)
...
* Intégrations Adobe Workfront {#adobe-workfront-integrations}
   ...
   * {#workfront-for-g-suite} Adobe Workfront for Google Workspace
