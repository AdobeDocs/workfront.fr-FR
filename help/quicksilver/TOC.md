...
* Annonces sur les produits {#product-announcements}
   ...
   * Versions de produit {#product-releases}
      ...
      * Version 23.2 {#release-23-2}
         ...
         * [Activité de la version 23.2 : Semaine du 27 février 2023](product-announcements/product-releases/23.2-release-activity/23-2-feb-27.md)
         * [Activité de la version 23.2 : Semaine du 20 février 2023](product-announcements/product-releases/23.2-release-activity/23-2-feb-20.md)
         * [Activité de la version 23.2 : semaine du 13 février 2023](product-announcements/product-releases/23.2-release-activity/23-2-feb-13.md)
         * [Activité de la version 23.2 : Semaine du 6 février 2023](product-announcements/product-releases/23.2-release-activity/23-2-feb-6.md)
         * [Activité de la version 23.2 : Semaine du 23 janvier 2023](product-announcements/product-releases/23.2-release-activity/23-1-jan-23.md)
...
* Administration et configuration {#administration-and-setup}
   ...
   * Ajouter des utilisateurs {#add-users}
      ...
      * Fonctionnement des niveaux d’accès {#access-levels}
         ...
         * [Accès aux objets par type de licence](administration-and-setup/add-users/access-levels-and-object-permissions/access-to-objects-and-areas-by-license-type.md)
...
* Principes de base d’Adobe Workfront {#basics}
   ...
   * Mise à jour des tâches et affichage des mises à jour {#update-work-items-view-updates}
      ...
      * [Onglet Mises à jour - Aperçu](workfront-basics/updating-work-items-and-viewing-updates/updates-tab-overview.md)
...
* Gestion des ressources {#manage-resources}
   ...
   * Gestion des ressources {#resource-management}
      ...
      * [Obsolescence des outils de planification des ressources dans Adobe Workfront](resource-mgmt/resource-mgmt-overview/deprecate-resource-scheduling.md)
      * [Migration de la planification des ressources vers l’équilibreur de charge de travail](resource-mgmt/resource-mgmt-overview/migrate-resource-scheduling-to-workload-balancer.md)
