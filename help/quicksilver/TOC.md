...
* Annonces sur les produits {#product-announcements}
   ...
   * Versions de produit {#product-releases}
      ...
      * Activité Version d’Adobe Workfront Fusion {#fusion-release}
         ...
         * [Activité Version d’Adobe Workfront Fusion](product-announcements/product-releases/fusion-release-activity/fusion-release-activity.md)
           [Activité Version de Workfront Fusion : semaine du 1er janvier 2024](/help/quicksilver/product-announcements/product-releases/fusion-release-activity/fusion-2024-1-4.md)
   ...
   * Programmes en version bêta {#beta}
      ...
      * Version alpha de l’intégration de Workfront et Frame.io {#frame-io-wf-integration-alpha}
         * [Version alpha de l’intégration native d’Adobe Workfront et Frame.io : vue d’ensemble](product-announcements/betas/frame-io-wf-integration-alpha/frame-io-wf-integration-alpha-overview.md)
         * [Version alpha de l’intégration native d’Adobe Workfront et Frame.io : fonctionnalités](product-announcements/betas/frame-io-wf-integration-alpha/frame-io-wf-integration-alpha-features.md)
...
* Rapports {#reporting}
   ...
   * Zone de travail de reporting {#reporting-canvas}
      * [Zone de travail de reporting](reports-and-dashboards/reporting-canvas/reporting-canvas.md)
      * Gérer les rapports {#manage-reports}
         * [Vue d’ensemble de la gestion des rapports](reports-and-dashboards/reporting-canvas/manage-reports/manage-reports.md)
      ...
      * Blocs de tableau {#table-blocks}
         ...
         * [Ajouter ou modifier un bloc de tableau dans la zone de travail de reporting](reports-and-dashboards/reporting-canvas/table-blocks/add-or-edit-report-table.md)
         * [Configurer une colonne de tableau dans la zone de travail de reporting](reports-and-dashboards/reporting-canvas/table-blocks/modify-columns-table.md)
         * [Créer un champ de formule dans la zone de travail de reporting](reports-and-dashboards/reporting-canvas/table-blocks/create-formula-field.md)
         * [Grouper les lignes d’un tableau dans la zone de travail de reporting](reports-and-dashboards/reporting-canvas/table-blocks/group-rows-in-table.md)
         * [Filtrer un tableau dans la zone de travail de reporting](reports-and-dashboards/reporting-canvas/table-blocks/configure-filter-rules-for-table.md)
      * Blocs de visualisation {#visualization-blocks}
         ...
         * [Ajouter ou modifier un bloc de visualisation dans la zone de travail de reporting](reports-and-dashboards/reporting-canvas/visualization-blocks/add-or-edit-report-visualization.md)
         * [Configurer une visualisation à barres dans la zone de travail de reporting](reports-and-dashboards/reporting-canvas/visualization-blocks/configure-bar-visualization.md)
   ...
   * Analytique améliorée {#enhanced-analytics}
      ...
      * [Afficher la visualisation de capacité des ressources dans Analytique améliorée](enhanced-analytics/resource-capacity-overview.md)
      * [Afficher la visualisation de capacité de l’équipe dans Analytique améliorée](enhanced-analytics/team-capacity-overview.md)
...
* Vérifier et approuver un travail {#review-and-approve-work}
   ...
   * Examen et approbation des documents {#document-reviews-and-approvals}
      ...
      * Approbation de documents {#approve-documents}
         ...
         * [Statut d’approbation de document](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/document-approval-status.md)
...
* Adobe Maestro {#adobe-maestro}
   ...
   * Architecture d’Adobe Maestro {#adobe-maestro-architecture}
      ...
      * [Modifier des types d’enregistrements](maestro/architecture/edit-record-types.md)
      * [Supprimer des espaces de travail](maestro/architecture/delete-workspaces.md)
      * [Modifier des espaces de travail](maestro/architecture/edit-workspaces.md)
      * [Supprimer des types d’enregistrements](maestro/architecture/delete-record-types.md)
   ...
   * Champs Adobe Maestro {#adobe-maestro-fields}
      * [Champs : index des articles](maestro/fields/fields-information.md)
      * [Vue d’ensemble des champs](maestro/fields/fields-overview.md)
      * [Créer des champs](maestro/fields/create-fields.md)
      * [Modifier des champs](maestro/fields/edit-fields.md)
      * [Supprimer des champs](maestro/fields/delete-fields.md)
      * [Vue d’ensemble des champs de formule](maestro/fields/formula-fields.md)
   * Accès à Adobe Maestro {#adobe-maestro-access}
      ...
      * [Vue d’ensemble des accès](maestro/access/access-overview.md)
      ...
      * [Partager des espaces de travail](maestro/access/share-workspaces.md)
      * [Partager des vues](maestro/access/share-views.md)
   * Enregistrements Adobe Maestro {#adobe-maestro-records}
      * [Enregistrements : index des articles](maestro/records/records-information.md)
      ...
      * [Partager des enregistrements](maestro/records/share-records.md)
      * [Gérer les commentaires d’enregistrement](maestro/records/manage-record-comments.md)
      * [Vue d’ensemble de la section Historique](maestro/records/history-section-overview.md)
      * [Ajouter des miniatures aux enregistrements](maestro/records/add-thumbnails-to-records.md)
      * [Gestion de la page d’enregistrement](maestro/records/manage-the-record-page.md)
   * Vues d’Adobe Maestro {#adobe-maestro-views}
      ...
      * [Gérer la vue de tableau](maestro/views/manage-the-table-view.md)
